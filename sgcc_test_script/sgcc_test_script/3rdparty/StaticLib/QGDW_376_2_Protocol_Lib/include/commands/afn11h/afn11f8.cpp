...
qgdw_3762_protocol::Afn11F8::Afn11F8()
{
    this->afn_=0x11;
    this->dt1_=char(0x80);
    this->dt2_=0x00;
...
qgdw_3762_protocol::Afn11F8::Afn11F8(const qgdw_3762_protocol::CtrlField ctrl_field, const qgdw_3762_protocol::InfoField info_field, const qgdw_3762_protocol::AddressField address_field)
:Frame3762Base(ctrl_field,info_field,address_field,0x11,char(0x80),0x00)
{
...
void qgdw_3762_protocol::Afn11F8::DecodeFrameDataField(QByteArray data)
{
...
QByteArray qgdw_3762_protocol::Afn11F8::EncodeFrameDataField()
{
    QByteArray data;
    if((this->ctrl_field_.dir&0x01) == qgdw_3762_protocol::kDirDown)
    {
