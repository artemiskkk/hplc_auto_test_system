...
qgdw_3762_protocol::Afn03F1::Afn03F1()
{
    this->afn_=0x03;
    this->dt1_=0x01;
    this->dt2_=0x00;
...
qgdw_3762_protocol::Afn03F1::Afn03F1(const qgdw_3762_protocol::CtrlField ctrl_field, qgdw_3762_protocol::InfoField info_field, qgdw_3762_protocol::AddressField address_field)
...
void qgdw_3762_protocol::Afn03F1::DecodeFrameDataField(QByteArray data)
{
...
QByteArray qgdw_3762_protocol::Afn03F1::EncodeFrameDataField()
{
    QByteArray data;
    if((this->ctrl_field_.dir&0x01) == qgdw_3762_protocol::kDirUp)
    {
