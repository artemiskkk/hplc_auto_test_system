#include "afn10f101_beijing.h"

qgdw_3762_protocol::Afn10F101_Beijing::Afn10F101_Beijing()
{
    this->afn_=0x10;
    this->dt1_=0x10;
    this->dt2_=0x0C;
...
qgdw_3762_protocol::Afn10F101_Beijing::Afn10F101_Beijing(const qgdw_3762_protocol::CtrlField ctrl_field, const qgdw_3762_protocol::InfoField info_field, const qgdw_3762_protocol::AddressField address_field)
...
void qgdw_3762_protocol::Afn10F101_Beijing::DecodeFrameDataField(QByteArray data)
{
    if((this->ctrl_field_.dir&0x01) == qgdw_3762_protocol::kDirUp)
    {
        ...
        {
            NodeInfoGroup10F101_Beijing node_info_group_;
            for(int j=0;j<6;j++)
            {
            ...
            data.remove(0,3);
            node_info_group_.bootloader_version_=data.at(0);
            data.remove(0,1);
...
QByteArray qgdw_3762_protocol::Afn10F101_Beijing::EncodeFrameDataField()
{
    QByteArray data;
    if((this->ctrl_field_.dir&0x01) == qgdw_3762_protocol::kDirUp)
    {
        ...
        for(int i=0;i<this->node_info_data_unit_.node_info_group_list_.size();i++)
        {
            ...
            data.append(this->node_info_data_unit_.node_info_group_list_.at(i).bootloader_version_);
        }
    }
    else
    {
