 ...
 */
struct RouterWorkModeUnit_10F133
{
     ...
     * @return
     */
    bool operator==(const RouterWorkModeUnit_10F133 &unit_)const
    {
...
#ifdef UNIT_TEST
class Afn10F133 : public Frame3762Base
#else
/**
 * @brief The Afn10F133 查询台区识别结果
 */
class QGDW_376_2_PROTOCOL_LIB_EXPORT Afn10F133 : public Frame3762Base
#endif
{
public:
    /**
     ...
     */
    Afn10F133(CtrlField ctrl_field,InfoField info_field,AddressField address_field);

    RouterWorkModeUnit_10F133 router_work_mode_unit_;//!<工作模式数据单元
public:
    /**
