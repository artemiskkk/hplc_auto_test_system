#include "afn10f21.h"
qgdw_3762_protocol::Afn10F21::Afn10F21()
{
    this->afn_=0x10;
    this->dt1_=0x10;
    this->dt2_=0x02;
}
qgdw_3762_protocol::Afn10F21::Afn10F21(const qgdw_3762_protocol::CtrlField ctrl_field, const qgdw_3762_protocol::InfoField info_field, const qgdw_3762_protocol::AddressField address_field)
:Frame3762Base(ctrl_field,info_field,address_field,0x10,0x10,0x02)
{
...
void qgdw_3762_protocol::Afn10F21::DecodeFrameDataField(QByteArray data)
{
    if((this->ctrl_field_.dir&0x01) == qgdw_3762_protocol::kDirUp)
    {
        ...
        {
            NetworkTypelogyInfo10F21 network_typelogy_info_;
            for(int j=0;j<6;j++)
            {
...
QByteArray qgdw_3762_protocol::Afn10F21::EncodeFrameDataField()
{
    QByteArray data;
    if((this->ctrl_field_.dir&0x01) == qgdw_3762_protocol::kDirUp)
    {
