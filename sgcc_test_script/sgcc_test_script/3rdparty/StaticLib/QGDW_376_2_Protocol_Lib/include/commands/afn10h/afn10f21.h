...
struct NodeInfo10F21
{
     ...
     * @return
     */
    bool operator==(const NodeInfo10F21 &unit_)const
    {
 ...
 */
struct NetworkTypelogyInfo10F21
{
    Address node_address_;//!<节点地址
    ushort node_tei_;//!<节点标识
    ushort proxy_node_tei_;//!<代理节点标识
    NodeInfo10F21 node_info_;//!<节点信息
    /**
     * @brief operator ==
     * @param unit_
     * @return
     */
    bool operator==(const NetworkTypelogyInfo10F21 &unit_)const
    {
 ...
 */
struct NetworkTypelogyInfoUnit10F21
{
    ushort node_total_num_;//!<从节点总数量
    ushort node_start_no_;//!<从节点起始序号
    uchar this_node_num_;//!<本次从节点数量
    QList<NetworkTypelogyInfo10F21> network_typelogy_info_List_;//!<网络拓扑QList
    /**
     * @brief operator ==
     * @param unit_
     * @return
     */
    bool operator==(const NetworkTypelogyInfoUnit10F21 &unit_)const
    {
...
#ifdef UNIT_TEST
class Afn10F21 : public Frame3762Base
#else
/**
 * @brief The AFN10F21 网络拓扑信息
 */
class QGDW_376_2_PROTOCOL_LIB_EXPORT Afn10F21 : public Frame3762Base
#endif
{
public:
    /**
     ...
     */
    Afn10F21(CtrlField ctrl_field,InfoField info_field,AddressField address_field);
    ushort node_start_no_;//!<从节点起始序号
    uchar node_num_;//!<从节点数量

    NetworkTypelogyInfoUnit10F21 network_typelogy_info_unit_;//!<网络拓扑信息数据单元
public:
    /**
