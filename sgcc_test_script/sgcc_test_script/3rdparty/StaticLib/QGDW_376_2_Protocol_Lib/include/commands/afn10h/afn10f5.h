...
/**
 * @brief The NodeInfo10F5 节点信息结构体
 */
struct NodeInfo10F5
{
     ...
     * @return
     */
    bool operator==(const NodeInfo10F5 &unit_)const
    {
...
/**
 * @brief The NodeInfoGroup10F5 从节点信息组结构体
 */
struct NodeInfoGroup10F5
{
    Address node_address_;//!<从节点地址
    NodeInfo10F5 node_info_;//!<从节点信息
    /**
     * @brief operator ==
     * @param unit_
     * @return
     */
    bool operator==(const NodeInfoGroup10F5 &unit_)const
    {
 ...
 */
struct ReadUnsuccessNodeInfoDataUnit
{
    ushort node_total_num_;//!<从节点总数量
    uchar this_node_num_;//!<本次应答的从节点数量
    QList<NodeInfoGroup10F5> node_info_group_list_;//!<从节点信息组QList
    /**
     * @brief operator ==
     * @param unit_
     * @return
     */
    bool operator==(const ReadUnsuccessNodeInfoDataUnit &unit_)const
    {
...
#ifdef UNIT_TEST
class Afn10F5 : public Frame3762Base
#else
/**
 * @brief The AFN10F5 未抄读成功的从节点信息
 */
class QGDW_376_2_PROTOCOL_LIB_EXPORT Afn10F5 : public Frame3762Base
#endif
{
public:
    /**
     ...
     */
    Afn10F5(CtrlField ctrl_field,InfoField info_field,AddressField address_field);
    ushort node_start_no_;//!<从节点起始序号
    uchar node_num_;//!<从节点数量

    ReadUnsuccessNodeInfoDataUnit unsuccess_node_info_unit_;//!<未抄读成功的从节点信息数据单元
public:
    /**
