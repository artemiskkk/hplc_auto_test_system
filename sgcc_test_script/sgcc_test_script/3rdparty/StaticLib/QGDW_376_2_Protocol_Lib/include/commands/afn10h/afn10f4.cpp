...
qgdw_3762_protocol::Afn10F4::Afn10F4()
{
    this->afn_=0x10;
    this->dt1_=0x08;
    this->dt2_=0x00;
...
qgdw_3762_protocol::Afn10F4::Afn10F4(const qgdw_3762_protocol::CtrlField ctrl_field, const qgdw_3762_protocol::InfoField info_field, const qgdw_3762_protocol::AddressField address_field)
...
void qgdw_3762_protocol::Afn10F4::DecodeFrameDataField(QByteArray data)
{
...
QByteArray qgdw_3762_protocol::Afn10F4::EncodeFrameDataField()
{
    QByteArray data;
    if((this->ctrl_field_.dir&0x01) == qgdw_3762_protocol::kDirUp)
    {
