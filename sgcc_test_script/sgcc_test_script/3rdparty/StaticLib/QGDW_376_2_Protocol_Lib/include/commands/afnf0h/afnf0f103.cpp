...
qgdw_3762_protocol::AfnF0F103::AfnF0F103()
{
    this->afn_=char(0xF0);
    this->dt1_=0x40;
    this->dt2_=0x0C;
...
qgdw_3762_protocol::AfnF0F103::AfnF0F103(const qgdw_3762_protocol::CtrlField ctrl_field, const qgdw_3762_protocol::InfoField info_field, const qgdw_3762_protocol::AddressField address_field)
:Frame3762Base(ctrl_field,info_field,address_field,char(0xF0),0x40,0x0C)
{
...
void qgdw_3762_protocol::AfnF0F103::DecodeFrameDataField(QByteArray data)
{
    if((this->ctrl_field_.dir&0x01) == qgdw_3762_protocol::kDirUp)
    {
        ...
        this->network_node_info_unit_.this_node_num_=ushort(short(data.at(1))<<8)+uchar(data.at(0));
        data.remove(0,2);
        ...
        {
            NodeInfoStructureF0F103 network_info_structure_;
            for(int j=0;j<6;j++)
            {
            ...
            {
                NodeHangDownInfoF0F103 node_hang_down_info_;
                for(int m=0;m<6;m++)
    ...
    else
    {
        ...
        if(this->node_num_!=(data.size()-1)/6)
        {
            throw DecodeException(qgdw_3762_protocol::ExceptionCatalogue::kDataLengthError,QString("DataField Length Error"));
        }
        data.remove(0,1);
...
QByteArray qgdw_3762_protocol::AfnF0F103::EncodeFrameDataField()
{
    QByteArray data;
    if((this->ctrl_field_.dir&0x01) == qgdw_3762_protocol::kDirUp)
    {
