...
qgdw_3762_protocol::AfnF0F40::AfnF0F40()
{
    this->afn_=char(0xF0);
    this->dt1_=char(0x80);
    this->dt2_=0x04;
...
qgdw_3762_protocol::AfnF0F40::AfnF0F40(const qgdw_3762_protocol::CtrlField ctrl_field, const qgdw_3762_protocol::InfoField info_field, const qgdw_3762_protocol::AddressField address_field)
:Frame3762Base(ctrl_field,info_field,address_field,char(0xF0),char(0x80),0x04)
{
...
void qgdw_3762_protocol::AfnF0F40::DecodeFrameDataField(QByteArray data)
{
    if((this->ctrl_field_.dir&0x01) == qgdw_3762_protocol::kDirUp)
    {
        ...
        this->read_chip_id_unit_up_.id_length_=uchar(data.at(8));
        if(this->read_chip_id_unit_up_.id_length_!=data.size()-9)
        {
            throw DecodeException(qgdw_3762_protocol::ExceptionCatalogue::kDataLengthError,QString("DataField Length Error"));
        }
        this->read_chip_id_unit_up_.id_content_.clear();
        this->read_chip_id_unit_up_.id_content_=data.mid(9);
    }
    else
    {
        if(data.length()!=9)
        ...
        this->read_chip_id_unit_down_.id_length_=uchar(data.at(8));
    }
}
QByteArray qgdw_3762_protocol::AfnF0F40::EncodeFrameDataField()
{
    QByteArray data;
    if((this->ctrl_field_.dir&0x01) == qgdw_3762_protocol::kDirUp)
    {
    ...
    else
    {
        ...
        data.append(char(this->read_chip_id_unit_down_.id_length_));
    }
    return  data;
}
