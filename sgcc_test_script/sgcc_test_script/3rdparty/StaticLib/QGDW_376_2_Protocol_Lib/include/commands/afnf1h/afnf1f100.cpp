...
qgdw_3762_protocol::AfnF1F100::AfnF1F100()
{
    this->afn_=char(0xF1);
    this->dt1_=0x08;
    this->dt2_=0x0C;
...
qgdw_3762_protocol::AfnF1F100::AfnF1F100(const qgdw_3762_protocol::CtrlField ctrl_field, const qgdw_3762_protocol::InfoField info_field, const qgdw_3762_protocol::AddressField address_field)
:Frame3762Base(ctrl_field,info_field,address_field,char(0xF1),0x08,0x0C)
{
...
void qgdw_3762_protocol::AfnF1F100::DecodeFrameDataField(QByteArray data)
{
    if((this->ctrl_field_.dir&0x01) == qgdw_3762_protocol::kDirDown)
    {
        ...
        this->unit_down_.preserve_=data.at(1);
        data.remove(0,2);
...
QByteArray qgdw_3762_protocol::AfnF1F100::EncodeFrameDataField()
{
    QByteArray data;
    if((this->ctrl_field_.dir&0x01) == qgdw_3762_protocol::kDirDown)
    {
        ...
        data.append(this->unit_down_.preserve_);
