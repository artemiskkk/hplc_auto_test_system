#ifndef SCRIPT_COMMADDRREQUEST_2
#define SCRIPT_COMMADDRREQUEST_2

#include "TestCase/BuildNetwork_GW.h"

enum Script_CommAddrRequest_2_RunState
{
  //  Init_PowerOffSta,
    Init_SetBaudRate,
    Init_PowerOnSta,
...
class Script_CommAddrRequest_2 : public QObject, public AbstractScript, public DynamicCreate<Script_CommAddrRequest_2>
{
    Q_OBJECT
 //   Q_PLUGIN_METADATA(IID "com.topscomm.AbstractScript")
 //   Q_INTERFACES(AbstractScript)
public:
    explicit Script_CommAddrRequest_2(QObject *parent = nullptr);
    ~Script_CommAddrRequest_2();

    Script_CommAddrRequest_2_RunState emScriptRunState;
...
#endif // SCRIPT_COMMADDRREQUEST_2
