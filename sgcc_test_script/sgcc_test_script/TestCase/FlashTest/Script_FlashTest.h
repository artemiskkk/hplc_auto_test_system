#ifndef SCRIPT_FLASHTEST_H
#define SCRIPT_FLASHTEST_H

#include <QObject>
#include "TestCase/BuildNetwork_GW.h"

enum Script_FlashTest_RunState
{
    TestInit,
...
class Script_FlashTest : public QObject, public AbstractScript,public DynamicCreate<Script_FlashTest>
{
    Q_OBJECT
//    Q_PLUGIN_METADATA(IID "com.topscomm.AbstractScript")
//    Q_INTERFACES(AbstractScript)
public:
    explicit Script_FlashTest(QObject *parent = nullptr);
    ~Script_FlashTest();
    Script_FlashTest_RunState emScriptRunState;
