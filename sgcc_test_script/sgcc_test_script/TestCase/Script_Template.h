 ...
 * 适用于必须要重新组网的脚本，如组网测试
 */
class Script_Template :  public QObject, public AbstractScript,public DynamicCreate<Script_Template>
{
    Q_OBJECT
public:
    explicit Script_Template(QObject *parent = nullptr);
    ~Script_Template();
private:
