#ifndef SCRIPT_ACTIVELYREPORT06F4_H
#define SCRIPT_ACTIVELYREPORT06F4_H

#include <QObject>
#include "TestCase/BuildNetwork_GW.h"
//#include "TestCase/BuildNetwork_Zhejiang/BuildNetwork_Zhejiang.h"

enum Script_ActivelyReport06F4_RunState
{
    TestInit,
...
class Script_ActivelyReport06F4 : public QObject, public AbstractScript,public DynamicCreate<Script_ActivelyReport06F4>
{
    Q_OBJECT
public:
    explicit Script_ActivelyReport06F4(QObject *parent = nullptr);
    ~Script_ActivelyReport06F4();
    Script_ActivelyReport06F4_RunState emScriptRunState;
    ...
    shared_ptr<Afn06F4> p_ActiveReport_06F4_Up;
...
#endif // SCRIPT_ACTIVELYREPORT06F4_H
