#ifndef SCRIPT_CCOONEMINUTENOBEACON_H
#define SCRIPT_CCOONEMINUTENOBEACON_H

#include <QObject>
#include "TestCase/BuildNetwork_GW.h"
//#include "TestCase/TestCase_ZheJiang/BuildNetwork/BuildNetwork_Zhejiang.h"

enum Script_CcoOneMinuteNoBeacon_RunState
{
    TestInit,
    ...
    Wait_QueryNetScale_ParameterInit_Finish,
...
class Script_CcoOneMinuteNoBeacon : public QObject, public AbstractScript,public DynamicCreate<Script_CcoOneMinuteNoBeacon>
{
    Q_OBJECT
public:
    explicit Script_CcoOneMinuteNoBeacon(QObject *parent = nullptr);
    ~Script_CcoOneMinuteNoBeacon();
    Script_CcoOneMinuteNoBeacon_RunState emScriptRunState;
...
#endif // SCRIPT_CCOONEMINUTENOBEACON_H
