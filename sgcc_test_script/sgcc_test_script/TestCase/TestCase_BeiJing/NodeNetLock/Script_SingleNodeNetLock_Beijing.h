#ifndef SCRIPT_SINGLENODENETLOCK_BEIJING_H
#define SCRIPT_SINGLENODENETLOCK_BEIJING_H

#include <QObject>
#include "TestCase/BuildNetwork_GW.h"

enum Script_SingleNodeNetLock_Beijing_RunState
{
    TestInit,
    ...
    Wait_SetSingleNodeNetLock_11F126_Finish,
    Wait_SetMasterAddr_05F1_Finish,
    Wait_QueryNetScale_10F9_Finish,
    ScriptSuccess
};
class Script_SingleNodeNetLock_Beijing : public QObject, public AbstractScript,public DynamicCreate<Script_SingleNodeNetLock_Beijing>
{
    Q_OBJECT
//    Q_PLUGIN_METADATA(IID "com.topscomm.AbstractScript")
//    Q_INTERFACES(AbstractScript)
public:
    explicit Script_SingleNodeNetLock_Beijing(QObject *parent = nullptr);
    ~Script_SingleNodeNetLock_Beijing();
    Script_SingleNodeNetLock_Beijing_RunState emScriptRunState;
