#ifndef SCRIPT_SINGLENODENETUNLOCK_BEIJING_H
#define SCRIPT_SINGLENODENETUNLOCK_BEIJING_H

#include <QObject>
#include "TestCase/BuildNetwork_GW.h"

enum Script_SingleNodeNetUnlock_Beijing_RunState
{
    TestInit,
    ...
    Wait_SetSingleNodeNetUnlock_11F126_Finish,
    Wait_SetMasterAddr_05F1_Finish,
    Wait_QueryNetScale_10F9_Finish,
    ScriptSuccess
};
class Script_SingleNodeNetUnlock_Beijing : public QObject, public AbstractScript,public DynamicCreate<Script_SingleNodeNetUnlock_Beijing>
{
    Q_OBJECT
//    Q_PLUGIN_METADATA(IID "com.topscomm.AbstractScript")
//    Q_INTERFACES(AbstractScript)
public:
    explicit Script_SingleNodeNetUnlock_Beijing(QObject *parent = nullptr);
    ~Script_SingleNodeNetUnlock_Beijing();
    Script_SingleNodeNetUnlock_Beijing_RunState emScriptRunState;
...
#endif // SCRIPT_SINGLENODENETUNLOCK_BEIJING_H
