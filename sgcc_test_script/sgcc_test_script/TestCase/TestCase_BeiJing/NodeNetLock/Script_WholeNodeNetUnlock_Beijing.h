#ifndef SCRIPT_WHOLENODENETUNLOCK_BEIJING_H
#define SCRIPT_WHOLENODENETUNLOCK_BEIJING_H

#include <QObject>
#include "TestCase/BuildNetwork_GW.h"

enum Script_WholeNodeNetUnlock_Beijing_RunState
{
    TestInit,
    Wait_BuildNetFinish_Whole,
    Wait_ParameterInit_Finish,
    Wait_SetWhiteListState_05F131_Finish,
    Wait_SetWholeNodeNetUnlock_11F126_Finish,
    Wait_SetMasterAddr_05F1_Finish,
    Wait_QueryNetScale_10F9_Finish,
    ScriptSuccess
};
class Script_WholeNodeNetUnlock_Beijing : public QObject, public AbstractScript,public DynamicCreate<Script_WholeNodeNetUnlock_Beijing>
{
    Q_OBJECT
//    Q_PLUGIN_METADATA(IID "com.topscomm.AbstractScript")
//    Q_INTERFACES(AbstractScript)
public:
    explicit Script_WholeNodeNetUnlock_Beijing(QObject *parent = nullptr);
    ~Script_WholeNodeNetUnlock_Beijing();
    Script_WholeNodeNetUnlock_Beijing_RunState emScriptRunState;
...
#endif // SCRIPT_WHOLENODENETUNLOCK_BEIJING_H
