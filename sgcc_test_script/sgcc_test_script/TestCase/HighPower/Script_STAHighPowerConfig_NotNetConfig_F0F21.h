#ifndef SCRIPT_STAHIGHPOWERCONFIG_NOTNETCONFIG_F0F21_H
#define SCRIPT_STAHIGHPOWERCONFIG_NOTNETCONFIG_F0F21_H


#include <QObject>
#include "TestCase/BuildNetwork_GW.h"

enum Script_STAHighPowerConfig_NotNetConfig_F0F21_RunState
{
    TestInit,
    ...
    Wait_DeleteSlaveNode_11F2_Finish,
    Wait_HardResetTest_Finish,
    Wait_SetSuperpowerPara_0C0C_Finish,
    Wait_AddSlaveNode_11F1_Finish,
    Wait_QueryNetScale_10F9_2_Finish,
    Wait_QuerySuperpowerPara_Finish,
...
{
    Wait_Config_0505_Finish,
    Wait_Config_0C0C_Finish
};
...
class Script_STAHighPowerConfig_NotNetConfig_F0F21 : public QObject, public AbstractScript,public DynamicCreate<Script_STAHighPowerConfig_NotNetConfig_F0F21>
{
    Q_OBJECT
public:
    explicit Script_STAHighPowerConfig_NotNetConfig_F0F21(QObject *parent = nullptr);
    ~Script_STAHighPowerConfig_NotNetConfig_F0F21();

    Script_STAHighPowerConfig_NotNetConfig_F0F21_RunState emScriptRunState;
...
//        char protocol;
    ...
    QString test_name_="【GW-STA-F021-0004-V01】大功率配置-不入网配置（F0F21）";
    //设定参数
    char vol=0x04;
    char factor=0x00;
...
#endif // SCRIPT_STAHIGHPOWERCONFIG_NOTNETCONFIG_F0F21_H
