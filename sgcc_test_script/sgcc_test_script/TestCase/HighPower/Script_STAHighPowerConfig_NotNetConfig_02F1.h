#ifndef SCRIPT_STAHIGHPOWERCONFIG_NOTNETCONFIG_02F1_H
#define SCRIPT_STAHIGHPOWERCONFIG_NOTNETCONFIG_02F1_H


#include <QObject>
#include "TestCase/BuildNetwork_GW.h"

enum Script_STAHighPowerConfig_NotNetConfig_02F1_RunState
{
    TestInit,
    ...
    Wait_SetSuperpowerPara_0505_Finish,
...
class Script_STAHighPowerConfig_NotNetConfig_02F1 : public QObject, public AbstractScript,public DynamicCreate<Script_STAHighPowerConfig_NotNetConfig_02F1>
{
    Q_OBJECT
public:
    explicit Script_STAHighPowerConfig_NotNetConfig_02F1(QObject *parent = nullptr);
    ~Script_STAHighPowerConfig_NotNetConfig_02F1();

    Script_STAHighPowerConfig_NotNetConfig_02F1_RunState emScriptRunState;
...
//        char protocol;
    ...
    QString test_name_="【GW-STA-F021-0003-V01】大功率配置-不入网配置（02F1）";
    //设定参数
    char vol=0x04;
    char factor=0x00;
...
#endif // SCRIPT_STAHIGHPOWERCONFIG_NOTNETCONFIG_02F1_H
