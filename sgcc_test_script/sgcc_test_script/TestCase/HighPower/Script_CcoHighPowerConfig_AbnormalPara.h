#ifndef SCRIPT_CCOHIGHPOWERCONFIG_ABNORMALPARA_H
#define SCRIPT_CCOHIGHPOWERCONFIG_ABNORMALPARA_H
 ...
 */
enum Script_CcoHighPowerConfig_AbnormalPara_RunState
{
    ScriptInit,
    Wait_BuildNetFinish_Whole,
    Wait_QueryHighPower_F0F7_Finish,
    Wait_SetHighPower_F0F8_FF_Finish ,
    Wait_QueryHighPower1_F0F7_Finish,
    Wait_SetHighPower_F0F8_0A_Finish ,
    Wait_QueryHighPower2_F0F7_Finish,
    Wait_SetHighPower_F0F8_03_Finish ,
    Wait_QueryHighPower3_F0F7_Finish,
    Wait_SetHighPower_F0F8_15_Finish ,
    Wait_QueryHighPower4_F0F7_Finish,
    ScriptSuccess
};
/**
 ...
 * 适用于必须要重新组网的脚本，如组网测试
 */
class Script_CcoHighPowerConfig_AbnormalPara :  public QObject, public AbstractScript,public DynamicCreate<Script_CcoHighPowerConfig_AbnormalPara>
{
    Q_OBJECT
public:
    explicit Script_CcoHighPowerConfig_AbnormalPara(QObject *parent = nullptr);
    ~Script_CcoHighPowerConfig_AbnormalPara();
private:
    Script_CcoHighPowerConfig_AbnormalPara_RunState emScriptRunState=ScriptInit;
    ...
    QString userCaseIds;
    //
    ushort testCircleTimes=0;
    ushort runCircleTimes=0;
    //定义帧格式处理
    ...
    shared_ptr<qgdw_3762_protocol::Afn11F1>  p_Afn11F1;
    shared_ptr<qgdw_3762_protocol::Afn10F4>  p_Afn10F4;
    shared_ptr<qgdw_3762_protocol::AfnF0F7>  p_AfnF0F7;
    shared_ptr<qgdw_3762_protocol::AfnF0F8>  p_AfnF0F8;

    //本脚本用到的全局变量
    uchar setdac ,readdac;
    uchar setpeak,readpeak;
...
#endif // SCRIPT_CCOHIGHPOWERCONFIG_ABNORMALPARA_H
