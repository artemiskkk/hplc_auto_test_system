#include "Script_STAHighPowerConfig_NotNetConfig_02F1.h"

Script_STAHighPowerConfig_NotNetConfig_02F1::Script_STAHighPowerConfig_NotNetConfig_02F1(QObject *parent) : QObject(parent)
{
...
Script_STAHighPowerConfig_NotNetConfig_02F1::~Script_STAHighPowerConfig_NotNetConfig_02F1()
{
...
void Script_STAHighPowerConfig_NotNetConfig_02F1::execute()
{
...
void Script_STAHighPowerConfig_NotNetConfig_02F1::stop()
{
...
void Script_STAHighPowerConfig_NotNetConfig_02F1::addAddrsInfo(const QList<ConcentratorInfo> *p_ConcentratorInfoList, const QList<MeterInfo> *p_MeterInfoList, const QList<SchemeCfgInfo> *p_SchemeCfgInfoList, const int freq)
{
    p_CtrInfoList->clear();
...
void Script_STAHighPowerConfig_NotNetConfig_02F1::setHost(AbstractScriptHost *host)
{
    p_AbstractScriptHost=host;
    p_BuildNetwork_GW->setHost(host);
}
bool Script_STAHighPowerConfig_NotNetConfig_02F1::config(const QMap<QString,QString> *paraDic)
{
    bool result = false;
    if(paraDic!=nullptr)
    {
...
void Script_STAHighPowerConfig_NotNetConfig_02F1::processMsg(DvcType dvcType,int id,uchar* data,int datalen)
{
...
void Script_STAHighPowerConfig_NotNetConfig_02F1::processCtrlDvcRes(DvcType dvcType,QList<int> idList, CtrlCmdType ctrlCmdType, bool isSucs, QList<double> params)
{
    if(isSucs==false)
        return;
    ...
    switch(emScriptRunState)
    {
        ...
        case Wait_SetSuperpowerPara_0505_Finish:
        {
            break;
        }
...
void Script_STAHighPowerConfig_NotNetConfig_02F1::sendSrcMsg(DvcType dvcType, int dvcId, QByteArray msg)
{
    if(msg.size()<1)
        return;
...
void Script_STAHighPowerConfig_NotNetConfig_02F1::processMsgFromCCO(DvcType dvcType, int dvcId)
{
...
//                                pullPinReset_STA(p_CtrInfoList,p_AbstractScriptHost);
        ...
        case Wait_HardResetTest_Finish:
        {
            ...
            else if(p_Frame3762Base->afn_ == 0x03&&p_Frame3762Base->dt1_==0x02&&p_Frame3762Base->dt2_==0x01&&p_Frame3762Base->ctrl_field_.dir == kDirUp)
            {
                ...
                emConfigSuperpowerParaState = Wait_Config_0505_Finish;
                sendMsg(CCO_GW,p_CtrInfoList->at(0)->ctrlID,INSIGNIFICANCE,p_TransparentTransmit_02F1);
                p_AbstractScriptHost->updateProgress(ProcessState_Processing, "02F1配置STA大功率参数_0505，等待--确认");
                emScriptRunState=Wait_SetSuperpowerPara_0505_Finish;
                p_timer->start(STA_CMD_TIMEOUT_TIME*1000);
            }
            else
            {
...
//                    index++;
                    if(p_Config_02F1_Up->frame_length_==char(0x00))
                    {
                        p_AbstractScriptHost->updateProgress(ProcessState_Processing, "给不在档案内电表，02F1配置大功率参数0505完成，无上行数据");
...
//                        index++;
                        ...
                        p_AbstractScriptHost->updateProgress(ProcessState_Processing,"测试成功【GW-STA-F021-0003-V01】大功率配置-不入网配置（02F1）");
...
void Script_STAHighPowerConfig_NotNetConfig_02F1::processMsgFromMeter645(DvcType dvcType, int dvcId, int mtrlID)
{
    bool haveCompleteMsg=true;
    while(haveCompleteMsg)
    {
...
void Script_STAHighPowerConfig_NotNetConfig_02F1::processMsgFromMeterOOP(DvcType dvcType, int dvcId, int mtrlID)
{
    bool haveCompleteMsg=true;
    while(haveCompleteMsg)
    {
...
void Script_STAHighPowerConfig_NotNetConfig_02F1::sendMsg(DvcType dvcType, int dvcId, int meterID, shared_ptr<void> frame)
{
    sendMsgOct.clear();
...
void Script_STAHighPowerConfig_NotNetConfig_02F1::timer_timeoutProc()
{
    p_timer->stop();
    switch(emScriptRunState)
    {
...
void Script_STAHighPowerConfig_NotNetConfig_02F1::delayTimer_timeoutProc()
{
    p_delayTimer->stop();
...
QByteArray Script_STAHighPowerConfig_NotNetConfig_02F1::getQueryFrame(ParaType type)
{
    QByteArray msg;
...
QByteArray Script_STAHighPowerConfig_NotNetConfig_02F1::getSetFrame(ParaType type)
{
    QByteArray msg;
...
void Script_STAHighPowerConfig_NotNetConfig_02F1::maxAllowTimer_timeoutProc()
{
    ...
    switch(emScriptRunState)
    {
        ...
        case Wait_SetSuperpowerPara_0505_Finish:
        {
            p_AbstractScriptHost->updateProgress(ProcessState_Failed, "Wait_SetSuperpowerPara_0505_Finish maxAllow timeout!!!");
            break;
        }
        case Wait_AddSlaveNode_11F1_Finish:
        {
