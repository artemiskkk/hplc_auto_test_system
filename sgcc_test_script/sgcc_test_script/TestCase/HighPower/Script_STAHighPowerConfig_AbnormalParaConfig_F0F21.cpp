#include "Script_STAHighPowerConfig_AbnormalParaConfig_F0F21.h"

Script_STAHighPowerConfig_AbnormalParaConfig_F0F21::Script_STAHighPowerConfig_AbnormalParaConfig_F0F21(QObject *parent) : QObject(parent)
{
...
Script_STAHighPowerConfig_AbnormalParaConfig_F0F21::~Script_STAHighPowerConfig_AbnormalParaConfig_F0F21()
{
...
void Script_STAHighPowerConfig_AbnormalParaConfig_F0F21::execute()
{
...
void Script_STAHighPowerConfig_AbnormalParaConfig_F0F21::stop()
{
...
void Script_STAHighPowerConfig_AbnormalParaConfig_F0F21::addAddrsInfo(const QList<ConcentratorInfo> *p_ConcentratorInfoList, const QList<MeterInfo> *p_MeterInfoList, const QList<SchemeCfgInfo> *p_SchemeCfgInfoList, const int freq)
{
    p_CtrInfoList->clear();
...
void Script_STAHighPowerConfig_AbnormalParaConfig_F0F21::setHost(AbstractScriptHost *host)
{
    p_AbstractScriptHost=host;
    p_BuildNetwork_GW->setHost(host);
}
bool Script_STAHighPowerConfig_AbnormalParaConfig_F0F21::config(const QMap<QString,QString> *paraDic)
{
    bool result = false;
    if(paraDic!=nullptr)
    {
...
void Script_STAHighPowerConfig_AbnormalParaConfig_F0F21::processMsg(DvcType dvcType,int id,uchar* data,int datalen)
{
...
void Script_STAHighPowerConfig_AbnormalParaConfig_F0F21::processCtrlDvcRes(DvcType dvcType,QList<int> idList, CtrlCmdType ctrlCmdType, bool isSucs, QList<double> params)
{
    if(isSucs==false)
        return;
    ...
    switch(emScriptRunState)
    {
        ...
        case Wait_SetSuperpowerPara_0300_Finish:
        {
            break;
        }
        case Wait_QuerySuperpowerPara_0300_Finish:
        {
            break;
        }
        case Wait_SetSuperpowerPara_150F_Finish:
        {
            break;
        }
        case Wait_QuerySuperpowerPara_150F_Finish:
        {
             break;
        }
        case Wait_SetSuperpowerPara_0F01_Finish:
        {
            break;
        }
        case Wait_QuerySuperpowerPara_0F01_Finish:
        {
            break;
        }
        case Wait_SetSuperpowerPara_0F1A_Finish:
        {
             break;
        }
        case Wait_QuerySuperpowerPara_0F1A_Finish:
        {
            break;
        }
...
void Script_STAHighPowerConfig_AbnormalParaConfig_F0F21::sendSrcMsg(DvcType dvcType, int dvcId, QByteArray msg)
{
    if(msg.size()<1)
        return;
...
void Script_STAHighPowerConfig_AbnormalParaConfig_F0F21::processMsgFromCCO(DvcType dvcType, int dvcId)
{
...
//                                em02F1_State=Set_02F1;
                                emConfigSuperpowerParaState_F0F21 = Wait_Config_0300_Finish;
                                sendMsg(CCO_GW,p_CtrInfoList->at(0)->ctrlID,INSIGNIFICANCE,p_ConfigSuperpowerPara_F0F21);
                                p_AbstractScriptHost->updateProgress(ProcessState_Processing, "F0F21配置STA大功率参数_0300，等待--确认");
                                emScriptRunState=Wait_SetSuperpowerPara_0300_Finish;
                                p_timer->start(STA_CMD_TIMEOUT_TIME*1000);
                            }
                            else
                            {
...
//                                    emConfigSuperpowerParaState_F0F21 = Wait_ConfigNormal_Finish;
//                                    sendMsg(CCO_GW,p_CtrInfoList->at(0)->ctrlID,INSIGNIFICANCE,p_ConfigSuperpowerPara_F0F21);
...
//                            }
            ...
            case Wait_SetSuperpowerPara_0300_Finish:
            {
                if(p_Frame3762Base->afn_ == char(0x00)&&p_Frame3762Base->dt1_==0x02&&p_Frame3762Base->dt2_==0x00&&p_Frame3762Base->ctrl_field_.dir == kDirUp)
                {
                    p_timer->stop();
                ...
                if(p_Frame3762Base->afn_ == 0x02&&p_Frame3762Base->dt1_==0x01&&p_Frame3762Base->dt2_==0x00&&p_Frame3762Base->ctrl_field_.dir == kDirUp)
                {
                            ...
                            &&(p_TransparentTransmit_02F1_Up->frame_content_.at(33)==nodeParaList.at(index).peak_clipping_factor))
                    {
                        ...
                        if(index==p_CtrInfoList->at(0)->p_MeterInfoForSingleNetList->size())
                        {
                            ...
                            {
                                index=0;
                                emConfigSuperpowerParaState_F0F21 = Wait_Config_150F_Finish;
                                sendMsg(CCO_GW,p_CtrInfoList->at(0)->ctrlID,INSIGNIFICANCE,p_ConfigSuperpowerPara_F0F21);
                                p_AbstractScriptHost->updateProgress(ProcessState_Processing, "F0F21配置STA大功率参数_150F，等待--确认");
                                emScriptRunState=Wait_SetSuperpowerPara_150F_Finish;
                                p_timer->start(STA_CMD_TIMEOUT_TIME*1000);
                            }
                            else
                            {
                ...
                if(p_Frame3762Base->afn_ == 0x02&&p_Frame3762Base->dt1_==0x01&&p_Frame3762Base->dt2_==0x00&&p_Frame3762Base->ctrl_field_.dir == kDirUp)
                {
                            ...
                            &&(p_TransparentTransmit_02F1_Up->frame_content_.at(33)==nodeParaList.at(index).peak_clipping_factor))
                    {
                        ...
                        if(index==p_CtrInfoList->at(0)->p_MeterInfoForSingleNetList->size())
                        {
                            ...
                            {
                                index=0;
                                emConfigSuperpowerParaState_F0F21 = Wait_Config_0F01_Finish;
                                sendMsg(CCO_GW,p_CtrInfoList->at(0)->ctrlID,INSIGNIFICANCE,p_ConfigSuperpowerPara_F0F21);
                                p_AbstractScriptHost->updateProgress(ProcessState_Processing, "F0F21配置STA大功率参数_0F01，等待--确认");
                                emScriptRunState=Wait_SetSuperpowerPara_0F01_Finish;
                                p_timer->start(STA_CMD_TIMEOUT_TIME*1000);
                            }
                            else
                            {
                ...
                if(p_Frame3762Base->afn_ == 0x02&&p_Frame3762Base->dt1_==0x01&&p_Frame3762Base->dt2_==0x00&&p_Frame3762Base->ctrl_field_.dir == kDirUp)
                {
                            ...
                            &&(p_TransparentTransmit_02F1_Up->frame_content_.at(33)==nodeParaList.at(index).peak_clipping_factor))
                    {
                        ...
                        if(index==p_CtrInfoList->at(0)->p_MeterInfoForSingleNetList->size())
                        {
                            ...
                            {
                                index=0;
                                emConfigSuperpowerParaState_F0F21 = Wait_Config_0F1A_Finish;
                                sendMsg(CCO_GW,p_CtrInfoList->at(0)->ctrlID,INSIGNIFICANCE,p_ConfigSuperpowerPara_F0F21);
                                p_AbstractScriptHost->updateProgress(ProcessState_Processing, "F0F21配置STA大功率参数_0F1A，等待--确认");
                                emScriptRunState=Wait_SetSuperpowerPara_0F1A_Finish;
                                p_timer->start(STA_CMD_TIMEOUT_TIME*1000);
                            }
                            else
                            {
                ...
                if(p_Frame3762Base->afn_ == 0x02&&p_Frame3762Base->dt1_==0x01&&p_Frame3762Base->dt2_==0x00&&p_Frame3762Base->ctrl_field_.dir == kDirUp)
                {
                            ...
                            &&(p_TransparentTransmit_02F1_Up->frame_content_.at(33)==nodeParaList.at(index).peak_clipping_factor))
                    {
                        ...
                        if(index==p_CtrInfoList->at(0)->p_MeterInfoForSingleNetList->size())
                        {
                            ...
                            {
                                index=0;
                                emConfigSuperpowerParaState_F0F21 = Wait_Config_FFFF_Finish;
                                sendMsg(CCO_GW,p_CtrInfoList->at(0)->ctrlID,INSIGNIFICANCE,p_ConfigSuperpowerPara_F0F21);
                                p_AbstractScriptHost->updateProgress(ProcessState_Processing, "F0F21配置STA大功率参数_FFFF，等待--确认");
            ...
            case Wait_SetSuperpowerPara_FFFF_Finish:
            {
                if(p_Frame3762Base->afn_ == char(0x00)&&p_Frame3762Base->dt1_==0x01&&p_Frame3762Base->dt2_==0x00&&p_Frame3762Base->ctrl_field_.dir == kDirUp)
                {
                    p_timer->stop();
                    index=0;
                    p_AbstractScriptHost->updateProgress(ProcessState_Processing,QString("脚本执行成功，%1").arg(test_name_));
                    nodeInfoList.clear();
                    nodeParaList.clear();
...
void Script_STAHighPowerConfig_AbnormalParaConfig_F0F21::processMsgFromMeter645(DvcType dvcType, int dvcId, int mtrlID)
{
    bool haveCompleteMsg=true;
    while(haveCompleteMsg)
    {
...
void Script_STAHighPowerConfig_AbnormalParaConfig_F0F21::processMsgFromMeterOOP(DvcType dvcType, int dvcId, int mtrlID)
{
    bool haveCompleteMsg=true;
    while(haveCompleteMsg)
    {
...
void Script_STAHighPowerConfig_AbnormalParaConfig_F0F21::sendMsg(DvcType dvcType, int dvcId, int meterID, shared_ptr<void> frame)
{
    sendMsgOct.clear();
...
//        p_TransparentTransmit_02F1->frame_content_=getQueryFrame(DAC);
    ...
    else if(frame==p_ConfigSuperpowerPara_F0F21)
    {
        ...
        switch (emConfigSuperpowerParaState_F0F21)
        {
            case Wait_Config_0300_Finish:
            {
                p_ConfigSuperpowerPara_F0F21->dac_voltage_=0x03;
                p_ConfigSuperpowerPara_F0F21->peak_clipping_factor_=0x00;
                break;
            }
            case Wait_Config_150F_Finish:
            {
                p_ConfigSuperpowerPara_F0F21->dac_voltage_=0x15;
                p_ConfigSuperpowerPara_F0F21->peak_clipping_factor_=0x0F;
                break;
            }
            case Wait_Config_0F01_Finish:
            {
                p_ConfigSuperpowerPara_F0F21->dac_voltage_=0x0f;
                p_ConfigSuperpowerPara_F0F21->peak_clipping_factor_=char(0x01);
                break;
            }
            case Wait_Config_0F1A_Finish:
            {
                p_ConfigSuperpowerPara_F0F21->dac_voltage_=0x0f;
                p_ConfigSuperpowerPara_F0F21->peak_clipping_factor_=char(0x1A);
                break;
            }
...
void Script_STAHighPowerConfig_AbnormalParaConfig_F0F21::timer_timeoutProc()
{
    p_timer->stop();
    switch(emScriptRunState)
    {
...
void Script_STAHighPowerConfig_AbnormalParaConfig_F0F21::delayTimer_timeoutProc()
{
    p_delayTimer->stop();
    ...
    case Wait_SetSuperpowerPara_0300_Finish:
    {
        ...
        em02F1_State=Query_02F1;
        sendMsg(CCO_GW,p_CtrInfoList->at(0)->ctrlID,INSIGNIFICANCE,p_TransparentTransmit_02F1);
        emScriptRunState=Wait_QuerySuperpowerPara_0300_Finish;
        p_AbstractScriptHost->updateProgress(ProcessState_Processing, "发送--透传查询从节点大功率参数（0300），等待--回复");
        p_timer->start(STA_CMD_TIMEOUT_TIME*1000);
        break;
    }
    case Wait_SetSuperpowerPara_150F_Finish:
    {
        ...
        em02F1_State=Query_02F1;
        sendMsg(CCO_GW,p_CtrInfoList->at(0)->ctrlID,INSIGNIFICANCE,p_TransparentTransmit_02F1);
        emScriptRunState=Wait_QuerySuperpowerPara_150F_Finish;
        p_AbstractScriptHost->updateProgress(ProcessState_Processing, "发送--透传查询从节点大功率参数（150F），等待--回复");
        p_timer->start(STA_CMD_TIMEOUT_TIME*1000);
        break;
    }
    case Wait_SetSuperpowerPara_0F01_Finish:
    {
        ...
        em02F1_State=Query_02F1;
        sendMsg(CCO_GW,p_CtrInfoList->at(0)->ctrlID,INSIGNIFICANCE,p_TransparentTransmit_02F1);
        emScriptRunState=Wait_QuerySuperpowerPara_0F01_Finish;
        p_AbstractScriptHost->updateProgress(ProcessState_Processing, "发送--透传查询从节点大功率参数（0F01），等待--回复");
        p_timer->start(STA_CMD_TIMEOUT_TIME*1000);
        break;
    }
    case Wait_SetSuperpowerPara_0F1A_Finish:
    {
        ...
        em02F1_State=Query_02F1;
        sendMsg(CCO_GW,p_CtrInfoList->at(0)->ctrlID,INSIGNIFICANCE,p_TransparentTransmit_02F1);
        emScriptRunState=Wait_QuerySuperpowerPara_0F1A_Finish;
        p_AbstractScriptHost->updateProgress(ProcessState_Processing, "发送--透传查询从节点大功率参数（0F1A），等待--回复");
        p_timer->start(STA_CMD_TIMEOUT_TIME*1000);
        break;
    }
    default:
...
QByteArray Script_STAHighPowerConfig_AbnormalParaConfig_F0F21::getQueryFrame(ParaType type)
{
    QByteArray msg;
...
QByteArray Script_STAHighPowerConfig_AbnormalParaConfig_F0F21::getSetFrame(ParaType type)
{
    QByteArray msg;
    ...
    if(type==DAC)
    {
        switch (emConfigSuperpowerParaState_02F1)
        {
            case Wait_Config_0B0B_Finish:
            {
                vol=char(0x0B);
                factor=char(0x0B);
                break;
...
void Script_STAHighPowerConfig_AbnormalParaConfig_F0F21::maxAllowTimer_timeoutProc()
{
