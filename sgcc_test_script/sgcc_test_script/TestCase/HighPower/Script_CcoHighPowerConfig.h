#ifndef SCRIPT_CCOHIGHPOWERCONFIG_H
#define SCRIPT_CCOHIGHPOWERCONFIG_H
 ...
 */
enum Script_CcoHighPowerConfig_RunState
{
    ScriptInit,
    Wait_BuildNetFinish_Whole,
    Wait_QueryHighPower_F0F7_Finish,
    Wait_SetHighPower_F0F8_Finish,
    Wait_RoutePowerOff_Finish,
//    Wait_QueryHighPower1_F0F7_Finish,
    Wait_HardWareInit_01F1_Finish,
    Wait_QueryHighPower1_F0F7_Finish,
    Wait_ParaInit_01F2_Finish,
 ...
 * 适用于必须要重新组网的脚本，如组网测试
 */
class Script_CcoHighPowerConfig :  public QObject, public AbstractScript,public DynamicCreate<Script_CcoHighPowerConfig>
{
    Q_OBJECT
public:
    explicit Script_CcoHighPowerConfig(QObject *parent = nullptr);
    ~Script_CcoHighPowerConfig();
private:
    Script_CcoHighPowerConfig_RunState emScriptRunState=ScriptInit;
    ...
    shared_ptr<qgdw_3762_protocol::Afn01F1>  p_Afn01F1;
    shared_ptr<qgdw_3762_protocol::Afn01F2>  p_Afn01F2;
    ...
    shared_ptr<qgdw_3762_protocol::AfnF0F12>  p_AfnF0F12;
...
#endif // SCRIPT_CCOHIGHPOWERCONFIG_H
