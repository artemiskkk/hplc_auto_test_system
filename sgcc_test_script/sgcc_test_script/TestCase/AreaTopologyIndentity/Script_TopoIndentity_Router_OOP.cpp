#include "Script_TopoIndentity_Router_OOP.h"

Script_TopoIndentity_Router_OOP::Script_TopoIndentity_Router_OOP(QObject *parent) : QObject(parent)
{
...
Script_TopoIndentity_Router_OOP::~Script_TopoIndentity_Router_OOP()
{
...
void Script_TopoIndentity_Router_OOP::execute()
{
...
void Script_TopoIndentity_Router_OOP::stop()
{
...
void Script_TopoIndentity_Router_OOP::addAddrsInfo(const QList<ConcentratorInfo> *p_ConcentratorInfoList, const QList<MeterInfo> *p_MeterInfoList, const QList<SchemeCfgInfo> *p_SchemeCfgInfoList, const int freq)
{
    p_CtrInfoList->clear();
...
void Script_TopoIndentity_Router_OOP::setHost(AbstractScriptHost *host)
{
    p_AbstractScriptHost=host;
    p_BuildNetwork_GW->setHost(host);
}
bool Script_TopoIndentity_Router_OOP::config(const QMap<QString,QString> *paraDic)
{
    bool result = false;
    if(paraDic!=nullptr)
    {
...
void Script_TopoIndentity_Router_OOP::processMsg(DvcType dvcType, int id, uchar *data, int datalen)
{
...
void Script_TopoIndentity_Router_OOP::processCtrlDvcRes(DvcType dvcType, QList<int> idList, CtrlCmdType ctrlCmdType, bool isSucs, QList<double> params)
{
    if(isSucs==false)
        return;
...
void Script_TopoIndentity_Router_OOP::processMsgFromCCO(DvcType dvcType, int dvcId)
{
...
void Script_TopoIndentity_Router_OOP::processMsgFromMeter645(DvcType dvcType, int dvcId, int mtrlID)
{
    bool haveCompleteMsg=true;
    while(haveCompleteMsg)
    {
...
void Script_TopoIndentity_Router_OOP::processMsgFromMeterOOP(DvcType dvcType, int dvcId, int mtrlID)
{
    bool haveCompleteMsg=true;
    while(haveCompleteMsg)
    {
...
void Script_TopoIndentity_Router_OOP::sendMsg(DvcType dvcType, int dvcId, int meterID, shared_ptr<void> frame)
{
    ...
    else if(frame==p_MonitorSlaveNode_13F1)
    {
        ...
        else if(comPrtclType==0x03)
        {
            ...
            //dynamic_pointer_cast<DataList>(p_ActionRequest->a_action_.data_ptr)->list_data_member_.append();
...
void Script_TopoIndentity_Router_OOP::sendSrcMsg(DvcType dvcType, int dvcId, QByteArray msg)
{
    if(msg.size()<1)
        return;
...
void Script_TopoIndentity_Router_OOP::timer_timeoutProc()
{
    switch(emScriptRunState)
    {
        case Wait_BuildNetFinish_Whole:
...
void Script_TopoIndentity_Router_OOP::maxAllowTimer_timeoutProc()
{
    switch(emScriptRunState)
    {
        case Wait_Finish_13F1:
...
void Script_TopoIndentity_Router_OOP::delayTimer_timeoutProc()
{
    p_delayTimer->stop();
...
void Script_TopoIndentity_Router_OOP::readInfoInit()
{
