#ifndef SCRIPT_TOPOINDENTITY_COM_FACTORY645_H
#define SCRIPT_TOPOINDENTITY_COM_FACTORY645_H

#include <QObject>
#include "TestCase/BuildNetwork_GW.h"
enum Script_TopoIndentity_Com_Factory645_RunState
{
    ReadMeterInit,
...
class Script_TopoIndentity_Com_Factory645 : public QObject, public AbstractScript,public DynamicCreate<Script_TopoIndentity_Com_Factory645>
{
    Q_OBJECT//抄表时间问题
//    Q_PLUGIN_METADATA(IID "com.topscomm.AbstractScript")
//    Q_INTERFACES(AbstractScript)
public:
    explicit Script_TopoIndentity_Com_Factory645(QObject *parent = nullptr);
    ~Script_TopoIndentity_Com_Factory645();

    Script_TopoIndentity_Com_Factory645_RunState emScriptRunState;
...
#endif // SCRIPT_TOPOINDENTITY_COM_FACTORY645_H
