#ifndef SCRIPT_TOPOINDENTITY_ROUTER_645_H
#define SCRIPT_TOPOINDENTITY_ROUTER_645_H

#include <QObject>
#include "TestCase/BuildNetwork_GW.h"
enum Script_TopoIndentity_Router_645_RunState
{
    ReadMeterInit,
...
class Script_TopoIndentity_Router_645 : public QObject, public AbstractScript,public DynamicCreate<Script_TopoIndentity_Router_645>
{
    Q_OBJECT//抄表时间问题
//    Q_PLUGIN_METADATA(IID "com.topscomm.AbstractScript")
//    Q_INTERFACES(AbstractScript)
public:
    explicit Script_TopoIndentity_Router_645(QObject *parent = nullptr);
    ~Script_TopoIndentity_Router_645();

    Script_TopoIndentity_Router_645_RunState emScriptRunState;
...
private:
    ...
    void processMsgFromCJQ(DvcType dvcType, int dvcId, int mtrlID);
    void sendMsg(DvcType dvcType, int dvcId, int meterID, shared_ptr<void> frame);
    void sendSrcMsg(DvcType dvcType,int dvcId,QByteArray msg);
};
#endif // SCRIPT_TOPOINDENTITY_ROUTER_645_H
