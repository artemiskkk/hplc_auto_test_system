#include "Script_TopoIndentity_Controller_OOP.h"

Script_TopoIndentity_Controller_OOP::Script_TopoIndentity_Controller_OOP(QObject *parent) : QObject(parent)
{
...
Script_TopoIndentity_Controller_OOP::~Script_TopoIndentity_Controller_OOP()
{
...
void Script_TopoIndentity_Controller_OOP::execute()
{
...
void Script_TopoIndentity_Controller_OOP::stop()
{
...
void Script_TopoIndentity_Controller_OOP::addAddrsInfo(const QList<ConcentratorInfo> *p_ConcentratorInfoList, const QList<MeterInfo> *p_MeterInfoList, const QList<SchemeCfgInfo> *p_SchemeCfgInfoList, const int freq)
{
    p_CtrInfoList->clear();
...
void Script_TopoIndentity_Controller_OOP::setHost(AbstractScriptHost *host)
{
    p_AbstractScriptHost=host;
    p_BuildNetwork_GW->setHost(host);
}
bool Script_TopoIndentity_Controller_OOP::config(const QMap<QString,QString> *paraDic)
{
    bool result = false;
    if(paraDic!=nullptr)
    {
...
void Script_TopoIndentity_Controller_OOP::processMsg(DvcType dvcType, int id, uchar *data, int datalen)
{
...
void Script_TopoIndentity_Controller_OOP::processCtrlDvcRes(DvcType dvcType, QList<int> idList, CtrlCmdType ctrlCmdType, bool isSucs, QList<double> params)
{
    if(isSucs==false)
        return;
...
void Script_TopoIndentity_Controller_OOP::processMsgFromCCO(DvcType dvcType, int dvcId)
{
...
void Script_TopoIndentity_Controller_OOP::processMsgFromMeter645(DvcType dvcType, int dvcId, int mtrlID)
{
    bool haveCompleteMsg=true;
    while(haveCompleteMsg)
    {
...
void Script_TopoIndentity_Controller_OOP::processMsgFromMeterOOP(DvcType dvcType, int dvcId, int mtrlID)
{
    bool haveCompleteMsg=true;
    while(haveCompleteMsg)
    {
...
void Script_TopoIndentity_Controller_OOP::sendMsg(DvcType dvcType, int dvcId, int meterID, shared_ptr<void> frame)
{
...
void Script_TopoIndentity_Controller_OOP::sendSrcMsg(DvcType dvcType, int dvcId, QByteArray msg)
{
    if(msg.size()<1)
        return;
...
void Script_TopoIndentity_Controller_OOP::timer_timeoutProc()
{
    switch(emScriptRunState)
    {
        case Wait_BuildNetFinish_Whole:
...
void Script_TopoIndentity_Controller_OOP::maxAllowTimer_timeoutProc()
{
    switch(emScriptRunState)
    {
        case Wait_Finish_SendOOPData:
...
void Script_TopoIndentity_Controller_OOP::delayTimer_timeoutProc()
{
    p_delayTimer->stop();
...
void Script_TopoIndentity_Controller_OOP::readInfoInit()
{
