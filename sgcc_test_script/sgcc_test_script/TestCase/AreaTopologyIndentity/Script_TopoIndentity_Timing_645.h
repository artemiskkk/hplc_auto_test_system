#ifndef SCRIPT_TOPOINDENTITY_TIMING_645_H
#define SCRIPT_TOPOINDENTITY_TIMING_645_H

#include <QObject>
#include "TestCase/BuildNetwork_GW.h"
enum Script_TopoIndentity_Timing_645_RunState
{
    ReadMeterInit,
...
class Script_TopoIndentity_Timing_645 : public QObject, public AbstractScript,public DynamicCreate<Script_TopoIndentity_Timing_645>
{
    Q_OBJECT//抄表时间问题
//    Q_PLUGIN_METADATA(IID "com.topscomm.AbstractScript")
//    Q_INTERFACES(AbstractScript)
public:
    explicit Script_TopoIndentity_Timing_645(QObject *parent = nullptr);
    ~Script_TopoIndentity_Timing_645();

    Script_TopoIndentity_Timing_645_RunState emScriptRunState;
...
#endif // SCRIPT_TOPOINDENTITY_TIMING_645_H
