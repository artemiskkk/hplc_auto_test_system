#ifndef SCRIPT_TOPOINDENTITY_ROUTER_OOP_H
#define SCRIPT_TOPOINDENTITY_ROUTER_OOP_H

#include <QObject>
#include <QDateTime>
#include "TestCase/BuildNetwork_GW.h"
enum Script_TopoIndentity_Router_OOP_RunState
{
    ReadMeterInit,
...
class Script_TopoIndentity_Router_OOP : public QObject, public AbstractScript,public DynamicCreate<Script_TopoIndentity_Router_OOP>
{
    Q_OBJECT//抄表时间问题
//    Q_PLUGIN_METADATA(IID "com.topscomm.AbstractScript")
//    Q_INTERFACES(AbstractScript)
public:
    explicit Script_TopoIndentity_Router_OOP(QObject *parent = nullptr);
    ~Script_TopoIndentity_Router_OOP();

    Script_TopoIndentity_Router_OOP_RunState emScriptRunState;
...
#endif // SCRIPT_TOPOINDENTITY_ROUTER_OOP_H
