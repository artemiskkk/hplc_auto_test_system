#ifndef SCRIPT_MINUTECOLLECT_CALIBRATIONTIME_H
#define SCRIPT_MINUTECOLLECT_CALIBRATIONTIME_H

#include <QObject>
#include "TestCase/BuildNetwork_GW.h"

enum Script_MinuteCollect_CalibrationTime_RunState
{
    ReadMeterInit,
...
class Script_MinuteCollect_CalibrationTime : public QObject, public AbstractScript,public DynamicCreate<Script_MinuteCollect_CalibrationTime>
{
    Q_OBJECT
public:
    explicit Script_MinuteCollect_CalibrationTime(QObject *parent = nullptr);
    ~Script_MinuteCollect_CalibrationTime();

    Script_MinuteCollect_CalibrationTime_RunState emScriptRunState;
    //**发送OOP报文类型
    ...
    //shared_ptr<QList<shared_ptr<MeterInfoForSingleNet>>> p_MeterInfoForSingleNet;
    ...
    shared_ptr<ActionRequest> p_ActionRequest_RollCallReport;
 //   shared_ptr<ReportResponseRecordList>
...
#endif // SCRIPT_MINUTECOLLECT_CALIBRATIONTIME_H
