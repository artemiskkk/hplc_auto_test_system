#ifndef SCRIPT_READMETER_F1F1_DELAYTIME20S_H
#define SCRIPT_READMETER_F1F1_DELAYTIME20S_H

#include <QObject>
#include "TestCase/BuildNetwork_GW.h"

enum Script_ReadMeter_F1F1_DelayTime20s_RunState
{
    ReadMeterInit,
...
class Script_ReadMeter_F1F1_DelayTime20s : public QObject, public AbstractScript,public DynamicCreate<Script_ReadMeter_F1F1_DelayTime20s>
{
    Q_OBJECT
public:
    explicit Script_ReadMeter_F1F1_DelayTime20s(QObject *parent = nullptr);
    ~Script_ReadMeter_F1F1_DelayTime20s();

    Script_ReadMeter_F1F1_DelayTime20s_RunState emScriptRunState;
    ...
    //**不应答表地址
//    uchar meAdder[6]={11,00,00,00,00,00};//**645
//    uchar meAdderOOP[6]={11,00,00,00,00,00};//**OOP
    QString meAdder="000000000011";
...
#endif // SCRIPT_READMETER_F1F1_DELAYTIME20S_H
