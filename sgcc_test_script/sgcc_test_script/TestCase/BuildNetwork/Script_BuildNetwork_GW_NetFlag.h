#ifndef SCRIPT_BUILDNETWORK_GW_NETFLAG_H
#define SCRIPT_BUILDNETWORK_GW_NETFLAG_H
 ...
 */
enum Script_BuildNetwork_GW_NetFlag_RunState
{
    ScriptInit,
    Wait_BuildNetFinish_Whole,
    Wait_RouterParaInit_01F2_Finish,
    Wait_AddNodes_11F1_Finish,
    Wait_QueryRouterRunMode_10F4_Finish,
    ScriptSuccess
};
/**
 ...
 * 适用于必须要重新组网的脚本，如组网测试
 */
class Script_BuildNetwork_GW_NetFlag :  public QObject, public AbstractScript,public DynamicCreate<Script_BuildNetwork_GW_NetFlag>
{
    Q_OBJECT
public:
    explicit Script_BuildNetwork_GW_NetFlag(QObject *parent = nullptr);
    ~Script_BuildNetwork_GW_NetFlag();
private:
    Script_BuildNetwork_GW_NetFlag_RunState emScriptRunState=ScriptInit;
...
#endif // SCRIPT_BUILDNETWORK_GW_NETFLAG_H
