#ifndef SCRIPT_SEARCHMETERWITHOUTNODES_GW_NETFLAG_H
#define SCRIPT_SEARCHMETERWITHOUTNODES_GW_NETFLAG_H
 ...
 */
enum Script_SearchMeterWithOutNodes_GW_NetFlag_RunState
{
    ScriptInit,
    Wait_BuildNetFinish_Whole,
    Wait_RouterParaInit_01F2_Finish,
    Wait_StartRegister_11F5_Finish,
    Wait_Cmd1_QueryRouterRunMode_10F4_Finish,
    Wait_RouterReportNodes_06F4_Finish,
    Wait_Cmd2_QueryRouterRunMode_10F4_Finish,
    ScriptSuccess
};
/**
 ...
 * 适用于必须要重新组网的脚本，如组网测试
 */
class Script_SearchMeterWithOutNodes_GW_NetFlag :  public QObject, public AbstractScript,public DynamicCreate<Script_SearchMeterWithOutNodes_GW_NetFlag>
{
    Q_OBJECT
public:
    explicit Script_SearchMeterWithOutNodes_GW_NetFlag(QObject *parent = nullptr);
    ~Script_SearchMeterWithOutNodes_GW_NetFlag();
private:
    Script_SearchMeterWithOutNodes_GW_NetFlag_RunState emScriptRunState=ScriptInit;
    ...
    shared_ptr<qgdw_3762_protocol::Afn11F5>  p_Afn11F5;
    shared_ptr<qgdw_3762_protocol::Afn10F4>  p_Afn10F4;
    shared_ptr<qgdw_3762_protocol::Afn00F1>  p_Afn00F1;
...
#endif // SCRIPT_SEARCHMETERWITHOUTNODES_GW_NETFLAG_H
