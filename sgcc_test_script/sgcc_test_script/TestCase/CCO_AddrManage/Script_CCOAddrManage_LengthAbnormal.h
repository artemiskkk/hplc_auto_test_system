#ifndef SCRIPT_CCOADDRMANAGE_LENGTHABNORMAL_H
#define SCRIPT_CCOADDRMANAGE_LENGTHABNORMAL_H
...
/**
 * @brief The Script_CCOAddrManage_LengthAbnormal_RunState 运行状态机
 */
enum Script_CCOAddrManage_LengthAbnormal_RunState
{
    ScriptInit,
    Wait_BuildNetFinish_Whole,
    Wait_SetCCOAddress_05F1_Finish,
    Wait_QueryCCOAddress_Finish,

    Wait_SetCCOAddress1_05F1_Finish,
    Wait_QueryCCOAddress1_Finish,

    Wait_SetCCOAddress2_05F1_Finish,
    Wait_QueryCCOAddress2_Finish,

    Wait_SetCCOAddress3_05F1_Finish,
    Wait_QueryCCOAddress3_Finish,

    Wait_SetCCOAddress4_05F1_Finish,
    Wait_QueryCCOAddress4_Finish,

    Wait_SetCCOAddress5_05F1_Finish,
    Wait_QueryCCOAddress5_Finish,

    Wait_SetCCOAddress6_05F1_Finish,
    Wait_QueryCCOAddress6_Finish,

    ScriptSuccess
};

/**
 * @brief The Script_CCOAddrManage_LengthAbnormal CCO主节点设置-长度异常 【GW-CCO-F015-0002-V01】
 * refs #3243 新增修改点 05F1判断了配置路由地址长度不等于6都是错误
 */
class Script_CCOAddrManage_LengthAbnormal :  public QObject, public AbstractScript,public DynamicCreate<Script_CCOAddrManage_LengthAbnormal>
{
    Q_OBJECT
public:
    explicit Script_CCOAddrManage_LengthAbnormal(QObject *parent = nullptr);
    ~Script_CCOAddrManage_LengthAbnormal();
private:
    Script_CCOAddrManage_LengthAbnormal_RunState emScriptRunState = ScriptInit;
...
#endif // SCRIPT_CCOADDRMANAGE_LENGTHABNORMAL_H
