#ifndef SCRIPT_READMETER_F1F1_SAMEMETERNEWFRAME_H
#define SCRIPT_READMETER_F1F1_SAMEMETERNEWFRAME_H

#include <QObject>
#include "TestCase/BuildNetwork_GW.h"
enum Script_ReadMeter_F1F1_SameMeterNewFrame_RunState
{
    ReadMeterInit,
    Wait_BuildNetFinish_Whole,
    Wait_00F1_for_12F2_Pause,
    Wait_00F2_for_sameF1F1,
...
class Script_ReadMeter_F1F1_SameMeterNewFrame : public QObject, public AbstractScript,public DynamicCreate<Script_ReadMeter_F1F1_SameMeterNewFrame>
{
    Q_OBJECT
//    Q_PLUGIN_METADATA(IID "com.topscomm.AbstractScript")
//    Q_INTERFACES(AbstractScript)
public:
    explicit Script_ReadMeter_F1F1_SameMeterNewFrame(QObject *parent = nullptr);
    ~Script_ReadMeter_F1F1_SameMeterNewFrame();

    Script_ReadMeter_F1F1_SameMeterNewFrame_RunState emScriptRunState;
  ...
  //  ushort times=0;
    ...
    //并发抄表参数
    const int maxFrameNum=1;//单帧最大报文数
    const int maxParallelNum=4;//最大并行数
...
#endif // SCRIPT_READMETER_F1F1_SAMEMETERNEWFRAME_H
