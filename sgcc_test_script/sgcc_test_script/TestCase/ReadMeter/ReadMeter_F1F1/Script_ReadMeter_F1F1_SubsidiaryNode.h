#ifndef SCRIPT_READMETER_F1F1_SUBSIDIARYNODE_H
#define SCRIPT_READMETER_F1F1_SUBSIDIARYNODE_H

#include <QObject>
#include "TestCase/BuildNetwork_GW.h"
enum Script_ReadMeter_F1F1_SubsidiaryNode_RunState
{
    ReadMeterInit,
...
class Script_ReadMeter_F1F1_SubsidiaryNode : public QObject, public AbstractScript,public DynamicCreate<Script_ReadMeter_F1F1_SubsidiaryNode>
{
    Q_OBJECT
//    Q_PLUGIN_METADATA(IID "com.topscomm.AbstractScript")
//    Q_INTERFACES(AbstractScript)
public:
    explicit Script_ReadMeter_F1F1_SubsidiaryNode(QObject *parent = nullptr);
    ~Script_ReadMeter_F1F1_SubsidiaryNode();

    Script_ReadMeter_F1F1_SubsidiaryNode_RunState emScriptRunState;
    ...
    //并发抄表参数
    const int maxFrameNum=4;//单帧最大报文数
...
#endif // SCRIPT_READMETER_F1F1_SUBSIDIARYNODE_H
