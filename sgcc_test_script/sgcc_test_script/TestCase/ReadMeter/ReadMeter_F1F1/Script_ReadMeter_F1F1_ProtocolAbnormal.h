#ifndef SCRIPT_READMETER_F1F1_PROTOCOLABNORMAL_H
#define SCRIPT_READMETER_F1F1_PROTOCOLABNORMAL_H

#include <QObject>
#include "TestCase/BuildNetwork_GW.h"
enum Script_ReadMeter_F1F1_ProtocolAbnormal_RunState
{
    ReadMeterInit,
...
class Script_ReadMeter_F1F1_ProtocolAbnormal : public QObject, public AbstractScript,public DynamicCreate<Script_ReadMeter_F1F1_ProtocolAbnormal>
{
    Q_OBJECT
    //    Q_PLUGIN_METADATA(IID "com.topscomm.AbstractScript")
    //    Q_INTERFACES(AbstractScript)
public:
    explicit Script_ReadMeter_F1F1_ProtocolAbnormal(QObject *parent = nullptr);
    ~Script_ReadMeter_F1F1_ProtocolAbnormal();

    Script_ReadMeter_F1F1_ProtocolAbnormal_RunState emScriptRunState;
...
#endif // SCRIPT_READMETER_F1F1_PROTOCOLABNORMAL_H
