#ifndef SCRIPT_READMETER_F1F1_NOTBUILDNET_H
#define SCRIPT_READMETER_F1F1_NOTBUILDNET_H

#include <QObject>
#include "TestCase/BuildNetwork_GW.h"
enum Script_ReadMeter_F1F1_NotBuildNet_RunState
{
    ReadMeterInit,
...
class Script_ReadMeter_F1F1_NotBuildNet : public QObject, public AbstractScript,public DynamicCreate<Script_ReadMeter_F1F1_NotBuildNet>
{
    Q_OBJECT
//    Q_PLUGIN_METADATA(IID "com.topscomm.AbstractScript")
//    Q_INTERFACES(AbstractScript)
public:
    explicit Script_ReadMeter_F1F1_NotBuildNet(QObject *parent = nullptr);
    ~Script_ReadMeter_F1F1_NotBuildNet();

    Script_ReadMeter_F1F1_NotBuildNet_RunState emScriptRunState;
...
#endif // SCRIPT_READMETER_F1F1_NOTBUILDNET_H
