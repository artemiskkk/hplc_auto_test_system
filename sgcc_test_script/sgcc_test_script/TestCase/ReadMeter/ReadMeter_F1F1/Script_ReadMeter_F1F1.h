#ifndef SCRIPT_READMETER_F1F1_H
#define SCRIPT_READMETER_F1F1_H

#include <QObject>
#include "TestCase/BuildNetwork_GW.h"
enum Script_ReadMeter_F1F1_RunState
{
    ReadMeterInit,
...
class Script_ReadMeter_F1F1 : public QObject, public AbstractScript,public DynamicCreate<Script_ReadMeter_F1F1>
{
    Q_OBJECT
//    Q_PLUGIN_METADATA(IID "com.topscomm.AbstractScript")
//    Q_INTERFACES(AbstractScript)
public:
    explicit Script_ReadMeter_F1F1(QObject *parent = nullptr);
    ~Script_ReadMeter_F1F1();

    Script_ReadMeter_F1F1_RunState emScriptRunState;
