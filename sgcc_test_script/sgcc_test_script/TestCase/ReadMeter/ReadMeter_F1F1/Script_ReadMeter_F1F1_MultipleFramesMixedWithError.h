#ifndef SCRIPT_READMETER_F1F1_MULTIPLEFRAMESMIXEDWITHERROR_H
#define SCRIPT_READMETER_F1F1_MULTIPLEFRAMESMIXEDWITHERROR_H

#include <QObject>
#include "TestCase/BuildNetwork_GW.h"
enum Script_ReadMeter_F1F1_MultipleFramesMixedWithError_RunState
{
    ReadMeterInit,
    Wait_BuildNetFinish_Whole,
    Wait_00F1_for_12F2_Pause,
    Wait_F1F1_MeterReadProtocolType_Finish,
    Wait_F1F1_MeterReadErrorByte_Finish,
    Wait_F1F1_MeterReadDataError_Finish,
    ScriptSuccess
};
...
class Script_ReadMeter_F1F1_MultipleFramesMixedWithError : public QObject, public AbstractScript,public DynamicCreate<Script_ReadMeter_F1F1_MultipleFramesMixedWithError>
{
    Q_OBJECT
    //    Q_PLUGIN_METADATA(IID "com.topscomm.AbstractScript")
    //    Q_INTERFACES(AbstractScript)
public:
    explicit Script_ReadMeter_F1F1_MultipleFramesMixedWithError(QObject *parent = nullptr);
    ~Script_ReadMeter_F1F1_MultipleFramesMixedWithError();

    Script_ReadMeter_F1F1_MultipleFramesMixedWithError_RunState emScriptRunState;
...
#endif // SCRIPT_READMETER_F1F1_MULTIPLEFRAMESMIXEDWITHERROR_H
