#ifndef SCRIPT_READMETER_F1F1_SEARCHMETER_H
#define SCRIPT_READMETER_F1F1_SEARCHMETER_H

#include <QObject>
#include "TestCase/BuildNetwork_GW.h"
enum Script_ReadMeter_F1F1_SearchMeter_RunState
{
    ReadMeterInit,
...
class Script_ReadMeter_F1F1_SearchMeter : public QObject, public AbstractScript,public DynamicCreate<Script_ReadMeter_F1F1_SearchMeter>
{
    Q_OBJECT
//    Q_PLUGIN_METADATA(IID "com.topscomm.AbstractScript")
//    Q_INTERFACES(AbstractScript)
public:
    explicit Script_ReadMeter_F1F1_SearchMeter(QObject *parent = nullptr);
    ~Script_ReadMeter_F1F1_SearchMeter();

    Script_ReadMeter_F1F1_SearchMeter_RunState emScriptRunState;
    ...
    bool searchMeterReportFlag=false,searchMeterEndFlag=false,finalWaitFlag=false;
...
#endif // SCRIPT_READMETER_F1F1_SEARCHMETER_H
