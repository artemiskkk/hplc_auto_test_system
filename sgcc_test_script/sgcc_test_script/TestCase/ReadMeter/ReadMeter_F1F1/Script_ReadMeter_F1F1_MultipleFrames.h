#ifndef SCRIPT_READMETER_F1F1_MULTIPLEFRAMES_H
#define SCRIPT_READMETER_F1F1_MULTIPLEFRAMES_H

#include <QObject>
#include "TestCase/BuildNetwork_GW.h"
enum Script_ReadMeter_F1F1_MultipleFrames_RunState
{
    ReadMeterInit,
    Wait_BuildNetFinish_Whole,
    Wait_00F1_for_12F2_Pause,
    Wait_F1F1_MeterRead1oop5oad_Finish,
    Wait_F1F1_MeterRead5oop1oad_Finish,
    ScriptSuccess
};
...
class Script_ReadMeter_F1F1_MultipleFrames : public QObject, public AbstractScript,public DynamicCreate<Script_ReadMeter_F1F1_MultipleFrames>
{
    Q_OBJECT
    //    Q_PLUGIN_METADATA(IID "com.topscomm.AbstractScript")
    //    Q_INTERFACES(AbstractScript)
public:
    explicit Script_ReadMeter_F1F1_MultipleFrames(QObject *parent = nullptr);
    ~Script_ReadMeter_F1F1_MultipleFrames();

    Script_ReadMeter_F1F1_MultipleFrames_RunState emScriptRunState;
...
#endif // SCRIPT_READMETER_F1F1_MULTIPLEFRAMES_H
