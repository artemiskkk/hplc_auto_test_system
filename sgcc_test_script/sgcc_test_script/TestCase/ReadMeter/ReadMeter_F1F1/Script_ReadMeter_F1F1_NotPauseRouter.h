#ifndef SCRIPT_READMETER_F1F1_NOTPAUSEROUTER_H
#define SCRIPT_READMETER_F1F1_NOTPAUSEROUTER_H

#include <QObject>
#include "TestCase/BuildNetwork_GW.h"
enum Script_ReadMeter_F1F1_NotPauseRouter_RunState
{
    ReadMeterInit,
...
class Script_ReadMeter_F1F1_NotPauseRouter : public QObject, public AbstractScript,public DynamicCreate<Script_ReadMeter_F1F1_NotPauseRouter>
{
    Q_OBJECT
//    Q_PLUGIN_METADATA(IID "com.topscomm.AbstractScript")
//    Q_INTERFACES(AbstractScript)
public:
    explicit Script_ReadMeter_F1F1_NotPauseRouter(QObject *parent = nullptr);
    ~Script_ReadMeter_F1F1_NotPauseRouter();

    Script_ReadMeter_F1F1_NotPauseRouter_RunState emScriptRunState;
    ...
    int maxParallelNum=1;//最大并行数
    int maxParallelNumTemp=5;//最大并行数
...
#endif // SCRIPT_READMETER_F1F1_NOTPAUSEROUTER_H
