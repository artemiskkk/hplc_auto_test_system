#ifndef SCRIPT_READMETER_F1F1_QUERYRUNSTATE_H
#define SCRIPT_READMETER_F1F1_QUERYRUNSTATE_H

#include <QObject>
#include "TestCase/BuildNetwork_GW.h"
enum Script_ReadMeter_F1F1_QueryRunState_RunState
{
    ReadMeterInit,
    Wait_BuildNetFinish_Whole,
    Wait_00F1_for_12F2_Pause,
    Wait_10F4_RouterRunState_Finish,
    Wait_10F4_MeterPowerOffRouterRunState_Finish,
    Wait_10F4_RouterRunState1_Finish,
    Wait_10F4_MeterPowerOnRouterRunState_Finish,
    Wait_10F4_RouterRunState2_Finish,
    ScriptSuccess
};
...
class Script_ReadMeter_F1F1_QueryRunState : public QObject, public AbstractScript,public DynamicCreate<Script_ReadMeter_F1F1_QueryRunState>
{
    Q_OBJECT
    //    Q_PLUGIN_METADATA(IID "com.topscomm.AbstractScript")
    //    Q_INTERFACES(AbstractScript)
public:
    explicit Script_ReadMeter_F1F1_QueryRunState(QObject *parent = nullptr);
    ~Script_ReadMeter_F1F1_QueryRunState();

    Script_ReadMeter_F1F1_QueryRunState_RunState emScriptRunState;
...
#endif // SCRIPT_READMETER_F1F1_QUERYRUNSTATE_H
