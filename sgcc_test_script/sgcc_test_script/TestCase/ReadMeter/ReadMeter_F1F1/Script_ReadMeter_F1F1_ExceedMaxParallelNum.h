#ifndef SCRIPT_READMETER_F1F1_EXCEEDMAXPARALLELNUM_H
#define SCRIPT_READMETER_F1F1_EXCEEDMAXPARALLELNUM_H

#include <QObject>
#include "TestCase/BuildNetwork_GW.h"
enum Script_ReadMeter_F1F1_ExceedMaxParallelNum_RunState
{
    ReadMeterInit,
...
class Script_ReadMeter_F1F1_ExceedMaxParallelNum : public QObject, public AbstractScript,public DynamicCreate<Script_ReadMeter_F1F1_ExceedMaxParallelNum>
{
    Q_OBJECT
//    Q_PLUGIN_METADATA(IID "com.topscomm.AbstractScript")
//    Q_INTERFACES(AbstractScript)
public:
    explicit Script_ReadMeter_F1F1_ExceedMaxParallelNum(QObject *parent = nullptr);
    ~Script_ReadMeter_F1F1_ExceedMaxParallelNum();

    Script_ReadMeter_F1F1_ExceedMaxParallelNum_RunState emScriptRunState;
    ...
    //并发抄表参数
    int maxFrameNum=16;//单帧最大报文数 路由最大支持13条
    int maxParallelNum=22;//最大并行数10
...
#endif // SCRIPT_READMETER_F1F1_EXCEEDMAXPARALLELNUM_H
