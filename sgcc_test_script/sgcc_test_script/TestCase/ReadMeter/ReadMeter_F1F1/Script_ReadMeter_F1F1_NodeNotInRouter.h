#ifndef SCRIPT_READMETER_F1F1_NODENOTINROUTER_H
#define SCRIPT_READMETER_F1F1_NODENOTINROUTER_H

#include <QObject>
#include "TestCase/BuildNetwork_GW.h"
enum Script_ReadMeter_F1F1_NodeNotInRouter_RunState
{
    ReadMeterInit,
...
class Script_ReadMeter_F1F1_NodeNotInRouter : public QObject, public AbstractScript,public DynamicCreate<Script_ReadMeter_F1F1_NodeNotInRouter>
{
    Q_OBJECT
//    Q_PLUGIN_METADATA(IID "com.topscomm.AbstractScript")
//    Q_INTERFACES(AbstractScript)
public:
    explicit Script_ReadMeter_F1F1_NodeNotInRouter(QObject *parent = nullptr);
    ~Script_ReadMeter_F1F1_NodeNotInRouter();

    Script_ReadMeter_F1F1_NodeNotInRouter_RunState emScriptRunState;
    ...
    shared_ptr<Afn11F2> p_DeleteNode_11F2;
...
#endif // SCRIPT_READMETER_F1F1_NODENOTINROUTER_H
