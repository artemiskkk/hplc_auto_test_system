#ifndef SCRIPT_READMETER_13F1_CONTRLAREA_H
#define SCRIPT_READMETER_13F1_CONTRLAREA_H
...
enum Script_Template_RebuildNetWork_RunState
{
    ...
    Wait_13F1_MeterRead01_Finish,
    Wait_13F1_MeterRead00_Finish,
    Wait_13F1_MeterRead10_Finish,
    Wait_13F1_MeterRead11_Finish,
    ScriptSuccess
};
/**
...
class Script_ReadMeter_13F1_ContrlArea :  public QObject, public AbstractScript,public DynamicCreate<Script_ReadMeter_13F1_ContrlArea>
{
    Q_OBJECT
public:
    explicit Script_ReadMeter_13F1_ContrlArea(QObject *parent = nullptr);
    ~Script_ReadMeter_13F1_ContrlArea();
private:
...
#endif // SCRIPT_READMETER_13F1_CONTRLAREA_H
