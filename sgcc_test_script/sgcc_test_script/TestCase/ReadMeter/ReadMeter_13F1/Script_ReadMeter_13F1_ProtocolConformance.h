#ifndef SCRIPT_READMETER_13F1_PROTOCOLCONFORMANCE_H
#define SCRIPT_READMETER_13F1_PROTOCOLCONFORMANCE_H
...
enum Script_Template_RebuildNetWork_RunState
{
    ...
    Wait_13F1_ReadMeter645_00_Finish,
    Wait_13F1_ReadMeter645_02_Finish,
    Wait_13F1_ReadMeter698_03_Finish,
    Wait_13F1_ReadMeter698645_03_Finish,
    Wait_13F1_ReadMeter645_03_Finish,
    Wait_13F1_ReadMeter645_04_Finish,
    Wait_13F1_ReadMeter645_ff_Finish,
    Wait_13F1_ReadMeter645_DelaySign00_Finish,
    Wait_13F1_ReadMeter645_DelaySign01_Finish,
    Wait_14F3_ReadMeter645_Finish,
    Wait_13F1_ReadMeter645_DelaySign02_Finish,
    Wait_13F1_ReadMeter645_DelaySign03_Finish,
    Wait_13F1_ReadMeter645_len0_Finish,
    Wait_13F1_ReadMeter645_len1_Finish,
    Wait_13F1_ReadMeter645_lenFF_Finish,
    Wait_13F1_ReadMeter645_lenFFFF_Finish,
    ScriptSuccess
};
/**
...
class Script_ReadMeter_13F1_ProtocolConformance :  public QObject, public AbstractScript,public DynamicCreate<Script_ReadMeter_13F1_ProtocolConformance>
{
    Q_OBJECT
public:
    explicit Script_ReadMeter_13F1_ProtocolConformance(QObject *parent = nullptr);
    ~Script_ReadMeter_13F1_ProtocolConformance();
...
private:
    ...
    shared_ptr<Afn14F3> p_DelayCorrect_14F3;
    ...
    QList<MeterInfo> p_tmp_645_list;
    QList<MeterInfo> p_tmp_698_list;
    QList<MeterInfo> *p_tmp_list=nullptr;

    QString startTime;
    QString endTime;
    bool readMeterState = false;
...
#endif // SCRIPT_READMETER_13F1_PROTOCOLCONFORMANCE_H
