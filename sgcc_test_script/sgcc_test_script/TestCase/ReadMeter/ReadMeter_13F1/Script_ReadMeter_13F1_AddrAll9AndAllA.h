#ifndef SCRIPT_READMETER_13F1_ADDRALL9ANDALLA_H
#define SCRIPT_READMETER_13F1_ADDRALL9ANDALLA_H
...
enum Script_ReadMeter_13F1_RunState
{
    ...
    Wait_13F1_MeterReadAddrAll9_Finish,
    Wait_13F1_MeterReadAddrAllA_Finish,
    Wait_13F1_MeterReadAddrNormal_Finish,
    Wait_00F1_for_12F3_Recover,
    ScriptSuccess
};

class Script_ReadMeter_13F1_AddrAll9AndAllA : public QObject, public AbstractScript,public DynamicCreate<Script_ReadMeter_13F1_AddrAll9AndAllA>
{
    Q_OBJECT
public:
    explicit Script_ReadMeter_13F1_AddrAll9AndAllA(QObject *parent = nullptr);
    ~Script_ReadMeter_13F1_AddrAll9AndAllA();
...
#endif // SCRIPT_READMETER_13F1_ADDRALL9ANDALLA_H
