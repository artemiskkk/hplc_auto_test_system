#ifndef SCRIPT_READMETER_13F1_DELAYRELATEDABANDON_H
#define SCRIPT_READMETER_13F1_DELAYRELATEDABANDON_H

#include <QObject>
#include "TestCase/BuildNetwork_GW.h"
#define SENCE3
class Script_ReadMeter_13F1_DelayRelatedAbandon : public QObject, public AbstractScript,public DynamicCreate<Script_ReadMeter_13F1_DelayRelatedAbandon>
{
    Q_OBJECT
public:
    explicit Script_ReadMeter_13F1_DelayRelatedAbandon(QObject *parent = nullptr);    
    ~Script_ReadMeter_13F1_DelayRelatedAbandon();
    /**
     * @brief The Script_ParameterManage_DeleteNotInRouter_RunState 运行状态机
     */
    enum Script_ReadMeter_13F1_DelayRelatedAbandon_RunState
    {
        ScriptInit,
        Wait_BuildNetFinish_Whole,
        Wait_PauseRouter_12F2_Finish,
        Wait_13F1_NoReply14F3_Finish,
        Wait_13F1_Wrong14F3_Finish,
        ScriptSuccess
    };
private:
    Q_ENUM(Script_ReadMeter_13F1_DelayRelatedAbandon_RunState)
    QMetaEnum runStateMetaEnum=QMetaEnum::fromType<Script_ReadMeter_13F1_DelayRelatedAbandon_RunState>();
    Script_ReadMeter_13F1_DelayRelatedAbandon_RunState emScriptRunState=ScriptInit;
    ...
    QTime t;
    QByteArray readMeterMsg;
    //定义帧格式处理
    shared_ptr<Frame3762Helper> p_Frame3762Helper;
    shared_ptr<Afn12F2> p_Afn12F2;
    shared_ptr<Afn13F1> p_Afn13F1;
    shared_ptr<Afn14F3> p_Afn14F3;
    ...
    QString testCase="【GW-CCO-F003-0010-V01】";
private:
...
#endif // SCRIPT_READMETER_13F1_DELAYRELATEDABANDON_H
