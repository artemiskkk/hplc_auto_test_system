#ifndef SCRIPT_READMETER_13F1_DELAYRELATED_H
#define SCRIPT_READMETER_13F1_DELAYRELATED_H

#include <QObject>
#include "TestCase/BuildNetwork_GW.h"
enum Script_ReadMeter_13F1_DelayRelated_RunState
{
    ReadMeterInit,
...
class Script_ReadMeter_13F1_DelayRelated : public QObject, public AbstractScript,public DynamicCreate<Script_ReadMeter_13F1_DelayRelated>
{
    Q_OBJECT
//    Q_PLUGIN_METADATA(IID "com.topscomm.AbstractScript")
//    Q_INTERFACES(AbstractScript)
public:
    explicit Script_ReadMeter_13F1_DelayRelated(QObject *parent = nullptr);
    ~Script_ReadMeter_13F1_DelayRelated();

    Script_ReadMeter_13F1_DelayRelated_RunState emScriptRunState;
...
#endif // SCRIPT_READMETER_13F1_DELAYRELATED_H
