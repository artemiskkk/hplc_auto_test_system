#ifndef SCRIPT_READMETER_13F1_H
#define SCRIPT_READMETER_13F1_H
...
class Script_ReadMeter_13F1 : public QObject, public AbstractScript,public DynamicCreate<Script_ReadMeter_13F1>
{
    Q_OBJECT
//    Q_PLUGIN_METADATA(IID "com.topscomm.AbstractScript")
//    Q_INTERFACES(AbstractScript)
public:
    explicit Script_ReadMeter_13F1(QObject *parent = nullptr);
    ~Script_ReadMeter_13F1();
...
QString startTime;
    QString endTime;
    int maxMonitorTime;  // 改为可配置参数，默认值在构造函数中设置
