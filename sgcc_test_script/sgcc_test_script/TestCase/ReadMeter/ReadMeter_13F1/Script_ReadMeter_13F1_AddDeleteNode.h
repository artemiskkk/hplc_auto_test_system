#ifndef SCRIPT_READMETER_13F1_ADDDELETENODE_H
#define SCRIPT_READMETER_13F1_ADDDELETENODE_H

#include <QObject>
#include "TestCase/BuildNetwork_GW.h"
enum Script_ReadMeter_13F1_AddDeleteNode_RunState
{
    ReadMeterInit,
...
class Script_ReadMeter_13F1_AddDeleteNode : public QObject, public AbstractScript,public DynamicCreate<Script_ReadMeter_13F1_AddDeleteNode>
{
    Q_OBJECT
//    Q_PLUGIN_METADATA(IID "com.topscomm.AbstractScript")
//    Q_INTERFACES(AbstractScript)
public:
    explicit Script_ReadMeter_13F1_AddDeleteNode(QObject *parent = nullptr);
    ~Script_ReadMeter_13F1_AddDeleteNode();

    Script_ReadMeter_13F1_AddDeleteNode_RunState emScriptRunState;
...
#endif // SCRIPT_READMETER_13F1_ADDDELETENODE_H
