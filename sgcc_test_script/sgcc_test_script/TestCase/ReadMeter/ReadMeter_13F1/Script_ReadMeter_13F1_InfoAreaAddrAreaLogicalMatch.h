#ifndef SCRIPT_READMETER_13F1_INFOAREAADDRAREALOGICALMATCH_H
#define SCRIPT_READMETER_13F1_INFOAREAADDRAREALOGICALMATCH_H
...
enum Script_Template_RebuildNetWork_RunState
{
    ...
    Wait_13F1_MeterReadCommId00_Finish,
    Wait_13F1_MeterReadCommId01_case1,
    Wait_13F1_MeterReadCommId01_case2,
    Wait_13F1_MeterReadCommId01_case3,
    Wait_13F1_MeterReadCommId01_case4,
    ScriptSuccess
};
/**
...
class Script_ReadMeter_13F1_InfoAreaAddrAreaLogicalMatch :  public QObject, public AbstractScript,public DynamicCreate<Script_ReadMeter_13F1_InfoAreaAddrAreaLogicalMatch>
{
    Q_OBJECT
public:
    explicit Script_ReadMeter_13F1_InfoAreaAddrAreaLogicalMatch(QObject *parent = nullptr);
    ~Script_ReadMeter_13F1_InfoAreaAddrAreaLogicalMatch();
private:
...
private:
    ...
    QByteArray ucharChangeToQbytearray(uchar data[4]);
private slots:
...
#endif // SCRIPT_READMETER_13F1_INFOAREAADDRAREALOGICALMATCH_H
