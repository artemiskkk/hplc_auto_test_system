#ifndef SCRIPT_READMETER_14F1_SEARCHMETER_H
#define SCRIPT_READMETER_14F1_SEARCHMETER_H

#include <QObject>
#include "TestCase/BuildNetwork_GW.h"
enum Script_ReadMeter_14F1_SearchMeter_RunState
{
    ReadMeterInit,
...
class Script_ReadMeter_14F1_SearchMeter : public QObject, public AbstractScript,public DynamicCreate<Script_ReadMeter_14F1_SearchMeter>
{
    Q_OBJECT
//    Q_PLUGIN_METADATA(IID "com.topscomm.AbstractScript")
//    Q_INTERFACES(AbstractScript)
public:
    explicit Script_ReadMeter_14F1_SearchMeter(QObject *parent = nullptr);
    ~Script_ReadMeter_14F1_SearchMeter();

    Script_ReadMeter_14F1_SearchMeter_RunState emScriptRunState;
    ...
    //参数
    bool searchMeterFlag=false;
    ushort activeRegisterLastTime=2;//min
    ushort reportNum_search=0,requestNum_14F1=0,reportNum_readMeter=0;
...
#endif // SCRIPT_READMETER_14F1_SEARCHMETER_H
