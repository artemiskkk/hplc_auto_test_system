#ifndef SCRIPT_READMETER_14F1_H
#define SCRIPT_READMETER_14F1_H
...
class Script_ReadMeter_14F1 : public QObject, public AbstractScript,public DynamicCreate<Script_ReadMeter_14F1>
{
    Q_OBJECT
//    Q_PLUGIN_METADATA(IID "com.topscomm.AbstractScript")
//    Q_INTERFACES(AbstractScript)
public:
    explicit Script_ReadMeter_14F1(QObject *parent = nullptr);
    ~Script_ReadMeter_14F1();
...
private:
    ...
    Address extractAddressFrom3762Frame(const QByteArray& rawData, AbstractScriptHost* scriptHost);
