#ifndef SCRIPT_READMETER_14F1_RESTARTPAUSEROCOVER1_H
#define SCRIPT_READMETER_14F1_RESTARTPAUSEROCOVER1_H

#include <QObject>
#include "TestCase/BuildNetwork_GW.h"
enum Script_ReadMeter_14F1_RestartPauseRocover1_RunState
{
    ReadMeterInit,
...
class Script_ReadMeter_14F1_RestartPauseRocover1 : public QObject, public AbstractScript,public DynamicCreate<Script_ReadMeter_14F1_RestartPauseRocover1>
{
    Q_OBJECT
//    Q_PLUGIN_METADATA(IID "com.topscomm.AbstractScript")
//    Q_INTERFACES(AbstractScript)
public:
    explicit Script_ReadMeter_14F1_RestartPauseRocover1(QObject *parent = nullptr);
    ~Script_ReadMeter_14F1_RestartPauseRocover1();

    CtrlState emCtrlState;
    Script_ReadMeter_14F1_RestartPauseRocover1_RunState emScriptRunState;
...
#endif // SCRIPT_READMETER_14F1_RESTARTPAUSEROCOVER1_H
