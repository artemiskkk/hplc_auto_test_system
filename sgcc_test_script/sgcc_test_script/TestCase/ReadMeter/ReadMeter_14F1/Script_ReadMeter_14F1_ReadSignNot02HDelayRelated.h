#ifndef SCRIPT_READMETER_14F1_READSIGNNOT02HDELAYRELATED_H
#define SCRIPT_READMETER_14F1_READSIGNNOT02HDELAYRELATED_H
...
enum Script_Template_RebuildNetWork_RunState
{
    ...
    Wait_10F4_QueryRouterRunState_Finish,
...
class Script_ReadMeter_14F1_ReadSignNot02HDelayRelated :  public QObject, public AbstractScript,public DynamicCreate<Script_ReadMeter_14F1_ReadSignNot02HDelayRelated>
{
    Q_OBJECT
public:
    explicit Script_ReadMeter_14F1_ReadSignNot02HDelayRelated(QObject *parent = nullptr);
    ~Script_ReadMeter_14F1_ReadSignNot02HDelayRelated();
private:
    ...
    shared_ptr<Afn10F4> p_RouterRunState_10F4;
    ...
    shared_ptr<Afn06F3> p_ReportRouterChangeInfo_06F3;
...
#endif // SCRIPT_READMETER_14F1_READSIGNNOT02HDELAYRELATED_H
