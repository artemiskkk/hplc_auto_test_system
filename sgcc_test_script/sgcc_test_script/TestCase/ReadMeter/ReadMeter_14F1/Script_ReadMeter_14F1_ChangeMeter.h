#ifndef SCRIPT_READMETER_14F1_CHANGEMETER_H
#define SCRIPT_READMETER_14F1_CHANGEMETER_H

#include <QObject>
#include "TestCase/BuildNetwork_GW.h"
enum Script_ReadMeter_14F1_ChangeMeter_RunState
{
    TestInit,
    Wait_BuildNetFinish_Whole,
    Wait_14F1_FirstTime,
    Wait_14F1_SecondTime,
    Wait_14F1_Round,
    After_Pause,
    ScriptSuccess
};
...
class Script_ReadMeter_14F1_ChangeMeter : public QObject, public AbstractScript,public DynamicCreate<Script_ReadMeter_14F1_ChangeMeter>
{
    Q_OBJECT
//    Q_PLUGIN_METADATA(IID "com.topscomm.AbstractScript")
//    Q_INTERFACES(AbstractScript)
public:
    explicit Script_ReadMeter_14F1_ChangeMeter(QObject *parent = nullptr);
    ~Script_ReadMeter_14F1_ChangeMeter();

    Script_ReadMeter_14F1_ChangeMeter_RunState emScriptRunState;
...
//    int reportCount_14F1=0;
    int firstMeterIndex,readMeterIndex;
    int No_14F1=0;
    bool readSucFlag=false;
...
#endif // SCRIPT_READMETER_14F1_CHANGEMETER_H
