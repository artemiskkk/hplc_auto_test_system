#ifndef SCRIPT_READMETER_14F1_DELAYRELATED_H
#define SCRIPT_READMETER_14F1_DELAYRELATED_H
...
class Script_ReadMeter_14F1_DelayRelated : public QObject, public AbstractScript,public DynamicCreate<Script_ReadMeter_14F1_DelayRelated>
{
    Q_OBJECT
//    Q_PLUGIN_METADATA(IID "com.topscomm.AbstractScript")
//    Q_INTERFACES(AbstractScript)
public:
    explicit Script_ReadMeter_14F1_DelayRelated(QObject *parent = nullptr);
    ~Script_ReadMeter_14F1_DelayRelated();
...
#endif // SCRIPT_READMETER_14F1_DELAYRELATED_H
