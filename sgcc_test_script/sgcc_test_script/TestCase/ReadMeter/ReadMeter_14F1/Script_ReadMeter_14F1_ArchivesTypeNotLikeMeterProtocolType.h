#ifndef SCRIPT_READMETER_14F1_ARCHIVESTYPENOTLIKEMETERPROTOCOLTYPE_H
#define SCRIPT_READMETER_14F1_ARCHIVESTYPENOTLIKEMETERPROTOCOLTYPE_H
...
enum Script_Template_RebuildNetWork_RunState
{
    ...
    Wait_14F1_MeterReadUp0101_Finish,
    Wait_06F2_ActiveReport_Finish,
    Wait_14F1_MeterReadUp0102_Finish,
    Wait_14F1_MeterReadUp0201_Finish,
    Wait_14F1_MeterReadUp0103_Finish,
    ScriptSuccess
};
/**
...
class Script_ReadMeter_14F1_ArchivesTypeNotLikeMeterProtocolType :  public QObject, public AbstractScript,public DynamicCreate<Script_ReadMeter_14F1_ArchivesTypeNotLikeMeterProtocolType>
{
    Q_OBJECT
public:
    explicit Script_ReadMeter_14F1_ArchivesTypeNotLikeMeterProtocolType(QObject *parent = nullptr);
    ~Script_ReadMeter_14F1_ArchivesTypeNotLikeMeterProtocolType();
private:
...
//    QList<MeterInfo> p_645MeterInfo;
//    QList<MeterInfo> p_698MeterInfo;
//    QList<MeterInfo> *p_partialMeterInfo;
    ...
    shared_ptr<Afn14F1> p_ReadMeter_14F1;
    shared_ptr<Afn06F2> p_ReportReadData_06F2;
...
#endif // SCRIPT_READMETER_14F1_ARCHIVESTYPENOTLIKEMETERPROTOCOLTYPE_H
