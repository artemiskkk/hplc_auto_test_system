#ifndef SCRIPT_READMETER_14F1_DELAY14F3DOWNNORESPONSE_H
#define SCRIPT_READMETER_14F1_DELAY14F3DOWNNORESPONSE_H

#include <QObject>
#include "TestCase/BuildNetwork_GW.h"
enum Script_ReadMeter_14F1_DelayRelated_RunState
{
    ReadMeterInit,
...
class Script_ReadMeter_14F1_Delay14F3DownNoResponse : public QObject, public AbstractScript,public DynamicCreate<Script_ReadMeter_14F1_Delay14F3DownNoResponse>
{
    Q_OBJECT
public:
    explicit Script_ReadMeter_14F1_Delay14F3DownNoResponse(QObject *parent = nullptr);
    ~Script_ReadMeter_14F1_Delay14F3DownNoResponse();

    Script_ReadMeter_14F1_DelayRelated_RunState emScriptRunState;
...
#endif // SCRIPT_READMETER_14F1_DELAY14F3DOWNNORESPONSE_H
