#ifndef SCRIPT_READMETER_14F1_SUBSIDIARYNODE_H
#define SCRIPT_READMETER_14F1_SUBSIDIARYNODE_H

#include <QObject>
#include "TestCase/BuildNetwork_GW.h"
enum Script_ReadMeter_14F1_SubsidiaryNode_RunState
{
    ReadMeterInit,
...
class Script_ReadMeter_14F1_SubsidiaryNode : public QObject, public AbstractScript,public DynamicCreate<Script_ReadMeter_14F1_SubsidiaryNode>
{
    Q_OBJECT
//    Q_PLUGIN_METADATA(IID "com.topscomm.AbstractScript")
//    Q_INTERFACES(AbstractScript)
public:
    explicit Script_ReadMeter_14F1_SubsidiaryNode(QObject *parent = nullptr);
    ~Script_ReadMeter_14F1_SubsidiaryNode();

    Script_ReadMeter_14F1_SubsidiaryNode_RunState emScriptRunState;
...
#endif // SCRIPT_READMETER_14F1_SUBSIDIARYNODE_H
