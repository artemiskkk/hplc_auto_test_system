#ifndef SCRIPT_READMETER_14F1_NOTBUILDNET_H
#define SCRIPT_READMETER_14F1_NOTBUILDNET_H

#include <QObject>
#include "TestCase/BuildNetwork_GW.h"
enum Script_ReadMeter_14F1_NotBuildNet_RunState
{
    ReadMeterInit,
    Wait_BuildNetFinish_Whole,
    Wait_HardInit_Finish,
    Wait_00F1_for_12F1_Restart,
    Wait_10s_AfterRestart,
...
class Script_ReadMeter_14F1_NotBuildNet : public QObject, public AbstractScript,public DynamicCreate<Script_ReadMeter_14F1_NotBuildNet>
{
    Q_OBJECT
//    Q_PLUGIN_METADATA(IID "com.topscomm.AbstractScript")
//    Q_INTERFACES(AbstractScript)
public:
    explicit Script_ReadMeter_14F1_NotBuildNet(QObject *parent = nullptr);
    ~Script_ReadMeter_14F1_NotBuildNet();

    Script_ReadMeter_14F1_NotBuildNet_RunState emScriptRunState;
    ...
    ushort timerAfterReachThresld=3600; //单位:s
...
#endif // SCRIPT_READMETER_14F1_NOTBUILDNET_H
