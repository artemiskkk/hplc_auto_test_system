#ifndef SCRIPT_READMETER_14F1_10F5QUERYREADFAILEDNODEINFO_H
#define SCRIPT_READMETER_14F1_10F5QUERYREADFAILEDNODEINFO_H
...
enum Script_ReadMeter_14F1_RunState
{
    ...
    Wait_10F4_QueryRouterRunStateMedium_Finish,
    Wait_06F3_ReportNodeInfo_Finish,
    ScriptSuccess
};
...
class Script_ReadMeter_14F1_10F5QueryReadFailedNodeInfo : public QObject, public AbstractScript,public DynamicCreate<Script_ReadMeter_14F1_10F5QueryReadFailedNodeInfo>
{
    Q_OBJECT
public:
    explicit Script_ReadMeter_14F1_10F5QueryReadFailedNodeInfo(QObject *parent = nullptr);
    ~Script_ReadMeter_14F1_10F5QueryReadFailedNodeInfo();
    ...
    shared_ptr<Afn10F4> p_QueryRouterRunState_10F4;
    shared_ptr<Afn10F5> p_QueryReadMeterFailedNodeNum_10F5;
    ...
    bool read_meter_state = false;
    bool read_14F1_state = false;
    int read_14F1_times=0;
public:
    void  execute();
    void  stop();
...
#endif // SCRIPT_READMETER_14F1_10F5QUERYREADFAILEDNODEINFO_H
