#ifndef SCRIPT_READMETER_14F1_RELAYADDRESS_H
#define SCRIPT_READMETER_14F1_RELAYADDRESS_H

#include <QObject>
#include "TestCase/BuildNetwork_GW.h"
enum Script_ReadMeter_14F1_RelayAddress_RunState
{
    ReadMeterInit,
...
class Script_ReadMeter_14F1_RelayAddress : public QObject, public AbstractScript,public DynamicCreate<Script_ReadMeter_14F1_RelayAddress>
{
    Q_OBJECT
//    Q_PLUGIN_METADATA(IID "com.topscomm.AbstractScript")
//    Q_INTERFACES(AbstractScript)
public:
    explicit Script_ReadMeter_14F1_RelayAddress(QObject *parent = nullptr);
    ~Script_ReadMeter_14F1_RelayAddress();

    Script_ReadMeter_14F1_RelayAddress_RunState emScriptRunState;
...
#endif // SCRIPT_READMETER_14F1_RELAYADDRESS_H
