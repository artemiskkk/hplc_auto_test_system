#ifndef SCRIPT_READMETER_14F1_SUCCESSFAILFLAG_H
#define SCRIPT_READMETER_14F1_SUCCESSFAILFLAG_H

#include <QObject>
#include "TestCase/BuildNetwork_GW.h"
enum Script_ReadMeter_14F1_SuccessFailFlag_RunState
{
    ReadMeterInit,
...
class Script_ReadMeter_14F1_SuccessFailFlag : public QObject, public AbstractScript,public DynamicCreate<Script_ReadMeter_14F1_SuccessFailFlag>
{
    Q_OBJECT
//    Q_PLUGIN_METADATA(IID "com.topscomm.AbstractScript")
//    Q_INTERFACES(AbstractScript)
public:
    explicit Script_ReadMeter_14F1_SuccessFailFlag(QObject *parent = nullptr);
    ~Script_ReadMeter_14F1_SuccessFailFlag();

    Script_ReadMeter_14F1_SuccessFailFlag_RunState emScriptRunState;
...
#endif // SCRIPT_READMETER_14F1_SUCCESSFAILFLAG_H
