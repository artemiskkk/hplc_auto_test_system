#ifndef SCRIPT_CHIPIDMANAGE_CCO_V3KEY_H
#define SCRIPT_CHIPIDMANAGE_CCO_V3KEY_H

#include <QObject>
#include "TestCase/BuildNetwork_GW.h"

enum Script_ChipIdManage_CCO_V3Key_RunState
{
    TestInit,
    Wait_BuildNetFinish_Whole,
    SetRouterChipIDKey_Before,
    SetRouterChipIDKey_After,
    ReadChipIDKeyAfterParaInit,
    ScriptSuccess
};
class Script_ChipIdManage_CCO_V3Key : public QObject, public AbstractScript,public DynamicCreate<Script_ChipIdManage_CCO_V3Key>
{
    Q_OBJECT
//    Q_PLUGIN_METADATA(IID "com.topscomm.AbstractScript")
//    Q_INTERFACES(AbstractScript)
public:
    explicit Script_ChipIdManage_CCO_V3Key(QObject *parent = nullptr);
    ~Script_ChipIdManage_CCO_V3Key();
    Script_ChipIdManage_CCO_V3Key_RunState emScriptRunState;
    ...
    shared_ptr<AfnF0F40> p_QueryRouterChipID_F0F40;
    shared_ptr<Afn10F112> p_QueryRouterChipID_10F112;
    shared_ptr<Afn10F40> p_QueryRouterChipID_10F40;
    shared_ptr<AfnF0F43> p_SetRouterChipIDKey_F0F43;
    shared_ptr<AfnF0F44> p_QueryRouterChipIDKey_F0F44;
...
#endif // SCRIPT_CHIPIDMANAGE_CCO_V3KEY_H
