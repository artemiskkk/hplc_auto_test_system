#ifndef Script_POWEROFFCJQREPORT_H
#define Script_POWEROFFCJQREPORT_H

#include <QObject>
#include "TestCase/BuildNetwork_GW.h"
enum Script_PowerOffCjqReport_RunState
{
    TestInit,
...
class Script_PowerOffCjqReport: public QObject, public AbstractScript,public DynamicCreate<Script_PowerOffCjqReport>
{
    Q_OBJECT
//    Q_PLUGIN_METADATA(IID "com.topscomm.AbstractScript")
//    Q_INTERFACES(AbstractScript)
public:
    explicit Script_PowerOffCjqReport(QObject *parent = nullptr);
    ~Script_PowerOffCjqReport();
    Script_PowerOffCjqReport_RunState emScriptRunState;
...
#endif // Script_POWEROFFCJQREPORT_H
