#ifndef SCRIPT_VERSIONHEAD_CCONORMAL_H
#define SCRIPT_VERSIONHEAD_CCONORMAL_H

#include <QObject>
#include "TestCase/BuildNetwork_GW.h"
enum Script_VersionHead_CcoNormal_RunState
{
    TestInit,
...
class Script_VersionHead_CcoNormal: public QObject, public AbstractScript,public DynamicCreate<Script_VersionHead_CcoNormal>
{
    Q_OBJECT
//    Q_PLUGIN_METADATA(IID "com.topscomm.AbstractScript")
//    Q_INTERFACES(AbstractScript)
public:
    explicit Script_VersionHead_CcoNormal(QObject *parent = nullptr);
    ~Script_VersionHead_CcoNormal();
    Script_VersionHead_CcoNormal_RunState emScriptRunState;
    ...
    shared_ptr<Afn05F1> p_SetCcoAddr_05F1;
    ...
    uchar dtValue3762;
    QString ccoInVrsn_init;
    QString TestHead,TestHead2;
    int tryTimes=0;
    uchar msgSeq=0;
    ushort times=0;
    //QString startTime;
...
#endif // SCRIPT_VERSIONHEAD_CCONORMAL_H
