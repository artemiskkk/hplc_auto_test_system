#ifndef SCRIPT_LN_INVERSE_ROUTERRESET_H
#define SCRIPT_LN_INVERSE_ROUTERRESET_H

#include <QObject>
#include "TestCase/BuildNetwork_GW.h"
enum Script_LN_Inverse_RouterReset_RunState
{
    TestInit,
...
class Script_LN_Inverse_RouterReset: public QObject, public AbstractScript,public DynamicCreate<Script_LN_Inverse_RouterReset>
{
    Q_OBJECT
//    Q_PLUGIN_METADATA(IID "com.topscomm.AbstractScript")
//    Q_INTERFACES(AbstractScript)
public:
    explicit Script_LN_Inverse_RouterReset(QObject *parent = nullptr);
    ~Script_LN_Inverse_RouterReset();
    Script_LN_Inverse_RouterReset_RunState emScriptRunState;
...
#endif // SCRIPT_LN_INVERSE_ROUTERRESET_H
