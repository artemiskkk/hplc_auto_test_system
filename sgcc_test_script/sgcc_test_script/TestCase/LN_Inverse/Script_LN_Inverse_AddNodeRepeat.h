#ifndef SCRIPT_LN_INVERSE_ADDNODEREPEAT_H
#define SCRIPT_LN_INVERSE_ADDNODEREPEAT_H

#include <QObject>
#include "TestCase/BuildNetwork_GW.h"
enum Script_LN_Inverse_AddNodeRepeat_RunState
{
    TestInit,
...
class Script_LN_Inverse_AddNodeRepeat: public QObject, public AbstractScript,public DynamicCreate<Script_LN_Inverse_AddNodeRepeat>
{
    Q_OBJECT
//    Q_PLUGIN_METADATA(IID "com.topscomm.AbstractScript")
//    Q_INTERFACES(AbstractScript)
public:
    explicit Script_LN_Inverse_AddNodeRepeat(QObject *parent = nullptr);
    ~Script_LN_Inverse_AddNodeRepeat();
    Script_LN_Inverse_AddNodeRepeat_RunState emScriptRunState;
...
#endif // SCRIPT_LN_INVERSE_ADDNODEREPEAT_H
