#ifndef SCRIPT_LN_INVERSE_H
#define SCRIPT_LN_INVERSE_H

#include <QObject>
#include "TestCase/BuildNetwork_GW.h"
enum Script_LN_Inverse_RunState
{
    TestInit,
...
class Script_LN_Inverse: public QObject, public AbstractScript,public DynamicCreate<Script_LN_Inverse>
{
    Q_OBJECT
//    Q_PLUGIN_METADATA(IID "com.topscomm.AbstractScript")
//    Q_INTERFACES(AbstractScript)
public:
    explicit Script_LN_Inverse(QObject *parent = nullptr);
    ~Script_LN_Inverse();
    Script_LN_Inverse_RunState emScriptRunState;
