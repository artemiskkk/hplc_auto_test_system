#ifndef SCRIPT_FREQMANAGE_RECORDSWITCHING_H
#define SCRIPT_FREQMANAGE_RECORDSWITCHING_H
...
/**
 * @brief The Script_FreqManage_RecordSwitching_RunState 运行状态机
 */
enum Script_FreqManage_RecordSwitching_RunState
{
    TestInit,
    Wait_BuildNetFinish_Whole,

    Wait_ParaInit_Finish_1,
    Wait_SetBand_05F16_Finish_1,
    Wait_QueryBand_Finish_1,

    Wait_AddStaAddress_11F1_Finish,
    Wait_SetBand_05F16_Finish_2,

    Wait_ParaInit_Finish_2,
    Wait_QueryBand_Finish_2,

    Wait_SetBand_05F16_Finish_3,
    Wait_QueryBand_Finish_3,
...
/**
 * @brief The Script_FreqManage_RecordSwitching 频段管理-档案相关切换
 *
 */

class Script_FreqManage_RecordSwitching :  public QObject, public AbstractScript, public DynamicCreate<Script_FreqManage_RecordSwitching>
{
    Q_OBJECT
public:
    explicit Script_FreqManage_RecordSwitching(QObject *parent = nullptr);
    ~Script_FreqManage_RecordSwitching();
private:
    Script_FreqManage_RecordSwitching_RunState emScriptRunState = TestInit;
...
#endif // SCRIPT_FREQMANAGE_RECORDSWITCHING_H
