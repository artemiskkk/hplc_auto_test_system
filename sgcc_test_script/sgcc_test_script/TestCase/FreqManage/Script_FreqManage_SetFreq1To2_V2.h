#ifndef SCRIPT_FREQMANAGE_SETFREQ1TO2_V2_H
#define SCRIPT_FREQMANAGE_SETFREQ1TO2_V2_H

#include "TestCase/BuildNetwork_GW.h"

enum Script_FreqManage_SetFreq1To2_V2_RunState
{
    TestInit,
...
class Script_FreqManage_SetFreq1To2_V2 : public QObject, public AbstractScript,public DynamicCreate<Script_FreqManage_SetFreq1To2_V2>
{
    Q_OBJECT
//    Q_PLUGIN_METADATA(IID "com.topscomm.AbstractScript")
//    Q_INTERFACES(AbstractScript)
public:
    explicit Script_FreqManage_SetFreq1To2_V2(QObject *parent = nullptr);
    ~Script_FreqManage_SetFreq1To2_V2();

    Script_FreqManage_SetFreq1To2_V2_RunState emScriptRunState;
...
#endif // SCRIPT_FREQMANAGE_SETFREQ1TO2_V2_H
