#ifndef SCRIPT_FREQMANAGE_FREQDIVIDETEST2_H
#define SCRIPT_FREQMANAGE_FREQDIVIDETEST2_H

#include <QObject>
#include "TestCase/BuildNetwork_GW.h"
enum Script_FreqManage_FreqDivideTest2_RunState
{
    TestInit,
    ...
    Wait_SetDstFreqDivide_Finish,
    Wait_QueryDstFreq_Finish,
    Wait_QueryDstFreqDivide_Finish,
    Wait_HardResetTest_Finish,
    Wait_EraseFlash_Finish,
    Wait_AddMeter_Finish,
    ScriptSuccess
};
class Script_FreqManage_FreqDivideTest2 : public QObject, public AbstractScript,public DynamicCreate<Script_FreqManage_FreqDivideTest2>
{
    Q_OBJECT
//    Q_PLUGIN_METADATA(IID "com.topscomm.AbstractScript")
//    Q_INTERFACES(AbstractScript)
public:
    explicit Script_FreqManage_FreqDivideTest2(QObject *parent = nullptr);
    ~Script_FreqManage_FreqDivideTest2();
    Script_FreqManage_FreqDivideTest2_RunState emScriptRunState;
    ...
    //
    int waitTime=90;//单位:s
    //F0D1
    char initFreq=0x01;//初始频段
...
#endif // SCRIPT_FREQMANAGE_FREQDIVIDETEST2_H
