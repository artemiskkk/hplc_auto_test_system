#ifndef SCRIPT_FREQMANAGE_SETFREQ3TO1_H
#define SCRIPT_FREQMANAGE_SETFREQ3TO1_H

#include <QObject>
#include "TestCase/BuildNetwork_GW.h"

enum Script_FreqManage_SetFreq3To1_RunState
{
    TestInit,
...
class Script_FreqManage_SetFreq3To1 : public QObject, public AbstractScript,public DynamicCreate<Script_FreqManage_SetFreq3To1>
{
    Q_OBJECT
//    Q_PLUGIN_METADATA(IID "com.topscomm.AbstractScript")
//    Q_INTERFACES(AbstractScript)
public:
    explicit Script_FreqManage_SetFreq3To1(QObject *parent = nullptr);
    ~Script_FreqManage_SetFreq3To1();

    Script_FreqManage_SetFreq3To1_RunState emScriptRunState;
...
#endif // SCRIPT_FREQMANAGE_SETFREQ3TO1_H
