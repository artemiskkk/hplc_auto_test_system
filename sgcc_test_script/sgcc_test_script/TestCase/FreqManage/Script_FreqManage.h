#ifndef SCRIPT_FREQMANAGE_H
#define SCRIPT_FREQMANAGE_H

#include <QObject>
#include "TestCase/BuildNetwork_GW.h"

enum Script_FreqManage_RunState
{
    TestInit,
...
class Script_FreqManage : public QObject, public AbstractScript
{
    Q_OBJECT
//    Q_PLUGIN_METADATA(IID "com.topscomm.AbstractScript")
//    Q_INTERFACES(AbstractScript)
public:
    explicit Script_FreqManage(QObject *parent = nullptr);
    ~Script_FreqManage();

    Script_FreqManage_RunState emScriptRunState;
