#ifndef SCRIPT_FREQMANAGE_FREQDIVIDETEST1_H
#define SCRIPT_FREQMANAGE_FREQDIVIDETEST1_H

#include <QObject>
#include "TestCase/BuildNetwork_GW.h"
enum Script_FreqManage_FreqDivideTest1_RunState
{
    TestInit,
...
class Script_FreqManage_FreqDivideTest1 : public QObject, public AbstractScript,public DynamicCreate<Script_FreqManage_FreqDivideTest1>
{
    Q_OBJECT
//    Q_PLUGIN_METADATA(IID "com.topscomm.AbstractScript")
//    Q_INTERFACES(AbstractScript)
public:
    explicit Script_FreqManage_FreqDivideTest1(QObject *parent = nullptr);
    ~Script_FreqManage_FreqDivideTest1();
    Script_FreqManage_FreqDivideTest1_RunState emScriptRunState;
...
#endif // SCRIPT_FREQMANAGE_FREQDIVIDETEST1_H
