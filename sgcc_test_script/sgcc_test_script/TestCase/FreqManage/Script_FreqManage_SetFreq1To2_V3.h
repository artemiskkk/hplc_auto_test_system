#ifndef SCRIPT_FREQMANAGE_SETFREQ1TO2_V3_H
#define SCRIPT_FREQMANAGE_SETFREQ1TO2_V3_H

#include "TestCase/BuildNetwork_GW.h"

enum Script_FreqManage_SetFreq1To2_V3_RunState
{
    TestInit,
...
class Script_FreqManage_SetFreq1To2_V3 : public QObject, public AbstractScript,public DynamicCreate<Script_FreqManage_SetFreq1To2_V3>
{
    Q_OBJECT
//    Q_PLUGIN_METADATA(IID "com.topscomm.AbstractScript")
//    Q_INTERFACES(AbstractScript)
public:
    explicit Script_FreqManage_SetFreq1To2_V3(QObject *parent = nullptr);
    ~Script_FreqManage_SetFreq1To2_V3();

    Script_FreqManage_SetFreq1To2_V3_RunState emScriptRunState;
    ...
    char initFreq=0x01;//初始频段1
    char initFreqDivide=0x01;//初始分频系数1
    char dstFreq=0x02;//目的频段2
...
#endif // SCRIPT_FREQMANAGE_SETFREQ1TO2_V3_H
