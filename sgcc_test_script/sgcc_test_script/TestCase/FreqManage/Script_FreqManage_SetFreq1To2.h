#ifndef SCRIPT_FREQMANAGE_SETFREQ1TO2_H
#define SCRIPT_FREQMANAGE_SETFREQ1TO2_H

#include "TestCase/BuildNetwork_GW.h"

enum Script_FreqManage_SetFreq1To2_RunState
{
    TestInit,
...
class Script_FreqManage_SetFreq1To2 : public QObject, public AbstractScript,public DynamicCreate<Script_FreqManage_SetFreq1To2>
{
    Q_OBJECT
//    Q_PLUGIN_METADATA(IID "com.topscomm.AbstractScript")
//    Q_INTERFACES(AbstractScript)
public:
    explicit Script_FreqManage_SetFreq1To2(QObject *parent = nullptr);
    ~Script_FreqManage_SetFreq1To2();

    Script_FreqManage_SetFreq1To2_RunState emScriptRunState;
...
#endif // SCRIPT_FREQMANAGE_SETFREQ1TO2_H
