#ifndef SCRIPT_FREQMANAGE_SETFREQ2TO3_H
#define SCRIPT_FREQMANAGE_SETFREQ2TO3_H

#include <QObject>
#include "TestCase/BuildNetwork_GW.h"

enum Script_FreqManage_SetFreq2To3_RunState
{
    TestInit,
...
class Script_FreqManage_SetFreq2To3 : public QObject, public AbstractScript,public DynamicCreate<Script_FreqManage_SetFreq2To3>
{
    Q_OBJECT
//    Q_PLUGIN_METADATA(IID "com.topscomm.AbstractScript")
//    Q_INTERFACES(AbstractScript)
public:
    explicit Script_FreqManage_SetFreq2To3(QObject *parent = nullptr);
    ~Script_FreqManage_SetFreq2To3();

    Script_FreqManage_SetFreq2To3_RunState emScriptRunState;
    ...
    char initFreq=0x02;//初始频段2
    char initFreqDivide=0x01;//初始分频系数1
    char dstFreq=0x03;//目的频段3
...
#endif // SCRIPT_FREQMANAGE_SETFREQ2TO3_H
