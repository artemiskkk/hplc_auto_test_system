#ifndef SCRIPT_FREQMANAGE_SETFREQ0TO1_H
#define SCRIPT_FREQMANAGE_SETFREQ0TO1_H

#include <QObject>
#include "TestCase/BuildNetwork_GW.h"

enum Script_FreqManage_SetFreq0To1_RunState
{
    TestInit,
...
class Script_FreqManage_SetFreq0To1 : public QObject, public AbstractScript,public DynamicCreate<Script_FreqManage_SetFreq0To1>
{
    Q_OBJECT
//    Q_PLUGIN_METADATA(IID "com.topscomm.AbstractScript")
//    Q_INTERFACES(AbstractScript)
public:
    explicit Script_FreqManage_SetFreq0To1(QObject *parent = nullptr);
    ~Script_FreqManage_SetFreq0To1();

    Script_FreqManage_SetFreq0To1_RunState emScriptRunState;
    ...
    char initFreq=0x00;//初始频段0
    char initFreqDivide=0x01;//初始分频系数1
    char dstFreq=0x01;//目的频段1
...
#endif // SCRIPT_FREQMANAGE_SETFREQ0TO1_H
