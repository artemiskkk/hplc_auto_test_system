#ifndef SCRIPT_FREQMANAGE_SETFREQ0TO0_H
#define SCRIPT_FREQMANAGE_SETFREQ0TO0_H

#include <QObject>
#include "TestCase/BuildNetwork_GW.h"

enum Script_FreqManage_SetFreq0To0_RunState
{
    TestInit,
...
class Script_FreqManage_SetFreq0To0 : public QObject, public AbstractScript,public DynamicCreate<Script_FreqManage_SetFreq0To0>
{
    Q_OBJECT
//    Q_PLUGIN_METADATA(IID "com.topscomm.AbstractScript")
//    Q_INTERFACES(AbstractScript)
public:
    explicit Script_FreqManage_SetFreq0To0(QObject *parent = nullptr);
    ~Script_FreqManage_SetFreq0To0();

    Script_FreqManage_SetFreq0To0_RunState emScriptRunState;
...
#endif // SCRIPT_FREQMANAGE_SETFREQ0TO0_H
