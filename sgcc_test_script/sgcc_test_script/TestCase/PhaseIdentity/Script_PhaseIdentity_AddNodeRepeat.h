#ifndef SCRIPT_PHASEIDENTITY_ADDNODEREPEAT_H
#define SCRIPT_PHASEIDENTITY_ADDNODEREPEAT_H

#include <QObject>
#include "TestCase/BuildNetwork_GW.h"
enum Script_PhaseIdentity_AddNodeRepeat_RunState
{
    TestInit,
...
class Script_PhaseIdentity_AddNodeRepeat: public QObject, public AbstractScript,public DynamicCreate<Script_PhaseIdentity_AddNodeRepeat>
{
    Q_OBJECT
//    Q_PLUGIN_METADATA(IID "com.topscomm.AbstractScript")
//    Q_INTERFACES(AbstractScript)
public:
    explicit Script_PhaseIdentity_AddNodeRepeat(QObject *parent = nullptr);
    ~Script_PhaseIdentity_AddNodeRepeat();
    Script_PhaseIdentity_AddNodeRepeat_RunState emScriptRunState;
    ...
    ushort index=0;
    uchar num=5;//每次查询数量
    int delayTime=60;//60s
    QString identityFailList_10F2;
    QString identityFailList_10F31;
    QString identityFailList_13F1;
public:
    void  execute();
    void  stop();
...
#endif // SCRIPT_PHASEIDENTITY_ADDNODEREPEAT_H
