#ifndef SCRIPT_PHASEIDENTITY_ROUTERRESET_H
#define SCRIPT_PHASEIDENTITY_ROUTERRESET_H

#include <QObject>
#include "TestCase/BuildNetwork_GW.h"
enum Script_PhaseIdentity_RouterReset_RunState
{
    TestInit,
...
class Script_PhaseIdentity_RouterReset: public QObject, public AbstractScript,public DynamicCreate<Script_PhaseIdentity_RouterReset>
{
    Q_OBJECT
//    Q_PLUGIN_METADATA(IID "com.topscomm.AbstractScript")
//    Q_INTERFACES(AbstractScript)
public:
    explicit Script_PhaseIdentity_RouterReset(QObject *parent = nullptr);
    ~Script_PhaseIdentity_RouterReset();
    Script_PhaseIdentity_RouterReset_RunState emScriptRunState;
...
#endif // SCRIPT_PHASEIDENTITY_ROUTERRESET_H
