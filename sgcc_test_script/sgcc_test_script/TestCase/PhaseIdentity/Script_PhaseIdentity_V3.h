#ifndef SCRIPT_PHASEIDENTITY_V3_H
#define SCRIPT_PHASEIDENTITY_V3_H

#include <QObject>
#include "TestCase/BuildNetwork_GW.h"
enum Script_PhaseIdentity_V3_RunState
{
    TestInit,
...
class Script_PhaseIdentity_V3: public QObject, public AbstractScript,public DynamicCreate<Script_PhaseIdentity_V3>
{
    Q_OBJECT
//    Q_PLUGIN_METADATA(IID "com.topscomm.AbstractScript")
//    Q_INTERFACES(AbstractScript)
public:
    explicit Script_PhaseIdentity_V3(QObject *parent = nullptr);
    ~Script_PhaseIdentity_V3();
    Script_PhaseIdentity_V3_RunState emScriptRunState;
...
#endif // SCRIPT_PHASEIDENTITY_V3_H
