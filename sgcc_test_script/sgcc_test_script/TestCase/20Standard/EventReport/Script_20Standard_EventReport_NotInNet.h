#ifndef SCRIPT_20STANDARD_EVENTREPORT_NOTINNET_H
#define SCRIPT_20STANDARD_EVENTREPORT_NOTINNET_H

#include <QObject>
#include "EventReportPrepare.h"
#define SENCE2
class Script_20Standard_EventReport_NotInNet : public QObject, public AbstractScript,public DynamicCreate<Script_20Standard_EventReport_NotInNet>
{
    Q_OBJECT
public:
    explicit Script_20Standard_EventReport_NotInNet(QObject *parent = nullptr);
    ~Script_20Standard_EventReport_NotInNet();
    enum Script_20Standard_EventReport_NotInNet_RunState
    {
        ScriptInit,
        Wait_BuildNetFinish_Whole,
        Wait_STALeaveNetFinish,
        Wait_EventReport_RstSTA_Finish,
        Wait_EventReport_STADelayInNet_Finish,
        ScriptSuccess
    };
private:
    Q_ENUM(Script_20Standard_EventReport_NotInNet_RunState)
    Script_20Standard_EventReport_NotInNet_RunState emScriptRunState=ScriptInit;
    QMetaEnum metaEnum=QMetaEnum::fromType<Script_20Standard_EventReport_NotInNet_RunState>();
    ...
    //
    QString testCase="【GW-STA-F028-0009-V01】";
    int singleStaIndex=0;
    int threeStaIndex=0;
    QByteArray meterMsg;
    int topoIndex=0;
    bool flagParaInit=true;
    bool flagReport=false;
    bool flagReadAddr=true;
    bool flagQueryTopo=true;
    QTime time;
private:
...
#endif // SCRIPT_20STANDARD_EVENTREPORT_NOTINNET_H
