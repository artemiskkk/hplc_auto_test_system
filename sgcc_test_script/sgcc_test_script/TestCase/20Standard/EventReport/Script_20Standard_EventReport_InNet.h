#ifndef SCRIPT_20STANDARD_EVENTREPORT_INNET_H
#define SCRIPT_20STANDARD_EVENTREPORT_INNET_H

#include <QObject>
#include "EventReportPrepare.h"
#define SENCE2
class Script_20Standard_EventReport_InNet : public QObject, public AbstractScript,public DynamicCreate<Script_20Standard_EventReport_InNet>
{
    Q_OBJECT
public:
    explicit Script_20Standard_EventReport_InNet(QObject *parent = nullptr);
    ~Script_20Standard_EventReport_InNet();
    enum Script_20Standard_EventReport_InNet_RunState
    {
        ScriptInit,
        Wait_BuildNetFinish_Whole,
        Wait_EventReportPrepare_Finish,
        Wait_EventReport_Confirm_Finish,
        Wait_EventReport_Repeat_Finish,
        Wait_EventReport_Deny_Finish,
        Wait_EventReport_NoReply_Finish,
        ScriptSuccess
    };
private:
    Q_ENUM(Script_20Standard_EventReport_InNet_RunState)
    Script_20Standard_EventReport_InNet_RunState emScriptRunState=ScriptInit;
    QMetaEnum metaEnum=QMetaEnum::fromType<Script_20Standard_EventReport_InNet_RunState>();
    ...
    EventReportPrepare *p_EventReportPrepare=nullptr;//事件上报准备
    ...
    shared_ptr<Afn00F1> p_Afn00F1=nullptr;
    shared_ptr<Afn00F2> p_Afn00F2=nullptr;
    ...
    //
    QString testCase="【GW-STA-F028-0008-V01】";
    int singleStaIndex=0;
    int threeStaIndex=0;
    QByteArray meterMsg;
private:
...
private slots:
    ...
    void slotNoticeEventReportPrepareState(ProcessState,const QString& state);
};
#endif // SCRIPT_20STANDARD_EVENTREPORT_INNET_H
