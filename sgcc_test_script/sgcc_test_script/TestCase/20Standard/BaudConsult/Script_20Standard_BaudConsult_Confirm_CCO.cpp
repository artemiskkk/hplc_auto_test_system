#include "Script_20Standard_BaudConsult_Confirm_CCO.h"
Script_20Standard_BaudConsult_Confirm_CCO::Script_20Standard_BaudConsult_Confirm_CCO(QObject *parent) : QObject(parent)
{
...
Script_20Standard_BaudConsult_Confirm_CCO::~Script_20Standard_BaudConsult_Confirm_CCO()
{
...
void Script_20Standard_BaudConsult_Confirm_CCO::setHost(AbstractScriptHost *host)
{
    p_AbstractScriptHost=host;
    p_BuildNetwork_GW->setHost(host);
}
void Script_20Standard_BaudConsult_Confirm_CCO::addAddrsInfo(const QList<ConcentratorInfo> *p_ConcentratorInfoList, const QList<MeterInfo> *p_MeterInfoList, const QList<SchemeCfgInfo> *p_SchemeCfgInfoList, const int freq)
{
    p_CtrInfoList->clear();
...
bool Script_20Standard_BaudConsult_Confirm_CCO::config(const QMap<QString,QString> *paraDic)
{
    bool result = false;
    if(paraDic!=nullptr)
    {
...
void Script_20Standard_BaudConsult_Confirm_CCO::execute()
{
...
void Script_20Standard_BaudConsult_Confirm_CCO::stop()
{
    p_timer->stop();
    p_delayTimer->stop();
...
void Script_20Standard_BaudConsult_Confirm_CCO::processMsg(DvcType dvcType, int id, uchar *data, int datalen)
{
    ...
    if(emScriptRunState==Wait_BuildNetFinish_Whole)//场景2-4
    {
        ...
        else
        {
            ...
            connect(p_BaudConsultPrepare,&BaudConsultPrepare::signalNoticeBaudConsultPrepareState,this,&Script_20Standard_BaudConsult_Confirm_CCO::slotNoticeBaudConsultPrepareState);
...
void Script_20Standard_BaudConsult_Confirm_CCO::processCtrlDvcRes(DvcType dvcType, QList<int> idList, CtrlCmdType ctrlCmdType, bool isSucs, QList<double> params)
{
    if(isSucs==false)
        return;
...
void Script_20Standard_BaudConsult_Confirm_CCO::processMsgFromCCO(DvcType dvcType, int dvcId)
{
...
void Script_20Standard_BaudConsult_Confirm_CCO::slotNoticeBaudConsultPrepareState(ProcessState pState, const QString &state)
{
    switch(emScriptRunState)
    {
        case Wait_BaudConsultPrepare_Finish:
        {
            if(pState==ProcessState_Processing)
            {
                ...
                connect(p_BaudConsult,&BaudConsult::signalNoticeBaudConsultState,this,&Script_20Standard_BaudConsult_Confirm_CCO::slotNoticeBaudConsultState);
...
void Script_20Standard_BaudConsult_Confirm_CCO::slotNoticeBaudConsultState(ProcessState pState, const QString &state)
{
    if(p_BaudConsult!=nullptr)
        delete p_BaudConsult;
...
void Script_20Standard_BaudConsult_Confirm_CCO::processMsgFromMeter645(DvcType dvcType, int dvcId, int mtrlID)
{
    bool haveCompleteMsg=true;
    while(haveCompleteMsg)
    {
...
void Script_20Standard_BaudConsult_Confirm_CCO::processMsgFromMeterOOP(DvcType dvcType, int dvcId, int mtrlID)
{
    bool haveCompleteMsg=true;
    while(haveCompleteMsg)
    {
...
void Script_20Standard_BaudConsult_Confirm_CCO::sendMsg(DvcType dvcType, int dvcId, int meterID, shared_ptr<void> frame)
{
...
void Script_20Standard_BaudConsult_Confirm_CCO::sendSrcMsg(DvcType dvcType, int dvcId, QByteArray msg)
{
    if(msg.size()<1)
        return;
...
void Script_20Standard_BaudConsult_Confirm_CCO::timer_timeoutProc()
{
    switch(emScriptRunState)
    {
        case Wait_BuildNetFinish_Whole:
...
void Script_20Standard_BaudConsult_Confirm_CCO::maxAllowTimer_timeoutProc()
{
    switch(emScriptRunState)
    {
        default:
...
void Script_20Standard_BaudConsult_Confirm_CCO::delayTimer_timeoutProc()
{
    switch(emScriptRunState)
    {
        default:
