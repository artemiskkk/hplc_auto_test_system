#ifndef SCRIPT_20STANDARD_BAUDCONSULT_CONFIRMDELAY_CCO_H
#define SCRIPT_20STANDARD_BAUDCONSULT_CONFIRMDELAY_CCO_H
...
#define SENCE2
class Script_20Standard_BaudConsult_ConfirmDelay_CCO : public QObject, public AbstractScript,public DynamicCreate<Script_20Standard_BaudConsult_ConfirmDelay_CCO>
{
    Q_OBJECT
public:
    explicit Script_20Standard_BaudConsult_ConfirmDelay_CCO(QObject *parent = nullptr);
    ~Script_20Standard_BaudConsult_ConfirmDelay_CCO();
    enum Script_20Standard_BaudConsult_ConfirmDelay_CCO_RunState
    {
        ScriptInit,
...
private:
    Q_ENUM(Script_20Standard_BaudConsult_ConfirmDelay_CCO_RunState)
    Script_20Standard_BaudConsult_ConfirmDelay_CCO_RunState emScriptRunState=ScriptInit;
    QMetaEnum metaEnum=QMetaEnum::fromType<Script_20Standard_BaudConsult_ConfirmDelay_CCO_RunState>();
    ...
    //
    QString testCase="【GW-STA-F028-0004-V01】";
    QByteArray meterMsg;
    bool readMeterNoFlag=false;
private:
...
#endif // SCRIPT_20STANDARD_BAUDCONSULT_CONFIRMDELAY_CCO_H
