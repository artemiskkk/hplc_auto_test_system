#ifndef SCRIPT_20STANDARD_BAUDCONSULT_CONFIRM_CKQ_H
#define SCRIPT_20STANDARD_BAUDCONSULT_CONFIRM_CKQ_H

#include <QObject>
#include "BaudConsult.h"
#include "BaudConsultPrepare.h"
#define SENCE2
class Script_20Standard_BaudConsult_Confirm_CKQ : public QObject, public AbstractScript,public DynamicCreate<Script_20Standard_BaudConsult_Confirm_CKQ>
{
    Q_OBJECT
public:
    explicit Script_20Standard_BaudConsult_Confirm_CKQ(QObject *parent = nullptr);
    ~Script_20Standard_BaudConsult_Confirm_CKQ();
    enum Script_20Standard_BaudConsult_Confirm_CKQ_RunState
    {
        ScriptInit,
...
private:
    Q_ENUM(Script_20Standard_BaudConsult_Confirm_CKQ_RunState)
    Script_20Standard_BaudConsult_Confirm_CKQ_RunState emScriptRunState=ScriptInit;
    QMetaEnum metaEnum=QMetaEnum::fromType<Script_20Standard_BaudConsult_Confirm_CKQ_RunState>();
    ...
    //
    QString testCase="【GW-STA-F028-0006-V01】";
private:
...
#endif // SCRIPT_20STANDARD_BAUDCONSULT_CONFIRM_CKQ_H
