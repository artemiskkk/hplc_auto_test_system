#ifndef SCRIPT_20STANDARD_BAUDCONSULT_DEFAULTRATE_CCO_H
#define SCRIPT_20STANDARD_BAUDCONSULT_DEFAULTRATE_CCO_H

#include <QObject>
#include "BaudConsult.h"
#include "BaudConsultPrepare.h"
#define SENCE2
class Script_20Standard_BaudConsult_DefaultRate_CCO : public QObject, public AbstractScript,public DynamicCreate<Script_20Standard_BaudConsult_DefaultRate_CCO>
{
    Q_OBJECT
public:
    explicit Script_20Standard_BaudConsult_DefaultRate_CCO(QObject *parent = nullptr);
    ~Script_20Standard_BaudConsult_DefaultRate_CCO();
    enum Script_20Standard_BaudConsult_DefaultRate_CCO_RunState
    {
        ScriptInit,
        Wait_BuildNetFinish_Whole,
        Wait_BaudConsultPrepare_Finish,
        Wait_BaudConsult_115200bps_Finish=115200,
        Wait_24hNoCommunication_Finish,
        Wait_ReadMeter_115200bps_Finish,
        Wait_ReadMeter_9600bps_Finish,
        Wait_BaudConsultPrepare1_Finish,
        Wait_BaudConsult_115200bps1_Finish,
        Wait_STA_PowerOff_PowerOn_Finish,
        Wait_ReadMeter_115200bps1_Finish,
        Wait_ReadMeter_9600bps1_Finish,
        ScriptSuccess
    };
private:
    Q_ENUM(Script_20Standard_BaudConsult_DefaultRate_CCO_RunState)
    Script_20Standard_BaudConsult_DefaultRate_CCO_RunState emScriptRunState=ScriptInit;
    QMetaEnum metaEnum=QMetaEnum::fromType<Script_20Standard_BaudConsult_DefaultRate_CCO_RunState>();
    ...
    //
    QString testCase="【GW-STA-F028-0005-V01】";
    QByteArray meterMsg;
    int baud=9600;
private:
...
#endif // SCRIPT_20STANDARD_BAUDCONSULT_DEFAULTRATE_CCO_H
