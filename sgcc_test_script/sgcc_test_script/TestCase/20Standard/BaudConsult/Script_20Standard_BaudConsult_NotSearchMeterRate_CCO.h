#ifndef SCRIPT_20STANDARD_BAUDCONSULT_NOTSEARCHMETERRATE_CCO_H
#define SCRIPT_20STANDARD_BAUDCONSULT_NOTSEARCHMETERRATE_CCO_H

#include <QObject>
#include "BaudConsult.h"
#include "BaudConsultPrepare.h"
#define SENCE2
class Script_20Standard_BaudConsult_NotSearchMeterRate_CCO : public QObject, public AbstractScript,public DynamicCreate<Script_20Standard_BaudConsult_NotSearchMeterRate_CCO>
{
    Q_OBJECT
public:
    explicit Script_20Standard_BaudConsult_NotSearchMeterRate_CCO(QObject *parent = nullptr);
    ~Script_20Standard_BaudConsult_NotSearchMeterRate_CCO();
    enum Script_20Standard_BaudConsult_NotSearchMeterRate_CCO_RunState
    {
        ScriptInit,
        Wait_BuildNetFinish_Whole,
        Wait_BaudConsultPrepare_Finish,
        Wait_BaudConsult_300bps_Finish=300,
        Wait_BaudConsult_600bps_Finish=600,
        Wait_BaudConsult_7200bps_Finish=97200,
        Wait_BaudConsult_38400bps_Finish=38400,
        Wait_BaudConsult_57600bps_Finish=57600,
        Wait_BaudConsult_230400bps_Finish=230400,
        Wait_BaudConsult_460800bps_Finish=460800,
        Wait_BaudConsult_625000bps_Finish=625000,
        ScriptSuccess
    };
private:
    Q_ENUM(Script_20Standard_BaudConsult_NotSearchMeterRate_CCO_RunState)
    Script_20Standard_BaudConsult_NotSearchMeterRate_CCO_RunState emScriptRunState=ScriptInit;
    QMetaEnum metaEnum=QMetaEnum::fromType<Script_20Standard_BaudConsult_NotSearchMeterRate_CCO_RunState>();
    ...
    //
    QString testCase="【GW-STA-F028-0007-V01】";
private:
...
#endif // SCRIPT_20STANDARD_BAUDCONSULT_NOTSEARCHMETERRATE_CCO_H
