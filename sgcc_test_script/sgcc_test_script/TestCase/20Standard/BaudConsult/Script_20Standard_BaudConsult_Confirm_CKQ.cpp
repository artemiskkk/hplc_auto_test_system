#include "Script_20Standard_BaudConsult_Confirm_CKQ.h"
Script_20Standard_BaudConsult_Confirm_CKQ::Script_20Standard_BaudConsult_Confirm_CKQ(QObject *parent) : QObject(parent)
{
...
Script_20Standard_BaudConsult_Confirm_CKQ::~Script_20Standard_BaudConsult_Confirm_CKQ()
{
...
void Script_20Standard_BaudConsult_Confirm_CKQ::setHost(AbstractScriptHost *host)
{
    p_AbstractScriptHost=host;
    p_BuildNetwork_GW->setHost(host);
}
void Script_20Standard_BaudConsult_Confirm_CKQ::addAddrsInfo(const QList<ConcentratorInfo> *p_ConcentratorInfoList, const QList<MeterInfo> *p_MeterInfoList, const QList<SchemeCfgInfo> *p_SchemeCfgInfoList, const int freq)
{
    p_CtrInfoList->clear();
...
bool Script_20Standard_BaudConsult_Confirm_CKQ::config(const QMap<QString,QString> *paraDic)
{
    bool result = false;
    if(paraDic!=nullptr)
    {
...
void Script_20Standard_BaudConsult_Confirm_CKQ::execute()
{
    ...
    p_AbstractScriptHost->updateProgress(ProcessState_Processing, "流程描述\n"
                                         ...
                                         "4.波特率协商19200bps   Wait_BaudConsult_19200bps_Finish\n"
                                         "5.波特率协商9600bps  Wait_BaudConsult_9600bps_Finish\n"
                                         "6.波特率协商4800bps  Wait_BaudConsult_4800bps_Finish\n"
                                         "7.波特率协商2400bps  Wait_BaudConsult_2400bps_Finish\n"
                                         "8.波特率协商1200bps  Wait_BaudConsult_1200bps_Finish\n");
...
void Script_20Standard_BaudConsult_Confirm_CKQ::stop()
{
    p_timer->stop();
    p_delayTimer->stop();
...
void Script_20Standard_BaudConsult_Confirm_CKQ::processMsg(DvcType dvcType, int id, uchar *data, int datalen)
{
    ...
    if(emScriptRunState==Wait_BuildNetFinish_Whole)//场景2-4
    {
        ...
        else
        {
            ...
            p_BaudConsultPrepare=new BaudConsultPrepare(p_CtrInfoList,p_AbstractScriptHost,9600,false);
            connect(p_BaudConsultPrepare,&BaudConsultPrepare::signalNoticeBaudConsultPrepareState,this,&Script_20Standard_BaudConsult_Confirm_CKQ::slotNoticeBaudConsultPrepareState);
...
void Script_20Standard_BaudConsult_Confirm_CKQ::processCtrlDvcRes(DvcType dvcType, QList<int> idList, CtrlCmdType ctrlCmdType, bool isSucs, QList<double> params)
{
    if(isSucs==false)
        return;
...
void Script_20Standard_BaudConsult_Confirm_CKQ::processMsgFromCCO(DvcType dvcType, int dvcId)
{
...
void Script_20Standard_BaudConsult_Confirm_CKQ::slotNoticeBaudConsultPrepareState(ProcessState pState, const QString &state)
{
    switch(emScriptRunState)
    {
        case Wait_BaudConsultPrepare_Finish:
        {
            if(pState==ProcessState_Processing)
            {
                ...
                p_BaudConsult=new BaudConsult(p_CtrInfoList,p_AbstractScriptHost,int(emScriptRunState),false);
                connect(p_BaudConsult,&BaudConsult::signalNoticeBaudConsultState,this,&Script_20Standard_BaudConsult_Confirm_CKQ::slotNoticeBaudConsultState);
...
void Script_20Standard_BaudConsult_Confirm_CKQ::slotNoticeBaudConsultState(ProcessState pState, const QString &state)
{
    if(p_BaudConsult!=nullptr)
        delete p_BaudConsult;
...
void Script_20Standard_BaudConsult_Confirm_CKQ::processMsgFromMeter645(DvcType dvcType, int dvcId, int mtrlID)
{
    bool haveCompleteMsg=true;
    while(haveCompleteMsg)
    {
...
void Script_20Standard_BaudConsult_Confirm_CKQ::processMsgFromMeterOOP(DvcType dvcType, int dvcId, int mtrlID)
{
    bool haveCompleteMsg=true;
    while(haveCompleteMsg)
    {
...
void Script_20Standard_BaudConsult_Confirm_CKQ::sendMsg(DvcType dvcType, int dvcId, int meterID, shared_ptr<void> frame)
{
...
void Script_20Standard_BaudConsult_Confirm_CKQ::sendSrcMsg(DvcType dvcType, int dvcId, QByteArray msg)
{
    if(msg.size()<1)
        return;
...
void Script_20Standard_BaudConsult_Confirm_CKQ::timer_timeoutProc()
{
    switch(emScriptRunState)
    {
        case Wait_BuildNetFinish_Whole:
...
void Script_20Standard_BaudConsult_Confirm_CKQ::maxAllowTimer_timeoutProc()
{
    switch(emScriptRunState)
    {
        default:
...
void Script_20Standard_BaudConsult_Confirm_CKQ::delayTimer_timeoutProc()
{
    switch(emScriptRunState)
    {
        default:
