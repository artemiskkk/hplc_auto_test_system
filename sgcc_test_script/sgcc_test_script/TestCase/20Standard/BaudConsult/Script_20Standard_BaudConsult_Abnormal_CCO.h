#ifndef SCRIPT_20STANDARD_BAUDCONSULT_ABNORMAL_CCO_H
#define SCRIPT_20STANDARD_BAUDCONSULT_ABNORMAL_CCO_H

#include <QObject>
#include "BaudConsult.h"
#include "BaudConsultPrepare.h"
#define SENCE2
class Script_20Standard_BaudConsult_Abnormal_CCO : public QObject, public AbstractScript,public DynamicCreate<Script_20Standard_BaudConsult_Abnormal_CCO>
{
    Q_OBJECT
public:
    explicit Script_20Standard_BaudConsult_Abnormal_CCO(QObject *parent = nullptr);
    ~Script_20Standard_BaudConsult_Abnormal_CCO();
    enum Script_20Standard_BaudConsult_Abnormal_CCO_RunState
    {
        ScriptInit,
...
private:
    Q_ENUM(Script_20Standard_BaudConsult_Abnormal_CCO_RunState)
    Script_20Standard_BaudConsult_Abnormal_CCO_RunState emScriptRunState=ScriptInit;
    QMetaEnum metaEnum=QMetaEnum::fromType<Script_20Standard_BaudConsult_Abnormal_CCO_RunState>();
    ...
    //
    QString testCase="【GW-STA-F028-0003-V01】";
    BaudConsult::BaudConsultSpecialType m_SpecialType=BaudConsult::Abnormal_NoResponse;
private:
...
#endif // SCRIPT_20STANDARD_BAUDCONSULT_ABNORMAL_CCO_H
