#ifndef SCRIPT_IDENTITYFLOW_STA_H
#define SCRIPT_IDENTITYFLOW_STA_H

#include "../InteroperateBase_GW.h"
enum Script_IdentityFlow_STA_RunState
{
    ScriptInit,
...
class Script_IdentityFlow_STA : public InteroperateBase_GW, public AbstractScript,public DynamicCreate<Script_IdentityFlow_STA>
{
    Q_OBJECT
public:
    explicit Script_IdentityFlow_STA(QObject *parent = nullptr);
    ~Script_IdentityFlow_STA();
private:
    Script_IdentityFlow_STA_RunState emScriptRunState=ScriptInit;
    uchar protocol=0x00;
private:
...
#endif // SCRIPT_IDENTITYFLOW_STA_H
