#ifndef SCRIPT_EVENTACTIVEREPORT_OOP_H
#define SCRIPT_EVENTACTIVEREPORT_OOP_H

#include "../InteroperateBase_GW.h"
enum Script_EventActiveReport_OOP_RunState
{
    ScriptInit,
...
class Script_EventActiveReport_OOP : public InteroperateBase_GW, public AbstractScript,public DynamicCreate<Script_EventActiveReport_OOP>
{
    Q_OBJECT
public:
    explicit Script_EventActiveReport_OOP(QObject *parent = nullptr);
    ~Script_EventActiveReport_OOP();
private:
    Script_EventActiveReport_OOP_RunState emScriptRunState=ScriptInit;
    uchar protocol=0x00;
private:
...
#endif // SCRIPT_EVENTACTIVEREPORT_OOP_H
