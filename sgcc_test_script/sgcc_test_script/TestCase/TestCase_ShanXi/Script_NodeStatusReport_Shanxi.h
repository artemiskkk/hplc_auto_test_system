#ifndef SCRIPT_NODESTATUSREPORT_SHANXI_H
#define SCRIPT_NODESTATUSREPORT_SHANXI_H

#include <QObject>
#include "TestCase/BuildNetwork_GW.h"

enum Script_NodeStatusReport_RunState
{
    TestInit,
    ...
    Wait_NodeStatusReportSwitch_05F201_Finish,
...
class Script_NodeStatusReport_Shanxi : public QObject, public AbstractScript,public DynamicCreate<Script_NodeStatusReport_Shanxi>
{
    Q_OBJECT
public:
    explicit Script_NodeStatusReport_Shanxi(QObject *parent = nullptr);
    ~Script_NodeStatusReport_Shanxi();

    Script_NodeStatusReport_RunState emScriptRunState;
    ...
    shared_ptr<Afn05F201> p_NodeStatusReportSwitch_05F201;
...
//    ushort index=0;
    ...
    /***可配置参数***/
    ushort timerForReachThresld=55*60; //单位:s
    ...
    const int maxWaitReportTime=45*60;
public:
    void  execute();
    void  stop();
...
#endif // SCRIPT_NODESTATUSREPORT_SHANXI_H
