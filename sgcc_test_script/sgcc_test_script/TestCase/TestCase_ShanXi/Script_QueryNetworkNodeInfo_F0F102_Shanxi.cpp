#include "Script_QueryNetworkNodeInfo_F0F102_Shanxi.h"

Script_QueryNetworkNodeInfo_F0F102_Shanxi::Script_QueryNetworkNodeInfo_F0F102_Shanxi(QObject *parent) : QObject(parent)
{
    ...
    p_QueryNetworkNodeInfo_F0F102=make_shared<AfnF0F102>();
...
Script_QueryNetworkNodeInfo_F0F102_Shanxi::~Script_QueryNetworkNodeInfo_F0F102_Shanxi()
{
...
void Script_QueryNetworkNodeInfo_F0F102_Shanxi::execute()
{
...
void Script_QueryNetworkNodeInfo_F0F102_Shanxi::stop()
{
...
void Script_QueryNetworkNodeInfo_F0F102_Shanxi::addAddrsInfo(const QList<ConcentratorInfo> *p_ConcentratorInfoList, const QList<MeterInfo> *p_MeterInfoList, const QList<SchemeCfgInfo> *p_SchemeCfgInfoList, const int freq)
{
    p_CtrInfoList->clear();
...
void Script_QueryNetworkNodeInfo_F0F102_Shanxi::setHost(AbstractScriptHost *host)
{
    p_AbstractScriptHost=host;
    p_BuildNetwork_GW->setHost(host);
}
bool Script_QueryNetworkNodeInfo_F0F102_Shanxi::config(const QMap<QString,QString> *paraDic)
{
    bool result = false;
    if(paraDic!=nullptr)
    {
...
void Script_QueryNetworkNodeInfo_F0F102_Shanxi::processMsg(DvcType dvcType,int id,uchar* data,int datalen)
{
...
void Script_QueryNetworkNodeInfo_F0F102_Shanxi::processCtrlDvcRes(DvcType dvcType,QList<int> idList, CtrlCmdType ctrlCmdType, bool isSucs, QList<double> params)
{
    if(isSucs==false)
        return;
    ...
    switch(emScriptRunState)
    {
        ...
        case Wait_QueryNetworkNodeInfo_F0F102_Finish:
        {
            break;
        }
        case Wait_QueryNetworkNodeInfo_F0F102_2_Finish:
        {
            break;
        }
        case Wait_ParaInit_01F2_2_Finish:
        {
            break;
        }
        case Wait_QueryNetworkNodeInfo_F0F102_3_Finish:
        {
            break;
        }
        case ScriptSuccess:
...
void Script_QueryNetworkNodeInfo_F0F102_Shanxi::sendSrcMsg(DvcType dvcType, int dvcId, QByteArray msg)
{
    if(msg.size()<1)
        return;
...
void Script_QueryNetworkNodeInfo_F0F102_Shanxi::processMsgFromCCO(DvcType dvcType, int dvcId)
{
...
//                        emScriptRunState=Wait_QueryNetScale_2_10F9_Finish;
                    ...
                    {
                        emSetNodeStartNo_State = NodeStartNo_1;
//                        node_start_number += first_query_num;
                        sendMsg(CCO_GW,p_CtrInfoList->at(0)->ctrlID,INSIGNIFICANCE,p_QueryNetworkNodeInfo_F0F102);
                        emScriptRunState=Wait_QueryNetworkNodeInfo_F0F102_Finish;
                        p_AbstractScriptHost->updateProgress(ProcessState_Processing, "发送--查询网络节点信息（F0F102），从1开始，等待--确认");
                        p_timer->start(CTRL_CMD_TIMEOUT_TIME*1000);
                        node_start_number += everytime_query_network_node_info_num;//查n个，下次从n+1来时
                        emSetNodeStartNo_State = NodeStartNo_Not_0_or_1;
                    }
                    else
                    {
            ...
            case Wait_QueryNetworkNodeInfo_F0F102_Finish:
            {
                if(p_Frame3762Base->afn_ == char(0xf0)&&p_Frame3762Base->dt1_==0x20&&p_Frame3762Base->dt2_==0x0C&&p_Frame3762Base->ctrl_field_.dir == kDirUp)
                {
                    p_timer->stop();
                    shared_ptr<AfnF0F102> p_QueryNetworkNodeInfo_F0F102_Up=dynamic_pointer_cast<AfnF0F102>(p_Frame3762Base);
                    if(node_start_number<netScale)
                    {
                        //是否添加超时重发?????
                        sendMsg(CCO_GW,p_CtrInfoList->at(0)->ctrlID,INSIGNIFICANCE,p_QueryNetworkNodeInfo_F0F102);
//                        emScriptRunState=Wait_QueryNetworkNodeInfo_F0F102_Finish;
                        p_AbstractScriptHost->updateProgress(ProcessState_Processing, "发送--查询网络节点信息（F0F102），等待--确认");
                        p_timer->start(CTRL_CMD_TIMEOUT_TIME*1000);
                        node_start_number += everytime_query_network_node_info_num;//查n个，下次从n+1来时
                    }
                    else if(node_start_number >= netScale)
                    {
                        emSetNodeStartNo_State = NodeStartNo_0;
                        node_start_number = 0;   //节点起始序号
//                        first_query_num = 1;    //首次查询时的节点起始号：0或1
                        sendMsg(CCO_GW,p_CtrInfoList->at(0)->ctrlID,INSIGNIFICANCE,p_QueryNetworkNodeInfo_F0F102);
                        emScriptRunState=Wait_QueryNetworkNodeInfo_F0F102_2_Finish;
                        p_AbstractScriptHost->updateProgress(ProcessState_Processing, "发送--查询网络节点信息（F0F102），从0开始，等待--确认");
                        p_timer->start(CTRL_CMD_TIMEOUT_TIME*1000);
                        node_start_number += everytime_query_network_node_info_num;//查n个，下次从n+1来时
                        emSetNodeStartNo_State = NodeStartNo_Not_0_or_1;
                    }
    ...
    //                        emScriptRunState=Wait_QueryNetworkNodeInfo_F0F102_Finish;
                    ...
                    {
                        sendMsg(CCO_GW,p_CtrInfoList->at(0)->ctrlID,INSIGNIFICANCE,p_ParaInit_01F2);
                        emScriptRunState=Wait_ParaInit_01F2_2_Finish;
                        p_AbstractScriptHost->updateProgress(ProcessState_Processing, "发送--参数初始化（O1F2_2），等待--确认");
                        p_timer->start(CTRL_CMD_TIMEOUT_TIME*1000);
                    }
                }
                else
            ...
            case Wait_ParaInit_01F2_2_Finish:
            {
                if(p_Frame3762Base->afn_ == 0x00&&p_Frame3762Base->dt1_==0x01&&p_Frame3762Base->dt2_==0x00&&p_Frame3762Base->ctrl_field_.dir == kDirUp)
                {
                    ...
                    p_AbstractScriptHost->updateProgress(ProcessState_Processing, "参数初始化回复确认！");
                    sendMsg(CCO_GW,p_CtrInfoList->at(0)->ctrlID,INSIGNIFICANCE,p_QueryNetworkNodeInfo_F0F102);
                    emScriptRunState=Wait_QueryNetworkNodeInfo_F0F102_3_Finish;
                    p_AbstractScriptHost->updateProgress(ProcessState_Processing, "发送--查询网络节点信息（F0F102），初始化后，等待--回复");
                    p_timer->start(10*1000);
                }
                else
                {
            ...
            case Wait_QueryNetworkNodeInfo_F0F102_3_Finish:
            {
                ...
                {
                    p_timer->stop();
                    shared_ptr<AfnF0F102> p_QueryNetworkNodeInfo_F0F102_3_Up=dynamic_pointer_cast<AfnF0F102>(p_Frame3762Base);

                    if(p_QueryNetworkNodeInfo_F0F102_3_Up->network_node_info_unit_.node_total_num_== 1)
                    {
                        emScriptRunState=ScriptSuccess;
                        resultFlag=true;
                        p_AbstractScriptHost->updateProgress(ProcessState_Success, QString("查询网络节点信息测试成功！"));
                    }
                    else
                    {
...
void Script_QueryNetworkNodeInfo_F0F102_Shanxi::processMsgFromMeter645(DvcType dvcType, int dvcId, int mtrlID)
{
    bool haveCompleteMsg=true;
    while(haveCompleteMsg)
    {
...
void Script_QueryNetworkNodeInfo_F0F102_Shanxi::processMsgFromMeterOOP(DvcType dvcType, int dvcId, int mtrlID)
{
    bool haveCompleteMsg=true;
    while(haveCompleteMsg)
    {
...
void Script_QueryNetworkNodeInfo_F0F102_Shanxi::sendMsg(DvcType dvcType, int dvcId, int meterID, shared_ptr<void> frame)
{
    sendMsgOct.clear();
    ...
    else if(frame==p_QueryNetworkNodeInfo_F0F102)
    {
        p_QueryNetworkNodeInfo_F0F102->ctrl_field_.dir=kDirDown;
        p_QueryNetworkNodeInfo_F0F102->ctrl_field_.prm=kActive;
        p_QueryNetworkNodeInfo_F0F102->ctrl_field_.comn_type=kHplc;

        p_QueryNetworkNodeInfo_F0F102->info_field_.info_field_down.msg_seq=char(msgSeq++);
        p_QueryNetworkNodeInfo_F0F102->info_field_.info_field_down.comu_rate=0;
        p_QueryNetworkNodeInfo_F0F102->info_field_.info_field_down.comu_module_ident=0;

        if(emSetNodeStartNo_State == NodeStartNo_0)
        {
            p_QueryNetworkNodeInfo_F0F102->node_start_no_ = 0;
        }
        else if(emSetNodeStartNo_State == NodeStartNo_1)
        {
            p_QueryNetworkNodeInfo_F0F102->node_start_no_ = 1;
        }
        else
        {
            p_QueryNetworkNodeInfo_F0F102->node_start_no_ = node_start_number+1;
        }
//        p_QueryNetworkNodeInfo_F0F102->node_start_no_ = node_start_number;
        p_QueryNetworkNodeInfo_F0F102->node_num_ = everytime_query_network_node_info_num;

        sendMsgOct=p_QueryNetworkNodeInfo_F0F102->EncodeFrame();
        sendMsgLog=QString("》》查询网络节点信息（F0F102）：%1\n").arg(QString(sendMsgOct.toHex().toUpper()));
    }
...
void Script_QueryNetworkNodeInfo_F0F102_Shanxi::timer_timeoutProc()
{
    p_timer->stop();
    switch(emScriptRunState)
    {
        ...
        case Wait_QueryNetworkNodeInfo_F0F102_Finish:
        {
            p_AbstractScriptHost->updateProgress(ProcessState_Failed, "Wait_QueryNetworkNodeInfo_F0F102_Finish timeout!!!");
            break;
        }
        case Wait_ParaInit_01F2_2_Finish:
        {
            p_AbstractScriptHost->updateProgress(ProcessState_Failed, "Wait_ParaInit_01F2_2_Finish timeout!!!");
            break;
        }
        case Wait_QueryNetworkNodeInfo_F0F102_2_Finish:
        {
            p_AbstractScriptHost->updateProgress(ProcessState_Failed, "Wait_QueryNetworkNodeInfo_F0F102_2_Finish timeout!!!");
            break;
        }
        case Wait_QueryNetworkNodeInfo_F0F102_3_Finish:
        {
            p_AbstractScriptHost->updateProgress(ProcessState_Failed, "Wait_QueryNetworkNodeInfo_F0F102_3_Finish timeout!!!");
            break;
        }
        default:
        {
...
void Script_QueryNetworkNodeInfo_F0F102_Shanxi::delayTimer_timeoutProc()
{
    p_delayTimer->stop();
...
void Script_QueryNetworkNodeInfo_F0F102_Shanxi::maxAllowTimer_timeoutProc()
{
    ...
    switch(emScriptRunState)
    {
        ...
        case Wait_QueryNetworkNodeInfo_F0F102_Finish:
        {
            p_AbstractScriptHost->updateProgress(ProcessState_Failed, "Wait_QueryBasicNetworkInfo_F0F100_Finish maxAllow timeout!!!");
            break;
        }
        case Wait_ParaInit_01F2_2_Finish:
        {
            p_AbstractScriptHost->updateProgress(ProcessState_Failed, "Wait_ParaInit_01F2_2_Finish maxAllow timeout!!!");
            break;
        }
        case Wait_QueryNetworkNodeInfo_F0F102_2_Finish:
        {
            p_AbstractScriptHost->updateProgress(ProcessState_Failed, "Wait_QueryNetworkNodeInfo_F0F102_3_Finish maxAllow timeout!!!");
            break;
        }
        case Wait_QueryNetworkNodeInfo_F0F102_3_Finish:
        {
