#ifndef SCRIPT_QUERYBASICNETWORKINFO_SHANXI_H
#define SCRIPT_QUERYBASICNETWORKINFO_SHANXI_H

#include <QObject>
#include "TestCase/BuildNetwork_GW.h"

enum Script_QueryBasicNetworkInfo_RunState
{
    TestInit,
    ...
    Wait_QueryBasicNetworkInfo_F0F100_Finish,
    Wait_ParaInit_01F2_2_Finish,
    QueryBasicNetworkInfo_F0F100_2_Finish,

    ScriptSuccess
};

class Script_QueryBasicNetworkInfo_Shanxi : public QObject, public AbstractScript,public DynamicCreate<Script_QueryBasicNetworkInfo_Shanxi>
{
    Q_OBJECT
public:
    explicit Script_QueryBasicNetworkInfo_Shanxi(QObject *parent = nullptr);
    ~Script_QueryBasicNetworkInfo_Shanxi();

    Script_QueryBasicNetworkInfo_RunState emScriptRunState;
...
#endif // SCRIPT_QUERYBASICNETWORKINFO_SHANXI_H
