#include "Script_QueryBasicNetworkInfo_Shanxi.h"

Script_QueryBasicNetworkInfo_Shanxi::Script_QueryBasicNetworkInfo_Shanxi(QObject *parent) : QObject(parent)
{
...
Script_QueryBasicNetworkInfo_Shanxi::~Script_QueryBasicNetworkInfo_Shanxi()
{
...
void Script_QueryBasicNetworkInfo_Shanxi::execute()
{
...
void Script_QueryBasicNetworkInfo_Shanxi::stop()
{
...
void Script_QueryBasicNetworkInfo_Shanxi::addAddrsInfo(const QList<ConcentratorInfo> *p_ConcentratorInfoList, const QList<MeterInfo> *p_MeterInfoList, const QList<SchemeCfgInfo> *p_SchemeCfgInfoList, const int freq)
{
    p_CtrInfoList->clear();
...
void Script_QueryBasicNetworkInfo_Shanxi::setHost(AbstractScriptHost *host)
{
    p_AbstractScriptHost=host;
    p_BuildNetwork_GW->setHost(host);
}
bool Script_QueryBasicNetworkInfo_Shanxi::config(const QMap<QString,QString> *paraDic)
{
    bool result = false;
    if(paraDic!=nullptr)
    {
...
void Script_QueryBasicNetworkInfo_Shanxi::processMsg(DvcType dvcType,int id,uchar* data,int datalen)
{
...
void Script_QueryBasicNetworkInfo_Shanxi::processCtrlDvcRes(DvcType dvcType,QList<int> idList, CtrlCmdType ctrlCmdType, bool isSucs, QList<double> params)
{
    if(isSucs==false)
        return;
    ...
    switch(emScriptRunState)
    {
        ...
        case Wait_QueryBasicNetworkInfo_F0F100_Finish:
        {
            break;
        }
...
void Script_QueryBasicNetworkInfo_Shanxi::sendSrcMsg(DvcType dvcType, int dvcId, QByteArray msg)
{
    if(msg.size()<1)
        return;
...
void Script_QueryBasicNetworkInfo_Shanxi::processMsgFromCCO(DvcType dvcType, int dvcId)
{
...
//                        emScriptRunState=Wait_QueryNetScale_2_10F9_Finish;
                    ...
                    {
                        sendMsg(CCO_GW,p_CtrInfoList->at(0)->ctrlID,INSIGNIFICANCE,p_QueryBasicNetworkInfo_F0F100);
                        emScriptRunState=Wait_QueryBasicNetworkInfo_F0F100_Finish;
                        p_AbstractScriptHost->updateProgress(ProcessState_Processing, "发送--查询网络基本信息（F0F100），等待--确认");
                        p_timer->start(CTRL_CMD_TIMEOUT_TIME*1000);
                    }
                    else
                    {
            ...
            case Wait_QueryBasicNetworkInfo_F0F100_Finish:
            {
                if(p_Frame3762Base->afn_ == char(0xf0)&&p_Frame3762Base->dt1_==0x08&&p_Frame3762Base->dt2_==0x0C&&p_Frame3762Base->ctrl_field_.dir == kDirUp)
                {
                    ...
                    if(p_QueryBasicNetworkInfo_F0F100_Up->network_basic_unit_.node_total_num_ == netScale)
                    {
                        sendMsg(CCO_GW,p_CtrInfoList->at(0)->ctrlID,INSIGNIFICANCE,p_ParaInit_01F2);
                    ...
                    {
                        p_AbstractScriptHost->updateProgress(ProcessState_Failed, QString("查询网络基本信息（F0F100）异常"));
                    }
                }
                else
                {
            ...
            case Wait_ParaInit_01F2_2_Finish:
            {
                if(p_Frame3762Base->afn_ == 0x00&&p_Frame3762Base->dt1_==0x01&&p_Frame3762Base->dt2_==0x00&&p_Frame3762Base->ctrl_field_.dir == kDirUp)
                {
                    ...
                    p_AbstractScriptHost->updateProgress(ProcessState_Processing, "参数初始化回复确认！");
                    sendMsg(CCO_GW,p_CtrInfoList->at(0)->ctrlID,INSIGNIFICANCE,p_QueryBasicNetworkInfo_F0F100);
                    emScriptRunState=QueryBasicNetworkInfo_F0F100_2_Finish;
                    p_AbstractScriptHost->updateProgress(ProcessState_Processing, "发送--查询网络基本信息（F0F100）_2，等待--回复");
                    p_timer->start(10*1000);
                }
                else
                {
...
void Script_QueryBasicNetworkInfo_Shanxi::processMsgFromMeter645(DvcType dvcType, int dvcId, int mtrlID)
{
    bool haveCompleteMsg=true;
    while(haveCompleteMsg)
    {
...
void Script_QueryBasicNetworkInfo_Shanxi::processMsgFromMeterOOP(DvcType dvcType, int dvcId, int mtrlID)
{
    bool haveCompleteMsg=true;
    while(haveCompleteMsg)
    {
...
void Script_QueryBasicNetworkInfo_Shanxi::sendMsg(DvcType dvcType, int dvcId, int meterID, shared_ptr<void> frame)
{
    sendMsgOct.clear();
    ...
    else if(frame==p_QueryBasicNetworkInfo_F0F100)
    {
        p_QueryBasicNetworkInfo_F0F100->ctrl_field_.dir=kDirDown;
        p_QueryBasicNetworkInfo_F0F100->ctrl_field_.prm=kActive;
        p_QueryBasicNetworkInfo_F0F100->ctrl_field_.comn_type=kHplc;

        p_QueryBasicNetworkInfo_F0F100->info_field_.info_field_down.msg_seq=char(msgSeq++);
        p_QueryBasicNetworkInfo_F0F100->info_field_.info_field_down.comu_rate=0;
        p_QueryBasicNetworkInfo_F0F100->info_field_.info_field_down.comu_module_ident=0;

        sendMsgOct=p_QueryBasicNetworkInfo_F0F100->EncodeFrame();
        sendMsgLog=QString("》》查询网络基本信息（F0F100）：%1\n").arg(QString(sendMsgOct.toHex().toUpper()));
    }
...
void Script_QueryBasicNetworkInfo_Shanxi::timer_timeoutProc()
{
    p_timer->stop();
    switch(emScriptRunState)
    {
        ...
        case Wait_QueryBasicNetworkInfo_F0F100_Finish:
        {
            p_AbstractScriptHost->updateProgress(ProcessState_Failed, "Wait_QueryBasicNetworkInfo_F0F100_Finish timeout!!!");
            break;
        }
        case Wait_ParaInit_01F2_2_Finish:
        {
        ...
        case QueryBasicNetworkInfo_F0F100_2_Finish:
        {
            p_AbstractScriptHost->updateProgress(ProcessState_Failed, "QueryBasicNetworkInfo_F0F100_2_Finish timeout!!!");
            break;
        }
        default:
        {
...
void Script_QueryBasicNetworkInfo_Shanxi::delayTimer_timeoutProc()
{
    p_delayTimer->stop();
...
void Script_QueryBasicNetworkInfo_Shanxi::maxAllowTimer_timeoutProc()
{
    ...
    switch(emScriptRunState)
    {
        ...
        case QueryBasicNetworkInfo_F0F100_2_Finish:
        {
            p_AbstractScriptHost->updateProgress(ProcessState_Failed, "QueryBasicNetworkInfo_F0F100_2_Finish maxAllow timeout!!!");
            break;
        }
        default:
        {
