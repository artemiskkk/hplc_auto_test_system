#ifndef SCRIPT_QUERYNETWORKNODEINFO_F0F102_SHANXI_H
#define SCRIPT_QUERYNETWORKNODEINFO_F0F102_SHANXI_H
...
enum Script_QueryNetworkNodeInfo_F0F102_RunState
{
    ...
    Wait_QueryNetworkNodeInfo_F0F102_Finish,
    Wait_QueryNetworkNodeInfo_F0F102_2_Finish,

    Wait_ParaInit_01F2_2_Finish,
    Wait_QueryNetworkNodeInfo_F0F102_3_Finish,
...
class Script_QueryNetworkNodeInfo_F0F102_Shanxi : public QObject, public AbstractScript,public DynamicCreate<Script_QueryNetworkNodeInfo_F0F102_Shanxi>
{
    Q_OBJECT
public:
    explicit Script_QueryNetworkNodeInfo_F0F102_Shanxi(QObject *parent = nullptr);
    ~Script_QueryNetworkNodeInfo_F0F102_Shanxi();
...
//    shared_ptr<Afn06F10> p_ChangeNodeState_06F10;
    ...
    shared_ptr<AfnF0F102> p_QueryNetworkNodeInfo_F0F102;
...
//    ushort index=0;
    ...
    uchar everytime_query_network_node_info_num = 5; //每次查询网络节点信息个数
    ushort node_start_number = 0;   //节点起始序号
...
#endif // SCRIPT_QUERYNETWORKNODEINFO_F0F102_SHANXI_H
