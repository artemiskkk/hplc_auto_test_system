#ifndef SCRIPT_TRANSPARENTTRANS_H
#define SCRIPT_TRANSPARENTTRANS_H

#include <QObject>
#include "TestCase/BuildNetwork_GW.h"
enum Script_TransparentTrans_RunState
{
    TestInit,
...
/**
 * @brief The Script_TransparentTrans 透传功能-透传抄读【GW-CCO-F006-0001-V01】
 *
 */

class Script_TransparentTrans : public QObject, public AbstractScript,public DynamicCreate<Script_TransparentTrans>
{
    Q_OBJECT
//    Q_PLUGIN_METADATA(IID "com.topscomm.AbstractScript")
//    Q_INTERFACES(AbstractScript)
public:
    explicit Script_TransparentTrans(QObject *parent = nullptr);
    ~Script_TransparentTrans();
    Script_TransparentTrans_RunState emScriptRunState;
...
#endif // SCRIPT_TRANSPARENTTRANS_H
