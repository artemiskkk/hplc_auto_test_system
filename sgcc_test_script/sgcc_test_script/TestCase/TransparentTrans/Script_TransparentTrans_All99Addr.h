#ifndef SCRIPT_TRANSPARENTTRANS_ALL99ADDR_H
#define SCRIPT_TRANSPARENTTRANS_ALL99ADDR_H

#include <QObject>
#include "TestCase/BuildNetwork_GW.h"

enum Script_TransparentTrans_All99Addr_RunState
{
    TestInit,
...
/**
 * @brief The Script_TransparentTrans 透传功能-全9地址透传【GW-CCO-F006-0005-V01】
 *
 */

class Script_TransparentTrans_All99Addr : public QObject, public AbstractScript,public DynamicCreate<Script_TransparentTrans_All99Addr>
{
    Q_OBJECT
//    Q_PLUGIN_METADATA(IID "com.topscomm.AbstractScript")
//    Q_INTERFACES(AbstractScript)
public:
    explicit Script_TransparentTrans_All99Addr(QObject *parent = nullptr);
    ~Script_TransparentTrans_All99Addr();
    Script_TransparentTrans_All99Addr_RunState emScriptRunState;
...
#endif // SCRIPT_TRANSPARENTTRANS_ALL99ADDR_H
