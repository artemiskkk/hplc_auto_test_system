#ifndef SCRIPT_BROADCASTTIME_HUNAN_H
#define SCRIPT_BROADCASTTIME_HUNAN_H
#include <QObject>
...
class Script_BroadcastTime_Hunan : public QObject, public AbstractScript,public DynamicCreate<Script_BroadcastTime_Hunan>
{
    Q_OBJECT
//    Q_PLUGIN_METADATA(IID "com.topscomm.AbstractScript")
//    Q_INTERFACES(AbstractScript)
public:
    explicit Script_BroadcastTime_Hunan(QObject *parent = nullptr);
    ~Script_BroadcastTime_Hunan();
...
#endif // SCRIPT_BROADCASTTIME_HUNAN_H
