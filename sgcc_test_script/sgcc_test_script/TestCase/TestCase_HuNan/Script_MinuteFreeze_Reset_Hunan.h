#ifndef SCRIPT_MINUTEFREEZE_RESET_HUNAN_H
#define SCRIPT_MINUTEFREEZE_RESET_HUNAN_H

#include <QObject>
#include "TestCase/BuildNetwork_GW.h"
enum Script_MinuteFreeze_Reset_Hunan_RunState
{
    TestInit,
...
class Script_MinuteFreeze_Reset_Hunan: public QObject, public AbstractScript,public DynamicCreate<Script_MinuteFreeze_Reset_Hunan>
{
    Q_OBJECT
//    Q_PLUGIN_METADATA(IID "com.topscomm.AbstractScript")
//    Q_INTERFACES(AbstractScript)
public:
    explicit Script_MinuteFreeze_Reset_Hunan(QObject *parent = nullptr);
    ~Script_MinuteFreeze_Reset_Hunan();
    Script_MinuteFreeze_Reset_Hunan_RunState emScriptRunState;
...
#endif // SCRIPT_MINUTEFREEZE_RESET_HUNAN_H
