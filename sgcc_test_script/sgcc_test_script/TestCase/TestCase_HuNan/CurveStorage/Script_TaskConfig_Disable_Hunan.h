#ifndef SCRIPT_TASKCONFIG_DISABLE_HUNAN_H
#define SCRIPT_TASKCONFIG_DISABLE_HUNAN_H

#include <QObject>
#include "TestCase/BuildNetwork_GW.h"

enum Script_TaskConfig_Disable_Hunan_RunState
{
    TestInit,
...
class Script_TaskConfig_Disable_Hunan : public QObject, public AbstractScript,public DynamicCreate<Script_TaskConfig_Disable_Hunan>
{
    Q_OBJECT
//    Q_PLUGIN_METADATA(IID "com.topscomm.AbstractScript")
//    Q_INTERFACES(AbstractScript)
public:
    explicit Script_TaskConfig_Disable_Hunan(QObject *parent = nullptr);
    ~Script_TaskConfig_Disable_Hunan();

    Script_TaskConfig_Disable_Hunan_RunState emScriptRunState;
...
#endif // SCRIPT_TASKCONFIG_DISABLE_HUNAN_H
