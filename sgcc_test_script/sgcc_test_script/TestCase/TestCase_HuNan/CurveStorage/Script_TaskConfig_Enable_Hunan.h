#ifndef SCRIPT_TASKCONFIG_ENABLE_HUNAN_H
#define SCRIPT_TASKCONFIG_ENABLE_HUNAN_H

#include <QObject>
#include "TestCase/BuildNetwork_GW.h"

enum Script_TaskConfig_Enable_Hunan_RunState
{
    TestInit,
    Wait_BuildNetFinish_Whole,
    Wait_QueryTaskConfig_645_Init_Finish,//回否认
    Wait_QueryTaskConfig_OOP_Init_Finish,//回否认
...
class Script_TaskConfig_Enable_Hunan : public QObject, public AbstractScript,public DynamicCreate<Script_TaskConfig_Enable_Hunan>
{
    Q_OBJECT
//    Q_PLUGIN_METADATA(IID "com.topscomm.AbstractScript")
//    Q_INTERFACES(AbstractScript)
public:
    explicit Script_TaskConfig_Enable_Hunan(QObject *parent = nullptr);
    ~Script_TaskConfig_Enable_Hunan();

    Script_TaskConfig_Enable_Hunan_RunState emScriptRunState;
...
#endif // SCRIPT_TASKCONFIG_ENABLE_HUNAN_H
