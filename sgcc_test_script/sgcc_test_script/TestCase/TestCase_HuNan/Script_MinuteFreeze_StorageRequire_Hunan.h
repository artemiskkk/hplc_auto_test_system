#ifndef SCRIPT_MINUTEFREEZE_STORAGEREQUIRE_HUNAN_H
#define SCRIPT_MINUTEFREEZE_STORAGEREQUIRE_HUNAN_H

#include <QObject>
#include "TestCase/BuildNetwork_GW.h"
enum Script_MinuteFreeze_StorageRequire_Hunan_RunState
{
    TestInit,
...
class Script_MinuteFreeze_StorageRequire_Hunan: public QObject, public AbstractScript,public DynamicCreate<Script_MinuteFreeze_StorageRequire_Hunan>
{
    Q_OBJECT
//    Q_PLUGIN_METADATA(IID "com.topscomm.AbstractScript")
//    Q_INTERFACES(AbstractScript)
public:
    explicit Script_MinuteFreeze_StorageRequire_Hunan(QObject *parent = nullptr);
    ~Script_MinuteFreeze_StorageRequire_Hunan();
    Script_MinuteFreeze_StorageRequire_Hunan_RunState emScriptRunState;
    ...
    ushort timerAfterReachThresld=400*60; //单位:s
...
//    ushort timerAfterReachThresld=500*60; //单位:s
//    double netSucRateThresld=1.0;
//    bool needBuildNet=true;
//    bool needPowerOff=true;
//    uchar addCntPerTime=5;
...
//    QString triOOP=QString("20000200 12,20010200 15,20040200 18,20050200 18,200a0200 14,00000200 20,00100200 20,00200200 20,"
//                           "00300200 10,00400200 10,00500200 10,00600200 10,00700200 10,00800200 10,10100200 0f,10300200 0f,20010200 0f");
//    int dataIDNum=2;//冻结数据项的个数
//    uchar realPeriod=1; //下行05F103的采集周期，单位min

//    int pointNum=288;    //F1F100下行数据点数
//public:
//    void  execute();
//    void  stop();
//    void  addAddrsInfo(const QList<ConcentratorInfo> *p_ConcentratorInfoList, const QList<MeterInfo> *p_MeterInfoList, const QList<SchemeCfgInfo> *p_SchemeCfgInfoList, const int freq);
...
#endif // SCRIPT_MINUTEFREEZE_STORAGEREQUIRE_HUNAN_H
