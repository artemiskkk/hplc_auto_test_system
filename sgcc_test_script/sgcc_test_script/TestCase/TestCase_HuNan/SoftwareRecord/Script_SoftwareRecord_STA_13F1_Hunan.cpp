#include "Script_SoftwareRecord_STA_13F1_Hunan.h"

Script_SoftwareRecord_STA_13F1_Hunan::Script_SoftwareRecord_STA_13F1_Hunan(QObject *parent) : QObject(parent)
{
...
Script_SoftwareRecord_STA_13F1_Hunan::~Script_SoftwareRecord_STA_13F1_Hunan()
{
...
void Script_SoftwareRecord_STA_13F1_Hunan::execute()
{
...
void Script_SoftwareRecord_STA_13F1_Hunan::stop()
{
...
void Script_SoftwareRecord_STA_13F1_Hunan::addAddrsInfo(const QList<ConcentratorInfo> *p_ConcentratorInfoList, const QList<MeterInfo> *p_MeterInfoList, const QList<SchemeCfgInfo> *p_SchemeCfgInfoList, const int freq)
{
    p_CtrInfoList->clear();
...
void Script_SoftwareRecord_STA_13F1_Hunan::setHost(AbstractScriptHost *host)
{
    p_AbstractScriptHost=host;
    p_BuildNetwork_GW->setHost(host);
}
bool Script_SoftwareRecord_STA_13F1_Hunan::config(const QMap<QString,QString> *paraDic)
{
    bool result = false;
    if(paraDic!=nullptr)
    {
...
void Script_SoftwareRecord_STA_13F1_Hunan::processMsg(DvcType dvcType, int id, uchar *data, int datalen)
{
...
void Script_SoftwareRecord_STA_13F1_Hunan::processCtrlDvcRes(DvcType dvcType, QList<int> idList, CtrlCmdType ctrlCmdType, bool isSucs, QList<double> params)
{
    if(isSucs==false)
        return;
...
void Script_SoftwareRecord_STA_13F1_Hunan::processMsgFromCCO(DvcType dvcType, int dvcId)
{
        ...
        switch(emScriptRunState)
        {
            ...
            case Wait_00F1_for_12F2_Pause:
            {
                if(p_Frame3762Base->afn_ == 0x00&&p_Frame3762Base->dt1_==0x01&&p_Frame3762Base->dt2_==0x00&&p_Frame3762Base->ctrl_field_.dir == kDirUp)
                {
                    ...
                    sendMsg(CCO_GW,dvcId,INSIGNIFICANCE,p_MonitorSlaveNode_13F1);
...
void Script_SoftwareRecord_STA_13F1_Hunan::processMsgFromMeter645(DvcType dvcType, int dvcId, int mtrlID)
{
    bool haveCompleteMsg=true;
    while(haveCompleteMsg)
    {
...
void Script_SoftwareRecord_STA_13F1_Hunan::processMsgFromMeterOOP(DvcType dvcType, int dvcId, int mtrlID)
{
    bool haveCompleteMsg=true;
    while(haveCompleteMsg)
    {
...
void Script_SoftwareRecord_STA_13F1_Hunan::sendMsg(DvcType dvcType, int dvcId, int meterID, shared_ptr<void> frame)
{
...
void Script_SoftwareRecord_STA_13F1_Hunan::sendSrcMsg(DvcType dvcType, int dvcId, QByteArray msg)
{
    if(msg.size()<1)
        return;
...
void Script_SoftwareRecord_STA_13F1_Hunan::timer_timeoutProc()
{
    switch(emScriptRunState)
    {
        case Wait_BuildNetFinish_Whole:
...
void Script_SoftwareRecord_STA_13F1_Hunan::maxAllowTimer_timeoutProc()
{
    switch(emScriptRunState)
    {
...
void Script_SoftwareRecord_STA_13F1_Hunan::delayTimer_timeoutProc()
{
    p_delayTimer->stop();
}

void Script_SoftwareRecord_STA_13F1_Hunan::softwareInfoInit()
{
    //加载程序文件
