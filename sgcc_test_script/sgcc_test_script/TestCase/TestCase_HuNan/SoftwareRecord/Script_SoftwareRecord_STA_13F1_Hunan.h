#ifndef SCRIPT_SOFTWARERECORD_STA_13F1_HUNAN_H
#define SCRIPT_SOFTWARERECORD_STA_13F1_HUNAN_H

#include <QCryptographicHash>
#include "TestCase/BuildNetwork_GW.h"

enum Script_SoftwareRecord_STA_13F1_Hunan_RunState
{
    TestInit,
...
class Script_SoftwareRecord_STA_13F1_Hunan : public QObject, public AbstractScript,public DynamicCreate<Script_SoftwareRecord_STA_13F1_Hunan>
{
    Q_OBJECT
//    Q_PLUGIN_METADATA(IID "com.topscomm.AbstractScript")
//    Q_INTERFACES(AbstractScript)
public:
    explicit Script_SoftwareRecord_STA_13F1_Hunan(QObject *parent = nullptr);
    ~Script_SoftwareRecord_STA_13F1_Hunan();

    Script_SoftwareRecord_STA_13F1_Hunan_RunState emScriptRunState;
...
#endif // SCRIPT_SOFTWARERECORD_STA_13F1_HUNAN_H
