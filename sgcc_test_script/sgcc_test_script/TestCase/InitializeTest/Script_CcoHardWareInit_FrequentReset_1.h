#ifndef SCRIPT_CCOHARDWAREINIT_FREQUENTRESET_1_H
#define SCRIPT_CCOHARDWAREINIT_FREQUENTRESET_1_H

#include <QObject>
#include "TestCase/BuildNetwork_GW.h"
#define SENCE3

enum Script_CcoHardWareInit_FrequentReset_1_RunState
{
    ScriptInit,
...
class Script_CcoHardWareInit_FrequentReset_1 : public QObject , public AbstractScript,public DynamicCreate<Script_CcoHardWareInit_FrequentReset_1>
{
    Q_OBJECT
public:
    explicit Script_CcoHardWareInit_FrequentReset_1(QObject *parent = nullptr);
    ~Script_CcoHardWareInit_FrequentReset_1();

private:
    Script_CcoHardWareInit_FrequentReset_1_RunState emScriptRunState = ScriptInit;
    ...
    QString test_name_="【GW-CCO-F014-0003-V01】硬件初始化-频繁复位1";
...
#endif // SCRIPT_CCOHARDWAREINIT_FREQUENTRESET_1_H
