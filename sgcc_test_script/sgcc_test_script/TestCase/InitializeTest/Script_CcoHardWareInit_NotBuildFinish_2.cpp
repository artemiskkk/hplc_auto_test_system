#include "Script_CcoHardWareInit_NotBuildFinish_2.h"

Script_CcoHardWareInit_NotBuildFinish_2::Script_CcoHardWareInit_NotBuildFinish_2(QObject *parent) : QObject(parent)
{
...
Script_CcoHardWareInit_NotBuildFinish_2::~Script_CcoHardWareInit_NotBuildFinish_2()
{
...
void Script_CcoHardWareInit_NotBuildFinish_2::setHost(AbstractScriptHost *host)
{
    p_AbstractScriptHost=host;
    p_BuildNetwork_GW->setHost(host);
}
void Script_CcoHardWareInit_NotBuildFinish_2::addAddrsInfo(const QList<ConcentratorInfo> *p_ConcentratorInfoList, const QList<MeterInfo> *p_MeterInfoList, const QList<SchemeCfgInfo> *p_SchemeCfgInfoList, const int freq)
{
    p_CtrInfoList->clear();
...
bool Script_CcoHardWareInit_NotBuildFinish_2::config(const QMap<QString,QString> *paraDic)
{
    bool result = false;
    if(paraDic!=nullptr)
    {
...
void Script_CcoHardWareInit_NotBuildFinish_2::execute()
{
...
void Script_CcoHardWareInit_NotBuildFinish_2::stop()
{
    p_timer->stop();
    p_delayTimer->stop();
    p_maxAllowTimer->stop();
...
void Script_CcoHardWareInit_NotBuildFinish_2::processMsg(DvcType dvcType, int id, uchar *data, int datalen)
{
...
void Script_CcoHardWareInit_NotBuildFinish_2::processCtrlDvcRes(DvcType dvcType, QList<int> idList, CtrlCmdType ctrlCmdType, bool isSucs, QList<double> params)
{
    if(isSucs==false)
        return;
...
void Script_CcoHardWareInit_NotBuildFinish_2::processMsgFromCCO(DvcType dvcType, int dvcId)
{
    ...
    while(haveCompleteMsg)
    {
        ...
        case Wait_SetAreaIdentification_05F6:
        {
            ...
            else if(p_Frame3762Base->afn_ == 0x10 && dtValue3762==4 && p_Frame3762Base->ctrl_field_.dir == kDirUp)
            {
                ...
                //if(event_report_flag_10F4_==0x00 && area_difference_flag_10F4_==0x01 && router_complete_flag == 0x00)//到这个时候可能已经组网完成了
                if(event_report_flag_10F4_==0x00 && area_difference_flag_10F4_==0x01)
                {
...
void Script_CcoHardWareInit_NotBuildFinish_2::processMsgFromMeter645(DvcType dvcType, int dvcId, int mtrlID)
{
    bool haveCompleteMsg=true;
    while(haveCompleteMsg)
    {
...
void Script_CcoHardWareInit_NotBuildFinish_2::processMsgFromMeterOOP(DvcType dvcType, int dvcId, int mtrlID)
{
    bool haveCompleteMsg=true;
    while(haveCompleteMsg)
    {
...
void Script_CcoHardWareInit_NotBuildFinish_2::sendMsg(DvcType dvcType, int dvcId, int meterID, shared_ptr<void> frame)
{
...
void Script_CcoHardWareInit_NotBuildFinish_2::sendSrcMsg(DvcType dvcType, int dvcId, QByteArray msg)
{
    if(msg.size()<1)
        return;
...
void Script_CcoHardWareInit_NotBuildFinish_2::timer_timeoutProc()
{
    switch(emScriptRunState)
    {
    case Wait_BuildNetFinish_Whole:
...
void Script_CcoHardWareInit_NotBuildFinish_2::maxAllowTimer_timeoutProc()
{
    p_delayTimer->stop();
    switch(emScriptRunState)
    {
...
void Script_CcoHardWareInit_NotBuildFinish_2::delayTimer_timeoutProc()
{
    p_delayTimer->stop();
    switch(emScriptRunState)
    {
...
bool Script_CcoHardWareInit_NotBuildFinish_2::meterIsExist(Address meterAddr)
{
