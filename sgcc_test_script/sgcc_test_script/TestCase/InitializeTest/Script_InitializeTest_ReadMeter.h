#ifndef SCRIPT_INITIALIZETEST_READMETER_H
#define SCRIPT_INITIALIZETEST_READMETER_H

#include <QObject>
#include "TestCase/BuildNetwork_GW.h"

enum Script_InitializeTest_ReadMeter_RunState
{
    TestInit,
...
class Script_InitializeTest_ReadMeter : public QObject, public AbstractScript,public DynamicCreate<Script_InitializeTest_ReadMeter>
{
    Q_OBJECT
//    Q_PLUGIN_METADATA(IID "com.topscomm.AbstractScript")
//    Q_INTERFACES(AbstractScript)
public:
    explicit Script_InitializeTest_ReadMeter(QObject *parent = nullptr);
    ~Script_InitializeTest_ReadMeter();
    Script_InitializeTest_ReadMeter_RunState emScriptRunState;
...
#endif // SCRIPT_INITIALIZETEST_READMETER_H
