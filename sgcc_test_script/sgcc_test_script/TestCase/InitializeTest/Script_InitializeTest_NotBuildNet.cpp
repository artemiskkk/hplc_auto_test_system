#include "Script_InitializeTest_NotBuildNet.h"

Script_InitializeTest_NotBuildNet::Script_InitializeTest_NotBuildNet(QObject *parent) : QObject(parent)
{
...
Script_InitializeTest_NotBuildNet::~Script_InitializeTest_NotBuildNet()
{
...
void Script_InitializeTest_NotBuildNet::execute()
{
...
void Script_InitializeTest_NotBuildNet::stop()
{
...
void Script_InitializeTest_NotBuildNet::addAddrsInfo(const QList<ConcentratorInfo> *p_ConcentratorInfoList, const QList<MeterInfo> *p_MeterInfoList, const QList<SchemeCfgInfo> *p_SchemeCfgInfoList, const int freq)
{
    p_CtrInfoList->clear();
...
void Script_InitializeTest_NotBuildNet::setHost(AbstractScriptHost *host)
{
    p_AbstractScriptHost=host;
    p_BuildNetwork_GW->setHost(host);
}
bool Script_InitializeTest_NotBuildNet::config(const QMap<QString,QString> *paraDic)
{
    bool result = false;
    if(paraDic!=nullptr)
    {
...
void Script_InitializeTest_NotBuildNet::processMsg(DvcType dvcType, int id, uchar *data, int datalen)
{
...
void Script_InitializeTest_NotBuildNet::processCtrlDvcRes(DvcType dvcType, QList<int> idList, CtrlCmdType ctrlCmdType, bool isSucs, QList<double> params)
{
    if(isSucs==false)
        return;
...
void Script_InitializeTest_NotBuildNet::processMsgFromCCO(DvcType dvcType, int dvcId)
{
...
void Script_InitializeTest_NotBuildNet::processMsgFromMeter645(DvcType dvcType, int dvcId, int mtrlID)
{
    bool haveCompleteMsg=true;
    while(haveCompleteMsg)
    {
...
void Script_InitializeTest_NotBuildNet::processMsgFromMeterOOP(DvcType dvcType, int dvcId, int mtrlID)
{
    bool haveCompleteMsg=true;
    while(haveCompleteMsg)
    {
...
void Script_InitializeTest_NotBuildNet::sendMsg(DvcType dvcType, int dvcId, int meterID, shared_ptr<void> frame)
{
...
void Script_InitializeTest_NotBuildNet::sendSrcMsg(DvcType dvcType, int dvcId, QByteArray msg)
{
    if(msg.size()<1)
        return;
...
void Script_InitializeTest_NotBuildNet::timer_timeoutProc()
{
    switch(emScriptRunState)
    {
        case Wait_BuildNetFinish_Whole:
...
void Script_InitializeTest_NotBuildNet::maxAllowTimer_timeoutProc()
{
    switch(emScriptRunState)
    {
        case Wait_HardResetTest_Finish:
...
void Script_InitializeTest_NotBuildNet::delayTimer_timeoutProc()
{
    p_delayTimer->stop();
    index=0;
...
bool Script_InitializeTest_NotBuildNet::meterIsExist(Address meterAddr)
{
