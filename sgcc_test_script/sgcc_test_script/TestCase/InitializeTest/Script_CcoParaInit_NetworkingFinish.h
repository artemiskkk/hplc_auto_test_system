#ifndef SCRIPT_CCOPARAINIT_NETWORKINGFINISH_H
#define SCRIPT_CCOPARAINIT_NETWORKINGFINISH_H

#include <QObject>
#include "TestCase/BuildNetwork_GW.h"
#define SENCE3

enum Script_CcoParaInit_NetworkingFinish_RunState
{
    ScriptInit,
...
class Script_CcoParaInit_NetworkingFinish : public QObject ,public AbstractScript,public DynamicCreate<Script_CcoParaInit_NetworkingFinish>
{
    Q_OBJECT
public:
    explicit Script_CcoParaInit_NetworkingFinish(QObject *parent = nullptr);
    ~Script_CcoParaInit_NetworkingFinish();

private:
    Script_CcoParaInit_NetworkingFinish_RunState emScriptRunState = ScriptInit;
    ...
    QString test_name_="【GW-CCO-F014-0009-V01】参数初始化-组网完成";
...
#endif // SCRIPT_CCOPARAINIT_NETWORKINGFINISH_H
