#ifndef SCRIPT_CCOHARDWAREINIT_NOTBUILDFINISH_1_H
#define SCRIPT_CCOHARDWAREINIT_NOTBUILDFINISH_1_H
...
class Script_CcoHardWareInit_NotBuildFinish_1 : public QObject , public AbstractScript,public DynamicCreate<Script_CcoHardWareInit_NotBuildFinish_1>
{
    Q_OBJECT
public:
    explicit Script_CcoHardWareInit_NotBuildFinish_1(QObject *parent = nullptr);
    ~Script_CcoHardWareInit_NotBuildFinish_1();
private:
    ...
    QString test_name_="【GW-CCO-F014-0001-V01】硬件初始化-组网未完成1";
...
#endif // SCRIPT_CCOHARDWAREINIT_NOTBUILDFINISH_1_H
