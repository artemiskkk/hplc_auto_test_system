#ifndef SCRIPT_INITIALIZETEST_H
#define SCRIPT_INITIALIZETEST_H

#include <QObject>
#include "TestCase/BuildNetwork_GW.h"

enum Script_InitializeTest_RunState
{
    TestInit,
...
class Script_InitializeTest : public QObject, public AbstractScript,public DynamicCreate<Script_InitializeTest>
{
    Q_OBJECT
//    Q_PLUGIN_METADATA(IID "com.topscomm.AbstractScript")
//    Q_INTERFACES(AbstractScript)
public:
    explicit Script_InitializeTest(QObject *parent = nullptr);
    ~Script_InitializeTest();
    Script_InitializeTest_RunState emScriptRunState;
