#ifndef SCRIPT_INITIALIZETEST_SEARCHMETER_H
#define SCRIPT_INITIALIZETEST_SEARCHMETER_H

#include <QObject>
#include "TestCase/BuildNetwork_GW.h"

enum Script_InitializeTest_SearchMeter_RunState
{
    TestInit,
    Wait_BuildNetFinish_Whole,
    Wait_QueryDefaultWorkSwitch_Finish,
    Wait_ActiveRegister_Finish,
...
class Script_InitializeTest_SearchMeter : public QObject, public AbstractScript,public DynamicCreate<Script_InitializeTest_SearchMeter>
{
    Q_OBJECT
//    Q_PLUGIN_METADATA(IID "com.topscomm.AbstractScript")
//    Q_INTERFACES(AbstractScript)
public:
    explicit Script_InitializeTest_SearchMeter(QObject *parent = nullptr);
    ~Script_InitializeTest_SearchMeter();
    Script_InitializeTest_SearchMeter_RunState emScriptRunState;
...
#endif // SCRIPT_INITIALIZETEST_SEARCHMETER_H
