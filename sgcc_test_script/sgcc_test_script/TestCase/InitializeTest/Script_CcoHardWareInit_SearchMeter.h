#ifndef SCRIPT_CCOHARDWAREINIT_SEARCHMETER_H
#define SCRIPT_CCOHARDWAREINIT_SEARCHMETER_H

#include <QObject>
#include "TestCase/BuildNetwork_GW.h"
#define SENCE3

enum Script_CcoHardWareInit_SearchMeter_RunState
{
    ScriptInit,
...
class Script_CcoHardWareInit_SearchMeter : public QObject , public AbstractScript,public DynamicCreate<Script_CcoHardWareInit_SearchMeter>
{
    Q_OBJECT
public:
    explicit Script_CcoHardWareInit_SearchMeter(QObject *parent = nullptr);
        ~Script_CcoHardWareInit_SearchMeter();

    private:
        Script_CcoHardWareInit_SearchMeter_RunState emScriptRunState = ScriptInit;
        ...
        QString test_name_="【GW-CCO-F014-0005-V01】硬件初始化-搜表";
...
#endif // SCRIPT_CCOHARDWAREINIT_SEARCHMETER_H
