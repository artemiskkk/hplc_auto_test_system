#ifndef SCRIPT_CCOHARDWAREINIT_NETWORKINGFINISH_2_H
#define SCRIPT_CCOHARDWAREINIT_NETWORKINGFINISH_2_H
...
class Script_CcoHardWareInit_NetworkingFinish_2 : public QObject, public AbstractScript,public DynamicCreate<Script_CcoHardWareInit_NetworkingFinish_2>
{
    Q_OBJECT
public:
    explicit Script_CcoHardWareInit_NetworkingFinish_2(QObject *parent = nullptr);
    ~Script_CcoHardWareInit_NetworkingFinish_2();
...
private:
    ...
    QString test_name_="【GW-CCO-F014-0015-V01】硬件初始化-组网完成2";
...
#endif // SCRIPT_CCOHARDWAREINIT_NETWORKINGFINISH_2_H
