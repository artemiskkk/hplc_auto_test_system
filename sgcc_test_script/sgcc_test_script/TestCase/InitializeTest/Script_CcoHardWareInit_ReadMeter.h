#ifndef SCRIPT_CCOHARDWAREINIT_READMETER_H
#define SCRIPT_CCOHARDWAREINIT_READMETER_H

#include <QObject>
#include "TestCase/BuildNetwork_GW.h"
#define SENCE3

enum Script_CcoHardWareInit_ReadMeter_RunState
{
    ScriptInit,
...
class Script_CcoHardWareInit_ReadMeter : public QObject , public AbstractScript,public DynamicCreate<Script_CcoHardWareInit_ReadMeter>
{
    Q_OBJECT
public:
    explicit Script_CcoHardWareInit_ReadMeter(QObject *parent = nullptr);
    ~Script_CcoHardWareInit_ReadMeter();

private:
    Script_CcoHardWareInit_ReadMeter_RunState emScriptRunState = ScriptInit;
    ...
    QString test_name_="【GW-CCO-F014-0004-V01】硬件初始化-抄表";
...
#endif // SCRIPT_CCOHARDWAREINIT_READMETER_H
