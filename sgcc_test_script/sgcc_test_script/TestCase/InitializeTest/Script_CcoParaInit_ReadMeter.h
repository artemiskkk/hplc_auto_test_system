#ifndef SCRIPT_CCOPARAINIT_READMETER_H
#define SCRIPT_CCOPARAINIT_READMETER_H
...
class Script_CcoParaInit_ReadMeter : public QObject , public AbstractScript,public DynamicCreate<Script_CcoParaInit_ReadMeter>
{
    Q_OBJECT
public:
    explicit Script_CcoParaInit_ReadMeter(QObject *parent = nullptr);
        ~Script_CcoParaInit_ReadMeter();
...
#endif // SCRIPT_CCOPARAINIT_READMETER_H
