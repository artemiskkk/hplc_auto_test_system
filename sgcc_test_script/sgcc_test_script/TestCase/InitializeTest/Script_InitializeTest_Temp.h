#ifndef SCRIPT_INITIALIZETEST_TEMP_H
#define SCRIPT_INITIALIZETEST_TEMP_H

#include <QObject>
#include "TestCase/BuildNetwork_GW.h"

enum Script_InitializeTest_Temp_RunState
{
    TestInit,
...
class Script_InitializeTest_Temp : public QObject, public AbstractScript,public DynamicCreate<Script_InitializeTest_Temp>
{
    Q_OBJECT
//    Q_PLUGIN_METADATA(IID "com.topscomm.AbstractScript")
//    Q_INTERFACES(AbstractScript)
public:
    explicit Script_InitializeTest_Temp(QObject *parent = nullptr);
    ~Script_InitializeTest_Temp();
    Script_InitializeTest_Temp_RunState emScriptRunState;
...
#endif // SCRIPT_INITIALIZETEST_TEMP_H
