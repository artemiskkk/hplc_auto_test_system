#ifndef SCRIPT_PULLPINRESET_100_H
#define SCRIPT_PULLPINRESET_100_H

#include <QObject>
#include "TestCase/BuildNetwork_GW.h"

enum Script_PullPinReset_100_RunState
{
    TestInit,
    Wait_BuildNetFinish_Whole,
    Wait_QueryDefaultWorkSwitch_Finish,
    Wait_HardResetTest_Finish,
    Wait_pullPinReset_Finish,
    ScriptSuccess
};
...
class Script_PullPinReset_100 : public QObject, public AbstractScript,public DynamicCreate<Script_PullPinReset_100>
{
    Q_OBJECT
//    Q_PLUGIN_METADATA(IID "com.topscomm.AbstractScript")
//    Q_INTERFACES(AbstractScript)
public:
    explicit Script_PullPinReset_100(QObject *parent = nullptr);
    ~Script_PullPinReset_100();
    Script_PullPinReset_100_RunState emScriptRunState;
    ...
    bool resendFlag;
    ushort resendNum=0;
    ushort pullPinResetNum=0;
    QString test_name_="【GW-CCO-F014-0004-V01】初始化-拉管脚初始化100次";
public:
    void  execute();
    void  stop();
...
#endif // SCRIPT_PULLPINRESET_100_H
