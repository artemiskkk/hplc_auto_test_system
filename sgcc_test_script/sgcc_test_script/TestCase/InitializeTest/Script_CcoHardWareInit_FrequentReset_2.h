#ifndef SCRIPT_CCOHARDWAREINIT_FREQUENTRESET_2_H
#define SCRIPT_CCOHARDWAREINIT_FREQUENTRESET_2_H

#include <QObject>
#include "TestCase/BuildNetwork_GW.h"
#define SENCE3

enum Script_CcoHardWareInit_FrequentReset_2_RunState
{
    ScriptInit,
...
class Script_CcoHardWareInit_FrequentReset_2 :public QObject, public AbstractScript,public DynamicCreate<Script_CcoHardWareInit_FrequentReset_2>
{
    Q_OBJECT
public:
    explicit Script_CcoHardWareInit_FrequentReset_2(QObject *parent = nullptr);
    ~Script_CcoHardWareInit_FrequentReset_2();

private:
    Script_CcoHardWareInit_FrequentReset_2_RunState emScriptRunState = ScriptInit;
    ...
    int query_10F21_index=0;
    int reset_index_ =0;
    QString test_name_="【GW-CCO-F014-0016-V01】硬件初始化-频繁复位2";
...
#endif // SCRIPT_CCOHARDWAREINIT_FREQUENTRESET_2_H
