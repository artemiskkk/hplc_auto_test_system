#include "Script_CcoHardWareInit_NetworkingFinish_2.h"

Script_CcoHardWareInit_NetworkingFinish_2::Script_CcoHardWareInit_NetworkingFinish_2(QObject *parent) : QObject(parent)
{
...
Script_CcoHardWareInit_NetworkingFinish_2::~Script_CcoHardWareInit_NetworkingFinish_2()
{
...
void Script_CcoHardWareInit_NetworkingFinish_2::setHost(AbstractScriptHost *host)
{
    p_AbstractScriptHost=host;
    p_BuildNetwork_GW->setHost(host);
}
void Script_CcoHardWareInit_NetworkingFinish_2::addAddrsInfo(const QList<ConcentratorInfo> *p_ConcentratorInfoList, const QList<MeterInfo> *p_MeterInfoList, const QList<SchemeCfgInfo> *p_SchemeCfgInfoList, const int freq)
{
    p_CtrInfoList->clear();
...
bool Script_CcoHardWareInit_NetworkingFinish_2::config(const QMap<QString,QString> *paraDic)
{
    bool result = false;
    if(paraDic!=nullptr)
    {
...
void Script_CcoHardWareInit_NetworkingFinish_2::execute()
{
...
void Script_CcoHardWareInit_NetworkingFinish_2::stop()
{
    p_timer->stop();
    p_delayTimer->stop();
...
void Script_CcoHardWareInit_NetworkingFinish_2::processMsg(DvcType dvcType, int id, uchar *data, int datalen)
{
...
void Script_CcoHardWareInit_NetworkingFinish_2::processCtrlDvcRes(DvcType dvcType, QList<int> idList, CtrlCmdType ctrlCmdType, bool isSucs, QList<double> params)
{
    if(isSucs==false)
        return;
...
void Script_CcoHardWareInit_NetworkingFinish_2::processMsgFromCCO(DvcType dvcType, int dvcId)
{
...
void Script_CcoHardWareInit_NetworkingFinish_2::processMsgFromMeter645(DvcType dvcType, int dvcId, int mtrlID)
{
    bool haveCompleteMsg=true;
    while(haveCompleteMsg)
    {
...
void Script_CcoHardWareInit_NetworkingFinish_2::processMsgFromMeterOOP(DvcType dvcType, int dvcId, int mtrlID)
{
    bool haveCompleteMsg=true;
    while(haveCompleteMsg)
    {
...
void Script_CcoHardWareInit_NetworkingFinish_2::sendMsg(DvcType dvcType, int dvcId, int meterID, shared_ptr<void> frame)
{
...
void Script_CcoHardWareInit_NetworkingFinish_2::sendSrcMsg(DvcType dvcType, int dvcId, QByteArray msg)
{
    if(msg.size()<1)
        return;
...
void Script_CcoHardWareInit_NetworkingFinish_2::timer_timeoutProc()
{
    switch(emScriptRunState)
    {
    case Wait_BuildNetFinish_Whole:
...
void Script_CcoHardWareInit_NetworkingFinish_2::maxAllowTimer_timeoutProc()
{
    p_delayTimer->stop();
    switch(emScriptRunState)
    {
...
void Script_CcoHardWareInit_NetworkingFinish_2::delayTimer_timeoutProc()
{
    p_delayTimer->stop();
    switch(emScriptRunState)
    {
...
bool Script_CcoHardWareInit_NetworkingFinish_2::meterIsExist(Address meterAddr)
{
