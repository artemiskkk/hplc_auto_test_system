#ifndef SCRIPT_PARAMETERMANAGE_ERASEFLASH_H
#define SCRIPT_PARAMETERMANAGE_ERASEFLASH_H

#include <QObject>
#include "TestCase/BuildNetwork_GW.h"
enum Script_ParameterManage_EraseFlash_RunState
{
    TestInit,
    ...
    Wait_QueryNodeNum_After_Finish,
    ScriptSuccess
};
class Script_ParameterManage_EraseFlash: public QObject, public AbstractScript,public DynamicCreate<Script_ParameterManage_EraseFlash>
{
    Q_OBJECT
//    Q_PLUGIN_METADATA(IID "com.topscomm.AbstractScript")
//    Q_INTERFACES(AbstractScript)
public:
    explicit Script_ParameterManage_EraseFlash(QObject *parent = nullptr);
    ~Script_ParameterManage_EraseFlash();
    Script_ParameterManage_EraseFlash_RunState emScriptRunState;
...
#endif // SCRIPT_PARAMETERMANAGE_ERASEFLASH_H
