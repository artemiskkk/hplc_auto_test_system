#ifndef SCRIPT_PARAMETERMANAGE_REPEATPARAMETER_H
#define SCRIPT_PARAMETERMANAGE_REPEATPARAMETER_H

#include <QObject>
#include "TestCase/BuildNetwork_GW.h"
enum Script_ParameterManage_RepeatParameter_RunState
{
    TestInit,
...
class Script_ParameterManage_RepeatParameter: public QObject, public AbstractScript,public DynamicCreate<Script_ParameterManage_RepeatParameter>
{
    Q_OBJECT
//    Q_PLUGIN_METADATA(IID "com.topscomm.AbstractScript")
//    Q_INTERFACES(AbstractScript)
public:
    explicit Script_ParameterManage_RepeatParameter(QObject *parent = nullptr);
    ~Script_ParameterManage_RepeatParameter();
    Script_ParameterManage_RepeatParameter_RunState emScriptRunState;
...
#endif // SCRIPT_PARAMETERMANAGE_REPEATPARAMETER_H
