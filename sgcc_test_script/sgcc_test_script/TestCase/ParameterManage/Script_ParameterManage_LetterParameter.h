...
#ifndef SCRIPT_PARAMETERMANAGE_LETTERPARAMETER_H
#define SCRIPT_PARAMETERMANAGE_LETTERPARAMETER_H

#include <QObject>
#include "TestCase/BuildNetwork_GW.h"
enum Script_ParameterManage_LetterParameter_RunState
{
    TestInit,
...
class Script_ParameterManage_LetterParameter: public QObject, public AbstractScript,public DynamicCreate<Script_ParameterManage_LetterParameter>
{
    Q_OBJECT
//    Q_PLUGIN_METADATA(IID "com.topscomm.AbstractScript")
//    Q_INTERFACES(AbstractScript)
public:
    explicit Script_ParameterManage_LetterParameter(QObject *parent = nullptr);
    ~Script_ParameterManage_LetterParameter();
    Script_ParameterManage_LetterParameter_RunState emScriptRunState;
...
#endif // SCRIPT_PARAMETERMANAGE_LETTERPARAMETER_H
