#ifndef SCRIPT_PARAMETERMANAGE_INITSTATE_H
#define SCRIPT_PARAMETERMANAGE_INITSTATE_H
...
/**
 * @brief The Script_ParameterManage_InitState_RunState 运行状态机
 */
enum Script_ParameterManage_InitState_RunState
{
    TestInit,
    Wait_BuildNetFinish_Whole,

    Wait_QueryCCOAddr_03F4_Finish,

    Wait_ParameterInitTest_Finish,    // 参数初始化
    Wait_QueryNodeNum_Finish,         //新增
    Wait_QueryCCOAddr_03F4_Finish_1,  //新增


    Wait_EraseFlashTest_Finish,        // 擦除路由Flash 1
    Wait_QueryNodeInfo_Finish,         //新增
    Wait_QueryCCOAddr_03F4_Finish_2,   //新增


    Wait_AddParameterTest_Finish,      // 添加档案

    Wait_EraseFlashTest_Finish_2,      // 擦除路由Flash 2
    Wait_QueryNodeInfo_Finish_2,       //新增
    Wait_QueryCCOAddr_03F4_Finish_3,   //新增

    Wait_SetCCOAddrTest_Finish,        // 设置地址
    Wait_QueryCCOAddr_03F4_Finish_4,

    // Wait_BurningUpgradeCCOTest_Finish,    // 烧写升级
...
/**
 * @brief The Script_ParameterManage_InitState 档案管理-初始状态 【GW-CCO-F016-0010-V01】
 *
 */

class Script_ParameterManage_InitState :  public QObject, public AbstractScript, public DynamicCreate<Script_ParameterManage_InitState>
{
    Q_OBJECT
public:
    explicit Script_ParameterManage_InitState(QObject *parent = nullptr);
    ~Script_ParameterManage_InitState();
private:
    Script_ParameterManage_InitState_RunState emScriptRunState = TestInit;
    ...
    shared_ptr<Afn10F2> p_QueryNodeInfo_10F2;  //查询档案信息
...
#endif // SCRIPT_PARAMETERMANAGE_INITSTATE_H
