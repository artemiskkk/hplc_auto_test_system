#ifndef SCRIPT_PARAMETERMANAGE_HARDRESET_H
#define SCRIPT_PARAMETERMANAGE_HARDRESET_H

#include <QObject>
#include "TestCase/BuildNetwork_GW.h"
enum Script_ParameterManage_HardReset_RunState
{
    TestInit,
...
class Script_ParameterManage_HardReset: public QObject, public AbstractScript,public DynamicCreate<Script_ParameterManage_HardReset>
{
    Q_OBJECT
//    Q_PLUGIN_METADATA(IID "com.topscomm.AbstractScript")
//    Q_INTERFACES(AbstractScript)
public:
    explicit Script_ParameterManage_HardReset(QObject *parent = nullptr);
    ~Script_ParameterManage_HardReset();
    Script_ParameterManage_HardReset_RunState emScriptRunState;
...
#endif // SCRIPT_PARAMETERMANAGE_HARDRESET_H
