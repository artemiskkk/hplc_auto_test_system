#ifndef SCRIPT_BROADCASTTIME_EXCEEDMAXTIME_H
#define SCRIPT_BROADCASTTIME_EXCEEDMAXTIME_H

#include <QObject>
#include "TestCase/BuildNetwork_GW.h"
enum Script_BroadcastTime_ExceedMaxTime_RunState
{
    BroadcastInit,
...
class Script_BroadcastTime_ExceedMaxTime : public QObject, public AbstractScript,public DynamicCreate<Script_BroadcastTime_ExceedMaxTime>
{
    Q_OBJECT
//    Q_PLUGIN_METADATA(IID "com.topscomm.AbstractScript")
//    Q_INTERFACES(AbstractScript)
public:
    explicit Script_BroadcastTime_ExceedMaxTime(QObject *parent = nullptr);
    ~Script_BroadcastTime_ExceedMaxTime();

    Script_BroadcastTime_ExceedMaxTime_RunState emScriptRunState;
...
#endif // SCRIPT_BROADCASTTIME_EXCEEDMAXTIME_H
