#ifndef SCRIPT_BROADCASTTIME_DELAYRELATED_H
#define SCRIPT_BROADCASTTIME_DELAYRELATED_H

#include <QObject>
#include "TestCase/BuildNetwork_GW.h"
enum Script_BroadcastTime_DelayRelated_RunState
{
    BroadcastInit,
    Wait_BuildNetFinish_Whole,
    Wait_QueryDelayTime_Finish,
...
class Script_BroadcastTime_DelayRelated : public QObject, public AbstractScript,public DynamicCreate<Script_BroadcastTime_DelayRelated>
{
    Q_OBJECT
//    Q_PLUGIN_METADATA(IID "com.topscomm.AbstractScript")
//    Q_INTERFACES(AbstractScript)
public:
    explicit Script_BroadcastTime_DelayRelated(QObject *parent = nullptr);
    ~Script_BroadcastTime_DelayRelated();

    Script_BroadcastTime_DelayRelated_RunState emScriptRunState;
    ...
    shared_ptr<Afn03F9> p_QueryDelayRelated_03F9;
...
#endif // SCRIPT_BROADCASTTIME_DELAYRELATED_H
