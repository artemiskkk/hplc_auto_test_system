#ifndef SCRIPT_BROADCASTTIME_H
#define SCRIPT_BROADCASTTIME_H

#include <QObject>
#include "TestCase/BuildNetwork_GW.h"
enum Script_BroadcastTime_RunState
{
    BroadcastInit,
...
class Script_BroadcastTime : public QObject, public AbstractScript,public DynamicCreate<Script_BroadcastTime>
{
    Q_OBJECT
//    Q_PLUGIN_METADATA(IID "com.topscomm.AbstractScript")
//    Q_INTERFACES(AbstractScript)
public:
    explicit Script_BroadcastTime(QObject *parent = nullptr);
    ~Script_BroadcastTime();

    Script_BroadcastTime_RunState emScriptRunState;
