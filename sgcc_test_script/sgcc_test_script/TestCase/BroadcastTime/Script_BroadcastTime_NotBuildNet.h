#ifndef SCRIPT_BROADCASTTIME_NOTBUILDNET_H
#define SCRIPT_BROADCASTTIME_NOTBUILDNET_H

#include "TestCase/BuildNetwork_GW.h"
enum Script_BroadcastTime_NotBuildNet_RunState
{
    BroadcastInit,
...
class Script_BroadcastTime_NotBuildNet : public QObject, public AbstractScript,public DynamicCreate<Script_BroadcastTime_NotBuildNet>
{
    Q_OBJECT
//    Q_PLUGIN_METADATA(IID "com.topscomm.AbstractScript")
//    Q_INTERFACES(AbstractScript)
public:
    explicit Script_BroadcastTime_NotBuildNet(QObject *parent = nullptr);
    ~Script_BroadcastTime_NotBuildNet();

    Script_BroadcastTime_NotBuildNet_RunState emScriptRunState;
    ...
    shared_ptr<Afn01F2> p_ParamInit_01F2;
...
#endif // SCRIPT_BROADCASTTIME_NOTBUILDNET_H
