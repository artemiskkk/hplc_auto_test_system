#ifndef SCRIPT_AREAIDENTITY_H
#define SCRIPT_AREAIDENTITY_H

#include <QObject>
#include "TestCase/BuildNetwork_GW.h"
enum Script_AreaIdentity_RunState
{
    TestInit,
    ...
    Wait_MonitorSlaveNode_Finish,
    Wait_SetAreaIdentityFlagDisable_Finish,
    Wait_QueryRouterStateDisable_Finish,
    ScriptSuccess
};
class Script_AreaIdentity : public QObject, public AbstractScript,public DynamicCreate<Script_AreaIdentity>
{
    Q_OBJECT
//    Q_PLUGIN_METADATA(IID "com.topscomm.AbstractScript")
//    Q_INTERFACES(AbstractScript)
public:
    explicit Script_AreaIdentity(QObject *parent = nullptr);
    ~Script_AreaIdentity();
    Script_AreaIdentity_RunState emScriptRunState;
    ...
    //参数
    struct ReadAreaInfo_Struct
    {
        Address nodeAddress;
        bool hasRead=false;
        uchar areaFlag=0;
    };
    QList<ReadAreaInfo_Struct> ReadAreaInfoList_13F1;
