#include "Script_SearchMeter_PartialPara_0Min_V2.h"

Script_SearchMeter_PartialPara_0Min_V2::Script_SearchMeter_PartialPara_0Min_V2(QObject *parent) : QObject(parent)
{
...
Script_SearchMeter_PartialPara_0Min_V2::~Script_SearchMeter_PartialPara_0Min_V2()
{
...
void Script_SearchMeter_PartialPara_0Min_V2::execute()
{
...
void Script_SearchMeter_PartialPara_0Min_V2::stop()
{
...
void Script_SearchMeter_PartialPara_0Min_V2::addAddrsInfo(const QList<ConcentratorInfo> *p_ConcentratorInfoList, const QList<MeterInfo> *p_MeterInfoList, const QList<SchemeCfgInfo> *p_SchemeCfgInfoList, const int freq)
{
    p_CtrInfoList->clear();
...
void Script_SearchMeter_PartialPara_0Min_V2::setHost(AbstractScriptHost *host)
{
    p_AbstractScriptHost=host;
    p_BuildNetwork_GW->setHost(host);
}
bool Script_SearchMeter_PartialPara_0Min_V2::config(const QMap<QString,QString> *paraDic)
{
    bool result = false;
    if(paraDic!=nullptr)
    {
...
void Script_SearchMeter_PartialPara_0Min_V2::processMsg(DvcType dvcType, int id, uchar *data, int datalen)
{
...
void Script_SearchMeter_PartialPara_0Min_V2::processCtrlDvcRes(DvcType dvcType, QList<int> idList, CtrlCmdType ctrlCmdType, bool isSucs, QList<double> params)
{
    if(isSucs==false)
        return;
...
void Script_SearchMeter_PartialPara_0Min_V2::processMsgFromCCO(DvcType dvcType, int dvcId)
{
    ...
    while(haveCompleteMsg)
    {
        ...
        case Wait_SearchMeter_11F5_Finish:
        {
            ...
            else if(p_Frame3762Base->afn_ == 0x06&&p_Frame3762Base->dt1_==0x04&&p_Frame3762Base->dt2_==0x00&&p_Frame3762Base->ctrl_field_.dir == kDirUp)
            {
                ...
                {
                    p_delayTimer->stop();
                    p_AbstractScriptHost->updateProgress(ProcessState_Failed, "06F3路由上报工况变动：搜表任务结束，不符合要求，上报表数"+QString::number(nodeInfoList.size()));
            ...
            else if(p_Frame3762Base->afn_ == 0x10&&p_Frame3762Base->dt1_==0x08&&p_Frame3762Base->dt2_==0x00&&p_Frame3762Base->ctrl_field_.dir == kDirUp)
            {
                        ...
                        && uchar(p_QueryRouterState_10F4_Up->router_operate_state_unit_.work_switch_.current_state_)==0x01)
                {
                    ...
                    emScriptRunState=AfterStopSearchMeter;
                    p_timer->start(CTRL_CMD_TIMEOUT_TIME*1000);
                }
                else
                {
        ...
        case AfterStopSearchMeter:
        {
            if(p_Frame3762Base->afn_ == 0x00&&p_Frame3762Base->dt1_==0x01&&p_Frame3762Base->dt2_==0x00&&p_Frame3762Base->ctrl_field_.dir == kDirUp)
            {
                p_timer->stop();
                p_AbstractScriptHost->updateProgress(ProcessState_Processing, "终止主动注册回复确认");
            ...
            else if(p_Frame3762Base->afn_ == 0x10&&p_Frame3762Base->dt1_==0x08&&p_Frame3762Base->dt2_==0x00&&p_Frame3762Base->ctrl_field_.dir == kDirUp)
            {
                ...
                {
                    p_AbstractScriptHost->updateProgress(ProcessState_Success, "当前状态为【其他】，注册允许状态为【不允许】，符合要求");
...
void Script_SearchMeter_PartialPara_0Min_V2::processMsgFromMeter645(DvcType dvcType, int dvcId, int mtrlID)
{
    bool haveCompleteMsg=true;
    while(haveCompleteMsg)
    {
...
void Script_SearchMeter_PartialPara_0Min_V2::processMsgFromMeterOOP(DvcType dvcType, int dvcId, int mtrlID)
{
    bool haveCompleteMsg=true;
    while(haveCompleteMsg)
    {
...
void Script_SearchMeter_PartialPara_0Min_V2::sendMsg(DvcType dvcType, int dvcId, int meterID, shared_ptr<void> frame)
{
...
void Script_SearchMeter_PartialPara_0Min_V2::sendSrcMsg(DvcType dvcType, int dvcId, QByteArray msg)
{
    if(msg.size()<1)
        return;
...
void Script_SearchMeter_PartialPara_0Min_V2::timer_timeoutProc()
{
    p_timer->stop();
    switch(emScriptRunState)
    {
...
void Script_SearchMeter_PartialPara_0Min_V2::maxAllowTimer_timeoutProc()
{
...
void Script_SearchMeter_PartialPara_0Min_V2::delayTimer_timeoutProc()
{
    p_delayTimer->stop();
    p_AbstractScriptHost->updateProgress(ProcessState_Processing, "11min内未收到06F4搜表上报");
...
void Script_SearchMeter_PartialPara_0Min_V2::statisticsNode()
{
...
Script_SearchMeter_PartialPara_0Min_V2::ParaExistState Script_SearchMeter_PartialPara_0Min_V2::judgeExistState()
{
    statisticsNode();
