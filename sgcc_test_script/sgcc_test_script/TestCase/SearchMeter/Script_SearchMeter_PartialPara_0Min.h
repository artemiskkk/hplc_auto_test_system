#ifndef SCRIPT_SEARCHMETER_PARTIALPARA_0MIN_H
#define SCRIPT_SEARCHMETER_PARTIALPARA_0MIN_H

#include <QObject>
#include "TestCase/BuildNetwork_GW.h"
enum Script_SearchMeter_PartialPara_0Min_RunState
{
    TestInit,
...
class Script_SearchMeter_PartialPara_0Min : public QObject, public AbstractScript,public DynamicCreate<Script_SearchMeter_PartialPara_0Min>
{
    Q_OBJECT
//    Q_PLUGIN_METADATA(IID "com.topscomm.AbstractScript")
//    Q_INTERFACES(AbstractScript)
public:
    explicit Script_SearchMeter_PartialPara_0Min(QObject *parent = nullptr);
    ~Script_SearchMeter_PartialPara_0Min();
    Script_SearchMeter_PartialPara_0Min_RunState emScriptRunState;
...
#endif // SCRIPT_SEARCHMETER_PARTIALPARA_0MIN_H
