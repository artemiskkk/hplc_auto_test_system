#ifndef SCRIPT_SEARCHMETER_NONEPARA_STOP_H
#define SCRIPT_SEARCHMETER_NONEPARA_STOP_H

#include <QObject>
#include "TestCase/BuildNetwork_GW.h"
enum Script_SearchMeter_NonePara_Stop_RunState
{
    TestInit,
...
class Script_SearchMeter_NonePara_Stop : public QObject, public AbstractScript,public DynamicCreate<Script_SearchMeter_NonePara_Stop>
{
    Q_OBJECT
//    Q_PLUGIN_METADATA(IID "com.topscomm.AbstractScript")
//    Q_INTERFACES(AbstractScript)
public:
    explicit Script_SearchMeter_NonePara_Stop(QObject *parent = nullptr);
    ~Script_SearchMeter_NonePara_Stop();
    Script_SearchMeter_NonePara_Stop_RunState emScriptRunState;
...
#endif // SCRIPT_SEARCHMETER_NONEPARA_STOP_H
