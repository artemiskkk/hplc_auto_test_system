#ifndef SCRIPT_PARAMETERSYNCHRONOUSFLOW_H
#define SCRIPT_PARAMETERSYNCHRONOUSFLOW_H

#include "../InteroperateBase_GW.h"
enum Script_ParameterSynchronousFlow_RunState
{
    ScriptInit,
    ...
    Wait_QueryRouterRunState_Finish,
    ScriptFinish
};
class Script_ParameterSynchronousFlow : public InteroperateBase_GW, public AbstractScript,public DynamicCreate<Script_ParameterSynchronousFlow>
{
    Q_OBJECT
public:
    explicit Script_ParameterSynchronousFlow(QObject *parent = nullptr);
    ~Script_ParameterSynchronousFlow();
private:
    Script_ParameterSynchronousFlow_RunState emScriptRunState=ScriptInit;
private:
...
#endif // SCRIPT_PARAMETERSYNCHRONOUSFLOW_H
