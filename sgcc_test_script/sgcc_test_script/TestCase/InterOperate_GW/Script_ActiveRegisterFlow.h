#ifndef SCRIPT_ACTIVEREGISTERFLOW_H
#define SCRIPT_ACTIVEREGISTERFLOW_H

#include "../InteroperateBase_GW.h"
enum Script_ActiveRegisterFlow_RunState
{
    ScriptInit,
...
class Script_ActiveRegisterFlow : public InteroperateBase_GW, public AbstractScript,public DynamicCreate<Script_ActiveRegisterFlow>
{
    Q_OBJECT
public:
    explicit Script_ActiveRegisterFlow(QObject *parent = nullptr);
    ~Script_ActiveRegisterFlow();
private:
    Script_ActiveRegisterFlow_RunState emScriptRunState=ScriptInit;
private:
...
#endif // SCRIPT_ACTIVEREGISTERFLOW_H
