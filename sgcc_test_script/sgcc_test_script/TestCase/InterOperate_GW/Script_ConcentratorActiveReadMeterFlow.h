#ifndef SCRIPT_CONCENTRATORACTIVEREADMETERFLOW_H
#define SCRIPT_CONCENTRATORACTIVEREADMETERFLOW_H

#include "../InteroperateBase_GW.h"
enum Script_ConcentratorActiveReadMeterFlow_RunState
{
    ScriptInit,
...
class Script_ConcentratorActiveReadMeterFlow : public InteroperateBase_GW, public AbstractScript,public DynamicCreate<Script_ConcentratorActiveReadMeterFlow>
{
    Q_OBJECT
public:
    explicit Script_ConcentratorActiveReadMeterFlow(QObject *parent = nullptr);
    ~Script_ConcentratorActiveReadMeterFlow();
private:
    Script_ConcentratorActiveReadMeterFlow_RunState emScriptRunState=ScriptInit;
private:
...
#endif // SCRIPT_CONCENTRATORACTIVEREADMETERFLOW_H
