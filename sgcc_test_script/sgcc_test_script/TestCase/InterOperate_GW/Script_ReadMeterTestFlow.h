#ifndef SCRIPT_READMETERTESTFLOW_H
#define SCRIPT_READMETERTESTFLOW_H
...
class Script_ReadMeterTestFlow : public InteroperateBase_GW, public AbstractScript,public DynamicCreate<Script_ReadMeterTestFlow>
{
    Q_OBJECT
public:
    explicit Script_ReadMeterTestFlow(QObject *parent = nullptr);
    ~Script_ReadMeterTestFlow();
private:
...
#endif // SCRIPT_READMETERTESTFLOW_H
