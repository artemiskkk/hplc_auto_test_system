#ifndef SCRIPT_READMETER13F1FLOW_H
#define SCRIPT_READMETER13F1FLOW_H

#include "../InteroperateBase_GW.h"
enum Script_ReadMeter13F1Flow_RunState
{
    ScriptInit,
...
class Script_ReadMeter13F1Flow : public InteroperateBase_GW, public AbstractScript,public DynamicCreate<Script_ReadMeter13F1Flow>
{
    Q_OBJECT
public:
    explicit Script_ReadMeter13F1Flow(QObject *parent = nullptr);
    ~Script_ReadMeter13F1Flow();
private:
    Script_ReadMeter13F1Flow_RunState emScriptRunState=ScriptInit;
    uchar protocol=0x00;
private:
...
#endif // SCRIPT_READMETER13F1FLOW_H
