#ifndef SCRIPT_ROUTERACTIVEREADMETERFLOW_H
#define SCRIPT_ROUTERACTIVEREADMETERFLOW_H

#include "../InteroperateBase_GW.h"
enum Script_RouterActiveReadMeterFlow_RunState
{
    ScriptInit,
    Wait_InteroperateInit_Finish,
    Wait_RestartRouter_Finish,
    Wait_ReadMeter_Finish,
    Wait_PauseRouter_Finish,
    ScriptFinish
};
class Script_RouterActiveReadMeterFlow : public InteroperateBase_GW, public AbstractScript,public DynamicCreate<Script_RouterActiveReadMeterFlow>
{
    Q_OBJECT
public:
    explicit Script_RouterActiveReadMeterFlow(QObject *parent = nullptr);
    ~Script_RouterActiveReadMeterFlow();
private:
    Script_RouterActiveReadMeterFlow_RunState emScriptRunState=ScriptInit;
    uchar protocol=0x00;
private:
...
#endif // SCRIPT_ROUTERACTIVEREADMETERFLOW_H
