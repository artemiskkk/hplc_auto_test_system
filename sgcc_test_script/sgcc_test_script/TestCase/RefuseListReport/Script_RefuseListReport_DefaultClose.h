#ifndef SCRIPT_REFUSELISTREPORT_DEFAULTCLOSE_H
#define SCRIPT_REFUSELISTREPORT_DEFAULTCLOSE_H
...
/**
 * @brief The Script_RefuseListReport_DefaultClose_RunState 运行状态机
 */
enum Script_RefuseListReport_DefaultClose_RunState
{
    ScriptInit,
    Wait_BuildNetFinish_Whole,

    Wait_SetParaInit_01F2_Finish,
    Wait_SetRefuseStaInforReportOpen_05F200_Finish,
    Wait_SetRefuseStaInforReportClose_05F200_Finish,
...
/**
 * @brief The Script_RefuseListReport_DefaultClose 拒绝节点信息上报-默认关闭【GW-CCO-F019-0001-V01】
 *
 */

class Script_RefuseListReport_DefaultClose :  public QObject, public AbstractScript, public DynamicCreate<Script_RefuseListReport_DefaultClose>
{
    Q_OBJECT
public:
    explicit Script_RefuseListReport_DefaultClose(QObject *parent = nullptr);
    ~Script_RefuseListReport_DefaultClose();
private:
    Script_RefuseListReport_DefaultClose_RunState emScriptRunState = ScriptInit;
...
#endif // SCRIPT_REFUSELISTREPORT_DEFAULTCLOSE_H
