#ifndef SCRIPT_READMETER_14F1_13F1_F1F1_RESTARTPAUSERECOVER_H
#define SCRIPT_READMETER_14F1_13F1_F1F1_RESTARTPAUSERECOVER_H

#include <QObject>
#include "TestCase/BuildNetwork_GW.h"
enum Script_ReadMeter_14F1_13F1_F1F1_RestartPauseRecover_RunState
{
    TestInit,
    Wait_BuildNetFinish_Whole,
    Wait_ReadMeter_Restart,
    Wait_ReadMeter_Pause,
    Wait_ReadMeter_Recover,
    RouterPause,
    ScriptSuccess
};
...
class Script_ReadMeter_14F1_13F1_F1F1_RestartPauseRecover : public QObject, public AbstractScript,public DynamicCreate<Script_ReadMeter_14F1_13F1_F1F1_RestartPauseRecover>
{
    Q_OBJECT
//    Q_PLUGIN_METADATA(IID "com.topscomm.AbstractScript")
//    Q_INTERFACES(AbstractScript)
public:
    explicit Script_ReadMeter_14F1_13F1_F1F1_RestartPauseRecover(QObject *parent = nullptr);
    ~Script_ReadMeter_14F1_13F1_F1F1_RestartPauseRecover();

    Script_ReadMeter_14F1_13F1_F1F1_RestartPauseRecover_RunState emScriptRunState;
...
//    int reportCount_14F1=0;
    ...
    int No_14F1;
    bool flag_13F1,flag_14F1,flag_F1F1,flag_pause_ack=false;
...
#endif // SCRIPT_READMETER_14F1_13F1_F1F1_RESTARTPAUSERECOVER_H
